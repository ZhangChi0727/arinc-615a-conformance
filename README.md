...
- Record FIND 78/78 and DOWNLOAD 365/365 source-unit reread candidates against 615A-3. Media Defined and Operator Defined DOWNLOAD stay separate. Bound CRS rows stay deferred. AFDX appendix units remain unread. This is not independent architecture, mathematical or RG approval.
...
- Continue AFDX appendix source-unit reread (13 DEFERRED-AFDX-DEPLOYMENT-M2-INFRASTRUCTURE-BINDING units) on this branch. FIND 78/78 and DOWNLOAD 365/365 candidate rereads are recorded; bound deferred rows are unchanged. Do not batch-rename DEFERRED-* labels or generate CRS rows from templates.
...
- 已对 FIND 78/78 条与 DOWNLOAD 365/365 条对照 615A-3 记录来源重读候选。Media Defined 与 Operator Defined DOWNLOAD 保持分开。绑定 CRS 行仍延期。AFDX 附录单元尚未重读。这不是独立架构、数学或 RG 批准。
...
- 在本分支继续 AFDX 附录来源单元重读（13 条 DEFERRED-AFDX-DEPLOYMENT-M2-INFRASTRUCTURE-BINDING）。FIND 78/78 与 DOWNLOAD 365/365 条候选重读已记录；绑定延期行未改。不得把 DEFERRED-* 标签批量改名，也不得按模板生成 CRS 行。
