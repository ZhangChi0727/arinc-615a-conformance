...
- Dependencies: 14
- Gaps: 1
- Coverage fingerprint: `abade2fd0cbbe5a1a29c3228474075c1bfaa1b51e81ca9bfcae3e0950c713d4b`
- Requirements fingerprint: `6a9dc14d68a79cb99d246f48d6e2528cb3c7ec2a26c082aa115e4e1dbbb8b4a7`
- Source-unit fingerprint: `2a3636194de2e310f0036246a592a5b1a4adac926a39590d913d597ba8e47248`
...
| `CRS-M1-00391` | `SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-005-3CE166EDA700`<br>`ARINC-615A-3 3-2 p.96` | `FIND-HOST` / `WHEN-FIND-IMPLEMENTED` / `ANSWER-FIND-REQUEST-WITHIN-TWO-SECOND-UPPER-BOUND` / `FIND-ANSWER, FIND-HOST-TIMEOUT-UPPER-BOUND-2-S` / `FIND-HOST-ANSWER-WITHIN-TWO-SECOND-UPPER-BOUND-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | When FIND is implemented, a FIND host shall send its FIND answer within a two-second upper bound of the request. Missing that bound risks omission from registration; that risk is not a permission to omit the answer.<br>在实现 FIND 时，FIND 主机必须在请求后的两秒上界内发出 FIND 应答。超过该上界有不被登记的风险；该风险不是可以不应答的许可。 | `SYMBOLIC-SOURCE-PARAMETER` / `FIND-HOST-TIMEOUT-2-S` / `SOURCE-DEFINES-DEADLINE-OR-DURATION` / `0..2 s` / evidence: SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-005-3CE166EDA700, SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-002-F178271163DF | — |
...
| `CRS-M1-00473` | `SU-ARINC-615A-3-TABLE-6_4_7-1-R009`<br>`ARINC-615A-3 6.4.7 p.79` | `PROTOCOL-FILE-PRODUCER` / `WHEN-MEDIA-OR-OPERATOR-DEFINED-DOWNLOAD-IS-USED` / `ENCODE-TABULATED-FIELD` / `FIELD-ESTIMATED-TIME, LNS` / `FIELD-PRESENCE-SIZE-AND-VALUE-OBSERVABLE` | `TABLE-CONSTRAINT` / `CONDITIONAL-REQUIRED` | `CONDITIONAL` | When Media Defined or Operator Defined DOWNLOAD is used, the protocol-file producer shall encode LNS Estimated Time as a 16-bit raw field. Status 0x0002 or 0x0004 carry remaining seconds; 0xFFFF means the estimate is not given and must not be decoded as ordinary remaining seconds; other status codes set the field to 0x0000.<br>在使用媒体定义或操作员定义 DOWNLOAD 时，协议文件生成方必须把 LNS Estimated Time 编为 16 位原始字段。状态 0x0002 或 0x0004 携带剩余秒数；0xFFFF 表示未给出估计，不得解码为普通剩余秒数；其他状态码把该字段置为 0x0000。 | — | — |
...
| `CRS-M1-00520` | `SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-002-F178271163DF`<br>`ARINC-615A-3 3-2 p.96` | `DATA-LOADER` / `WHEN-FIND-IMPLEMENTED` / `KEEP-THREE-SECOND-FIND-ANSWER-WINDOW` / `FIND-ANSWER-WINDOW-3-S` / `FIND-ANSWER-WINDOW-UPPER-BOUND-OBSERVABLE` | `FACT` / `REQUIRED` | `APPLICABLE-SUPPORTING` | When FIND is implemented, the data loader shall keep a three-second window for FIND answers after sending a FIND request. The window length is an upper bound, not a requirement that every answer arrive at exactly three seconds.<br>在实现 FIND 时，数据加载器必须在发出 FIND 请求后为 FIND 应答保持三秒窗口。该窗口长度是上界，并不要求每个应答恰好在第三秒到达。 | `SYMBOLIC-SOURCE-PARAMETER` / `FIND-ANSWER-WINDOW-3-S` / `SOURCE-DEFINES-DEADLINE-OR-DURATION` / `0..3 s` / evidence: SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-002-F178271163DF, SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-004-30FC1BCEB891 | — |
| `CRS-M1-00521` | `SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-004-30FC1BCEB891`<br>`ARINC-615A-3 3-2 p.96` | `DATA-LOADER` / `WHEN-FIND-IMPLEMENTED` / `CLOSE-FIND-ANSWER-REGISTRATION-WHEN-WINDOW-EXPIRES` / `FIND-ANSWER-REGISTRATION, FIND-ANSWER-WINDOW-3-S` / `FIND-REGISTRATION-CLOSE-AT-WINDOW-END-OBSERVABLE` | `FACT` / `REQUIRED` | `APPLICABLE-SUPPORTING` | When FIND is implemented, the data loader shall close FIND-answer registration when the three-second window expires.<br>在实现 FIND 时，数据加载器必须在三秒窗口到期时关闭 FIND 应答登记。 | — | — |
...
| `CRS-M1-00523` | `SU-ARINC-615A-3-5-4-4-3-P052-PROSE-SENTENCE-006-ED9F856333F8`<br>`ARINC-615A-3 5.4.4.3 p.40` | `DATA-LOADER` / `WHEN-REMOVABLE-MEDIA-IS-LNR-SOURCE-AND-DOWNLOAD-DESTINATION` / `INCREMENT-DNLD-DATA-NUMBER-FROM-ONE-EACH-DOWNLOAD` / `DNLD-DATA-NUMBER, DNLD-DATA-DIRECTORY` / `DNLD-DATA-NUMBER-STARTS-AT-ONE-AND-INCREMENTS-OBSERVABLE` | `FACT` / `CONDITIONAL-REQUIRED` | `CONDITIONAL` | When removable media is the LNR source and the destination of downloaded data, the data loader shall increment <number> on each download, starting at 1, so successive DNLD_DATA directory names stay unique.<br>在可移动媒体既是 LNR 来源又是下载数据目的地时，数据加载器必须在每次下载时递增 <number>，且从 1 开始，以使相继 DNLD_DATA 目录名保持唯一。 | — | — |
...
| `CRS-M1-00391` | `FIND-HOST-ANSWER-DEADLINE` | `FIND-REQUEST-RECEIVED-BY-HOST` → `FIND-ANSWER-SENT-BY-HOST` | `ILLEGAL-FIND-REQUEST-OR-FIND-ABORTED` / `NONE` | `FIND-REQUEST-INSTANCE` / `PAIR-FIND-REQUEST-WITH-HOST-ANSWER` |
| `CRS-M1-00520` | `FIND-ANSWER-REGISTRATION-WINDOW` | `FIND-REQUEST-SENT` → `FIND-ANSWER-REGISTRATION-WINDOW-CLOSED` | `FIND-OPERATION-ABORTED` / `NONE` | `FIND-REQUEST-INSTANCE` / `PAIR-FIND-REQUEST-WITH-REGISTRATION-WINDOW` |
...
| `CRS-M1-00472` | `LNS` / `7` | `FIELD-EXCEPTION-TIMER` | `16` | `ONCE` / `WHEN-STATUS-CODE-0002-OR-0004` | `UNSIGNED-INT-BIG-ENDIAN` / `NOT-APPLICABLE-OR-PROSE-DEFINED` | LNS-EXCEPTION-TIMER-WHEN-STATUS-0002-OR-0004 |
| `CRS-M1-00473` | `LNS` / `8` | `FIELD-ESTIMATED-TIME` | `16` | `ONCE` / `WHEN-STATUS-CODE-0002-OR-0004` | `UNSIGNED-INT-BIG-ENDIAN` / `NOT-APPLICABLE-OR-PROSE-DEFINED` | LNS-ESTIMATED-TIME-WHEN-STATUS-0002-OR-0004, LNS-ESTIMATED-TIME-UNKNOWN-IS-0xFFFF |
...
- 依赖：14
- 缺口：1
- 覆盖指纹：`abade2fd0cbbe5a1a29c3228474075c1bfaa1b51e81ca9bfcae3e0950c713d4b`
- 需求指纹：`6a9dc14d68a79cb99d246f48d6e2528cb3c7ec2a26c082aa115e4e1dbbb8b4a7`
- 来源单元指纹：`2a3636194de2e310f0036246a592a5b1a4adac926a39590d913d597ba8e47248`
...
| `CRS-M1-00391` | `SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-005-3CE166EDA700`<br>`ARINC-615A-3 3-2 p.96` | `FIND-HOST` / `WHEN-FIND-IMPLEMENTED` / `ANSWER-FIND-REQUEST-WITHIN-TWO-SECOND-UPPER-BOUND` / `FIND-ANSWER, FIND-HOST-TIMEOUT-UPPER-BOUND-2-S` / `FIND-HOST-ANSWER-WITHIN-TWO-SECOND-UPPER-BOUND-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 在实现 FIND 时，FIND 主机必须在请求后的两秒上界内发出 FIND 应答。超过该上界有不被登记的风险；该风险不是可以不应答的许可。 | `SYMBOLIC-SOURCE-PARAMETER` / `FIND-HOST-TIMEOUT-2-S` / `SOURCE-DEFINES-DEADLINE-OR-DURATION` / `0..2 s` / 证据：SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-005-3CE166EDA700, SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-002-F178271163DF | — |
...
| `CRS-M1-00473` | `SU-ARINC-615A-3-TABLE-6_4_7-1-R009`<br>`ARINC-615A-3 6.4.7 p.79` | `PROTOCOL-FILE-PRODUCER` / `WHEN-MEDIA-OR-OPERATOR-DEFINED-DOWNLOAD-IS-USED` / `ENCODE-TABULATED-FIELD` / `FIELD-ESTIMATED-TIME, LNS` / `FIELD-PRESENCE-SIZE-AND-VALUE-OBSERVABLE` | `TABLE-CONSTRAINT` / `CONDITIONAL-REQUIRED` | `CONDITIONAL` | 在使用媒体定义或操作员定义 DOWNLOAD 时，协议文件生成方必须把 LNS Estimated Time 编为 16 位原始字段。状态 0x0002 或 0x0004 携带剩余秒数；0xFFFF 表示未给出估计，不得解码为普通剩余秒数；其他状态码把该字段置为 0x0000。 | — | — |
...
| `CRS-M1-00520` | `SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-002-F178271163DF`<br>`ARINC-615A-3 3-2 p.96` | `DATA-LOADER` / `WHEN-FIND-IMPLEMENTED` / `KEEP-THREE-SECOND-FIND-ANSWER-WINDOW` / `FIND-ANSWER-WINDOW-3-S` / `FIND-ANSWER-WINDOW-UPPER-BOUND-OBSERVABLE` | `FACT` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 在实现 FIND 时，数据加载器必须在发出 FIND 请求后为 FIND 应答保持三秒窗口。该窗口长度是上界，并不要求每个应答恰好在第三秒到达。 | `SYMBOLIC-SOURCE-PARAMETER` / `FIND-ANSWER-WINDOW-3-S` / `SOURCE-DEFINES-DEADLINE-OR-DURATION` / `0..3 s` / 证据：SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-002-F178271163DF, SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-004-30FC1BCEB891 | — |
| `CRS-M1-00521` | `SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-004-30FC1BCEB891`<br>`ARINC-615A-3 3-2 p.96` | `DATA-LOADER` / `WHEN-FIND-IMPLEMENTED` / `CLOSE-FIND-ANSWER-REGISTRATION-WHEN-WINDOW-EXPIRES` / `FIND-ANSWER-REGISTRATION, FIND-ANSWER-WINDOW-3-S` / `FIND-REGISTRATION-CLOSE-AT-WINDOW-END-OBSERVABLE` | `FACT` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 在实现 FIND 时，数据加载器必须在三秒窗口到期时关闭 FIND 应答登记。 | — | — |
| `CRS-M1-00522` | `SU-ARINC-615A-3-5-4-4-3-P052-PROSE-SENTENCE-005-D462FF831585`<br>`ARINC-615A-3 5.4.4.3 p.40` | `DATA-LOADER` / `WHEN-REMOVABLE-MEDIA-IS-LNR-SOURCE-AND-DOWNLOAD-DESTINATION` / `CREATE-DNLD-DATA-DIRECTORY-IN-DOWNLOAD-MEDIA-ROOT` / `DNLD-DATA-DIRECTORY, DOWNLOAD-MEDIA-ROOT` / `DNLD-DATA-DIRECTORY-IN-ROOT-OBSERVABLE` | `FACT` / `CONDITIONAL-REQUIRED` | `CONDITIONAL` | 在可移动媒体既是 LNR 来源又是下载数据目的地时，数据加载器必须在下载媒体的根目录下创建 DNLD_DATA 目录。 | — | — |
| `CRS-M1-00523` | `SU-ARINC-615A-3-5-4-4-3-P052-PROSE-SENTENCE-006-ED9F856333F8`<br>`ARINC-615A-3 5.4.4.3 p.40` | `DATA-LOADER` / `WHEN-REMOVABLE-MEDIA-IS-LNR-SOURCE-AND-DOWNLOAD-DESTINATION` / `INCREMENT-DNLD-DATA-NUMBER-FROM-ONE-EACH-DOWNLOAD` / `DNLD-DATA-NUMBER, DNLD-DATA-DIRECTORY` / `DNLD-DATA-NUMBER-STARTS-AT-ONE-AND-INCREMENTS-OBSERVABLE` | `FACT` / `CONDITIONAL-REQUIRED` | `CONDITIONAL` | 在可移动媒体既是 LNR 来源又是下载数据目的地时，数据加载器必须在每次下载时递增 <number>，且从 1 开始，以使相继 DNLD_DATA 目录名保持唯一。 | — | — |
