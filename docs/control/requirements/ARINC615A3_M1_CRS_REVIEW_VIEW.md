...
- Requirements fingerprint: `748e207be55841515ad66df655c7f31fbdc54f0c4860c71c6c4b958b2514be64`
...
|---|---|---|---|---|---|---|---|
| `CRS-M1-00001` | `SU-ARINC-615A-3-1-2-P014-PROSE-SENTENCE-002-8D3CB7C14FBD`<br>`ARINC-615A-3 1.2 p.2` | `DATA-LOADER` / `DURING-SCOPE-SCOPE` / `IMPLEMENT` / `NETWORK-INTERFACE` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform IMPLEMENT on NETWORK-INTERFACE under DURING-SCOPE-SCOPE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“数据加载器”在“在 SCOPE 范围内”下必须对“网络接口”执行“提供能力”；证据是“能力可用性可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00002` | `SU-ARINC-615A-3-1-2-P014-PROSE-SENTENCE-003-8280DDEE506E`<br>`ARINC-615A-3 1.2 p.2` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-SCOPE-SCOPE` / `IMPLEMENT` / `CONFORMANCE-MODALITY` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform IMPLEMENT on CONFORMANCE-MODALITY under DURING-SCOPE-SCOPE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 SCOPE 范围内”下必须对“CONFORMANCE-MODALITY”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00003` | `SU-ARINC-615A-3-1-2-P014-PROSE-SENTENCE-004-9B5A3832A655`<br>`ARINC-615A-3 1.2 p.2` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-SCOPE-SCOPE` / `USE` / `CONFORMANCE-MODALITY` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION may perform USE on CONFORMANCE-MODALITY under DURING-SCOPE-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 SCOPE 范围内”下可以对“CONFORMANCE-MODALITY”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
...
| `CRS-M1-00005` | `SU-ARINC-615A-3-1-3-P014-PROSE-SENTENCE-001-2FA34C046AFB`<br>`ARINC-615A-3 1.3 p.2` | `DATA-LOADER` / `DURING-SCOPE-SCOPE` / `TRANSFER` / `SOFTWARE-PART` / `TRANSFER-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform TRANSFER on SOFTWARE-PART under DURING-SCOPE-SCOPE; evidence is the resulting TRANSFER-OUTCOME-OBSERVABLE.<br>参与者“数据加载器”在“在 SCOPE 范围内”下必须对“软件加载件”执行“传输”；证据是“传输结果可被观察”。 | — | — |
| `CRS-M1-00006` | `SU-ARINC-615A-3-1-3-P014-PROSE-SENTENCE-002-873AFAE35C45`<br>`ARINC-615A-3 1.3 p.2` | `TARGET-HARDWARE` / `DURING-SCOPE-SCOPE` / `TRANSFER` / `NETWORK-INTERFACE, TARGET-HARDWARE-ID` / `TRANSFER-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform TRANSFER on NETWORK-INTERFACE, TARGET-HARDWARE-ID under DURING-SCOPE-SCOPE; evidence is the resulting TRANSFER-OUTCOME-OBSERVABLE.<br>参与者“目标硬件”在“在 SCOPE 范围内”下必须对“网络接口、TARGET-HARDWARE-ID”执行“传输”；证据是“传输结果可被观察”。 | — | DEP-ARINC-664-2, DEP-ARINC-664-3 |
| `CRS-M1-00007` | `SU-ARINC-615A-3-1-3-P014-PROSE-SENTENCE-005-EC7965CC3D31`<br>`ARINC-615A-3 1.3 p.2` | `DATA-LOADER` / `DURING-SCOPE-SCOPE` / `IMPLEMENT` / `OPERATION, NETWORK-INTERFACE` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform IMPLEMENT on OPERATION, NETWORK-INTERFACE under DURING-SCOPE-SCOPE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“数据加载器”在“在 SCOPE 范围内”下必须对“协议操作、网络接口”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00008` | `SU-ARINC-615A-3-1-3-P014-PROSE-SENTENCE-007-00560ACC8ACC`<br>`ARINC-615A-3 1.3 p.2` | `DATA-LOADER` / `DURING-SCOPE-SCOPE` / `PROHIBIT` / `DATA-LOADING-TYPES` / `PROHIBITED-EVENT-ABSENCE-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform PROHIBIT on DATA-LOADING-TYPES under DURING-SCOPE-SCOPE; evidence is the resulting PROHIBITED-EVENT-ABSENCE-OBSERVABLE.<br>参与者“数据加载器”在“在 SCOPE 范围内”下必须对“DATA-LOADING-TYPES”执行“禁止”；证据是“受禁事件不出现可被观察”。 | — | — |
| `CRS-M1-00009` | `SU-ARINC-615A-3-1-6-P017-PROSE-SENTENCE-001-6E91C83C11CE`<br>`ARINC-615A-3 1.6 p.5` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-SCOPE-SCOPE` / `DESIGN` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform DESIGN on NETWORK-INTERFACE under DURING-SCOPE-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 SCOPE 范围内”下必须对“网络接口”执行“设计”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00010` | `SU-ARINC-615A-3-1-6-P017-PROSE-SENTENCE-003-817EC6E68797`<br>`ARINC-615A-3 1.6 p.5` | `DATA-LOADER` / `DURING-SCOPE-SCOPE` / `IMPLEMENT` / `NETWORK-INTERFACE` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform IMPLEMENT on NETWORK-INTERFACE under DURING-SCOPE-SCOPE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“数据加载器”在“在 SCOPE 范围内”下必须对“网络接口”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00011` | `SU-ARINC-615A-3-1-6-P017-PROSE-SENTENCE-004-1768AAB8F452`<br>`ARINC-615A-3 1.6 p.5` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-SCOPE-SCOPE` / `ENCODE` / `NETWORK-INTERFACE` / `ENCODED-FIELD-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION may perform ENCODE on NETWORK-INTERFACE under DURING-SCOPE-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 SCOPE 范围内”下可以对“网络接口”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00012` | `SU-ARINC-615A-3-1-6-P017-PROSE-SENTENCE-005-358B4BAB3D69`<br>`ARINC-615A-3 1.6 p.5` | `PROTOCOL-IMPLEMENTATION` / `DURING-SCOPE-SCOPE` / `ENCODE` / `NETWORK-INTERFACE` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-IMPLEMENTATION shall perform ENCODE on NETWORK-INTERFACE under DURING-SCOPE-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“协议实现”在“在 SCOPE 范围内”下必须对“网络接口”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00013` | `SU-ARINC-615A-3-1-6-P017-PROSE-SENTENCE-006-711482ED9B24`<br>`ARINC-615A-3 1.6 p.5` | `SOFTWARE-PACKAGE-PRODUCER` / `DURING-SCOPE-SCOPE` / `COMPLY` / `SOFTWARE-PART, NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform COMPLY on SOFTWARE-PART, NETWORK-INTERFACE under DURING-SCOPE-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“在 SCOPE 范围内”下必须对“软件加载件、网络接口”执行“符合”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00014` | `SU-ARINC-615A-3-5-1-P034-PROSE-SENTENCE-015-441CC925118B`<br>`ARINC-615A-3 5.1 p.22` | `PROTOCOL-FILE-PRODUCER` / `DURING-COMMON-SCOPE` / `ENCODE` / `PROTOCOL-FILE-NAME` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-FILE-PRODUCER shall perform ENCODE on PROTOCOL-FILE-NAME under DURING-COMMON-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“协议文件生成方”在“在 COMMON 范围内”下必须对“PROTOCOL-FILE-NAME”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00015` | `SU-ARINC-615A-3-5-1-P034-PROSE-SENTENCE-016-EE8EBA5E1E47`<br>`ARINC-615A-3 5.1 p.22` | `SOFTWARE-PACKAGE-PRODUCER` / `DURING-COMMON-SCOPE` / `DEFINE` / `SOFTWARE-PART` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform DEFINE on SOFTWARE-PART under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“在 COMMON 范围内”下必须对“软件加载件”执行“定义”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00016` | `SU-ARINC-615A-3-5-1-P034-PROSE-SENTENCE-016-EE8EBA5E1E47`<br>`ARINC-615A-3 5.1 p.22` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `COMPLY` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform COMPLY on NETWORK-INTERFACE under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“网络接口”执行“符合”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00017` | `SU-ARINC-615A-3-5-2-P035-PROSE-SENTENCE-011-D07026646B5D`<br>`ARINC-615A-3 5.2 p.23` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `USE` / `FIND-SERVICE, TARGET-HARDWARE-ID` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform USE on FIND-SERVICE, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下必须对“FIND-SERVICE、TARGET-HARDWARE-ID”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00018` | `SU-ARINC-615A-3-5-3-2-2-P037-PROSE-SENTENCE-001-5DE45B64D498`<br>`ARINC-615A-3 5.3.2.2 p.25` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `TRANSFER` / `TFTP-OPTION` / `TRANSFER-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION may perform TRANSFER on TFTP-OPTION under DURING-COMMON-SCOPE; evidence is the resulting TRANSFER-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下可以对“TFTP 选项”执行“传输”；证据是“传输结果可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00019` | `SU-ARINC-615A-3-5-3-2-2-P037-PROSE-SENTENCE-003-DE334C18716C`<br>`ARINC-615A-3 5.3.2.2 p.25` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `USE` / `DEFAULT-OPTION-VALUES` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform USE on DEFAULT-OPTION-VALUES under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“DEFAULT-OPTION-VALUES”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00020` | `SU-ARINC-615A-3-5-3-2-2-P037-PROSE-SENTENCE-004-FC7D3B3729A1`<br>`ARINC-615A-3 5.3.2.2 p.25` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `TRANSFER` / `TRANSFER-OUTCOME` / `TRANSFER-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform TRANSFER on TRANSFER-OUTCOME under DURING-COMMON-SCOPE; evidence is the resulting TRANSFER-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TRANSFER-OUTCOME”执行“传输”；证据是“传输结果可被观察”。 | — | — |
| `CRS-M1-00021` | `SU-ARINC-615A-3-5-3-2-2-P037-PROSE-SENTENCE-005-C966C11D19B8`<br>`ARINC-615A-3 5.3.2.2 p.25` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `AFTER-LAST-TFTP-OPTION` / `ABSENT-AFTER-BOUNDARY` / `TFTP-OPTION, NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform ABSENT-AFTER-BOUNDARY on TFTP-OPTION, NETWORK-INTERFACE under AFTER-LAST-TFTP-OPTION; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“最后一个 TFTP 选项结束后”下必须对“TFTP 选项、网络接口”执行“确保边界后不存在数据”；证据是“状态或编码结果可被观察”。 | — | DEP-RFC-768, DEP-RFC-791, DEP-RFC-1350 |
| `CRS-M1-00022` | `SU-ARINC-615A-3-5-3-2-3-2-P037-PROSE-SENTENCE-002-1E0F8D921559`<br>`ARINC-615A-3 5.3.2.3.2 p.25` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `TRANSFER` / `TARGET-HARDWARE-ID` / `TRANSFER-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE may perform TRANSFER on TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting TRANSFER-OUTCOME-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下可以对“TARGET-HARDWARE-ID”执行“传输”；证据是“传输结果可被观察”。 | — | — |
| `CRS-M1-00023` | `SU-ARINC-615A-3-5-3-2-3-2-P037-PROSE-SENTENCE-004-C976EA5E8074`<br>`ARINC-615A-3 5.3.2.3.2 p.25` | `PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `IMPLEMENT` / `NETWORK-INTERFACE` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-IMPLEMENTATION shall perform IMPLEMENT on NETWORK-INTERFACE under DURING-COMMON-SCOPE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“协议实现”在“在 COMMON 范围内”下必须对“网络接口”执行“提供能力”；证据是“能力可用性可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00024` | `SU-ARINC-615A-3-5-3-2-3-3-P038-PROSE-SENTENCE-004-15DBABB1142A`<br>`ARINC-615A-3 5.3.2.3.3 p.26` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `USE` / `ERROR-CODE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform USE on ERROR-CODE under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“错误码”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00025` | `SU-ARINC-615A-3-5-3-2-3-3-P038-PROSE-SENTENCE-005-A1C528A5F702`<br>`ARINC-615A-3 5.3.2.3.3 p.26` | `PROTOCOL-FILE-PRODUCER` / `DURING-COMMON-SCOPE` / `ENCODE` / `ERROR-CODE, ERROR-MESSAGE` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-FILE-PRODUCER shall perform ENCODE on ERROR-CODE, ERROR-MESSAGE under DURING-COMMON-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“协议文件生成方”在“在 COMMON 范围内”下必须对“错误码、错误消息”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00026` | `SU-ARINC-615A-3-5-3-2-3-3-P038-PROSE-SENTENCE-006-06665FE11D6E`<br>`ARINC-615A-3 5.3.2.3.3 p.26` | `PROTOCOL-FILE-PRODUCER` / `DURING-COMMON-SCOPE` / `ENCODE` / `ERROR-CODE, ERROR-MESSAGE` / `ENCODED-FIELD-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-FILE-PRODUCER may perform ENCODE on ERROR-CODE, ERROR-MESSAGE under DURING-COMMON-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“协议文件生成方”在“在 COMMON 范围内”下可以对“错误码、错误消息”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00027` | `SU-ARINC-615A-3-5-3-2-3-3-P038-PROSE-SENTENCE-007-2560DF2DBBD3`<br>`ARINC-615A-3 5.3.2.3.3 p.26` | `TARGET-HARDWARE` / `WHEN-TFTP-RESOURCE-UNAVAILABLE` / `IMPLEMENT` / `ERROR-CODE, TARGET-HARDWARE-ID` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform IMPLEMENT on ERROR-CODE, TARGET-HARDWARE-ID under WHEN-TFTP-RESOURCE-UNAVAILABLE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“目标硬件”在“TFTP 资源不可用时”下必须对“错误码、TARGET-HARDWARE-ID”执行“提供能力”；证据是“能力可用性可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00028` | `SU-ARINC-615A-3-5-3-2-3-3-P038-PROSE-SENTENCE-008-B72528E71CC2`<br>`ARINC-615A-3 5.3.2.3.3 p.26` | `TARGET-HARDWARE` / `WHEN-TFTP-RESOURCE-UNAVAILABLE` / `IMPLEMENT` / `ERROR-CODE, TARGET-HARDWARE-ID` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform IMPLEMENT on ERROR-CODE, TARGET-HARDWARE-ID under WHEN-TFTP-RESOURCE-UNAVAILABLE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“目标硬件”在“TFTP 资源不可用时”下必须对“错误码、TARGET-HARDWARE-ID”执行“提供能力”；证据是“能力可用性可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00029` | `SU-ARINC-615A-3-5-3-2-3-4-P038-PROSE-SENTENCE-004-1F95516BE886`<br>`ARINC-615A-3 5.3.2.3.4 p.26` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `TRANSFER` / `PROTOCOL-MESSAGE` / `TRANSFER-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION may perform TRANSFER on PROTOCOL-MESSAGE under DURING-COMMON-SCOPE; evidence is the resulting TRANSFER-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下可以对“PROTOCOL-MESSAGE”执行“传输”；证据是“传输结果可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00030` | `SU-ARINC-615A-3-5-3-2-3-4-P038-PROSE-SENTENCE-006-D6FEB985BBBB`<br>`ARINC-615A-3 5.3.2.3.4 p.26` | `TFTP-RECEIVER` / `ON-WAIT-MESSAGE-RECEIPT` / `ABORT` / `WAIT-MESSAGE` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TFTP-RECEIVER shall perform ABORT on WAIT-MESSAGE under ON-WAIT-MESSAGE-RECEIPT; evidence is the resulting ABORT-RESULT-OBSERVABLE.<br>参与者“TFTP 接收方”在“收到 WAIT 消息时”下必须对“WAIT 消息”执行“中止”；证据是“中止结果可被观察”。 | `MESSAGE-CARRIED-PARAMETER` / `MESSAGE-TIMER-VALUE` / `UNRESOLVED..UNRESOLVED s` | DEP-RFC-1350 |
| `CRS-M1-00031` | `SU-ARINC-615A-3-5-3-2-3-8-1-P040-PROSE-SENTENCE-001-28CC7C395DC9`<br>`ARINC-615A-3 5.3.2.3.8.1 p.28` | `DATA-LOADER` / `DURING-COMMON-SCOPE` / `IMPLEMENT` / `TFTP-BLOCK-SIZE, NETWORK-INTERFACE` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform IMPLEMENT on TFTP-BLOCK-SIZE, NETWORK-INTERFACE under DURING-COMMON-SCOPE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“数据加载器”在“在 COMMON 范围内”下必须对“TFTP 块大小、网络接口”执行“提供能力”；证据是“能力可用性可被观察”。 | — | DEP-RFC-791, DEP-RFC-1350, DEP-RFC-2348 |
| `CRS-M1-00032` | `SU-ARINC-615A-3-5-3-2-3-8-1-P040-PROSE-SENTENCE-002-A3F954863D43`<br>`ARINC-615A-3 5.3.2.3.8.1 p.28` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `IMPLEMENT` / `CONFORMANCE-MODALITY, TARGET-HARDWARE-ID` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform IMPLEMENT on CONFORMANCE-MODALITY, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下必须对“CONFORMANCE-MODALITY、TARGET-HARDWARE-ID”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00033` | `SU-ARINC-615A-3-5-3-2-3-8-1-P041-PROSE-SENTENCE-003-C74E9B3EC0A0`<br>`ARINC-615A-3 5.3.2.3.8.1 p.29` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `USE` / `TFTP-BLOCK-SIZE, TARGET-HARDWARE-ID` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE may perform USE on TFTP-BLOCK-SIZE, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下可以对“TFTP 块大小、TARGET-HARDWARE-ID”执行“使用”；证据是“状态或编码结果可被观察”。 | — | DEP-RFC-1350, DEP-RFC-2348 |
| `CRS-M1-00034` | `SU-ARINC-615A-3-5-3-2-3-8-2-P041-PROSE-SENTENCE-001-700C898C606C`<br>`ARINC-615A-3 5.3.2.3.8.2 p.29` | `PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `USE` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-IMPLEMENTATION may perform USE on NETWORK-INTERFACE under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“协议实现”在“在 COMMON 范围内”下可以对“网络接口”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
...
| `CRS-M1-00036` | `SU-ARINC-615A-3-5-3-2-3-8-3-P041-PROSE-SENTENCE-001-700C898C606C`<br>`ARINC-615A-3 5.3.2.3.8.3 p.29` | `PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `USE` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-IMPLEMENTATION may perform USE on NETWORK-INTERFACE under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“协议实现”在“在 COMMON 范围内”下可以对“网络接口”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00037` | `SU-ARINC-615A-3-5-3-2-3-8-4-P041-PROSE-SENTENCE-001-700C898C606C`<br>`ARINC-615A-3 5.3.2.3.8.4 p.29` | `PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `USE` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-IMPLEMENTATION may perform USE on NETWORK-INTERFACE under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“协议实现”在“在 COMMON 范围内”下可以对“网络接口”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00038` | `SU-ARINC-615A-3-5-3-2-3-8-5-P041-PROSE-SENTENCE-001-700C898C606C`<br>`ARINC-615A-3 5.3.2.3.8.5 p.29` | `PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `USE` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-IMPLEMENTATION may perform USE on NETWORK-INTERFACE under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“协议实现”在“在 COMMON 范围内”下可以对“网络接口”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00039` | `SU-ARINC-615A-3-5-3-2-3-8-5-P042-PROSE-SENTENCE-009-89192D1CA807`<br>`ARINC-615A-3 5.3.2.3.8.5 p.30` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `ENCODE` / `HEADER-FILE, CRC, SOFTWARE-PART, TARGET-HARDWARE-ID` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform ENCODE on HEADER-FILE, CRC, SOFTWARE-PART, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下必须对“头文件、CRC／校验值、软件加载件、TARGET-HARDWARE-ID”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | DEP-RFC-1350, DEP-ARINC-6655, DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00040` | `SU-ARINC-615A-3-5-3-2-3-8-5-P042-PROSE-SENTENCE-010-B47966431472`<br>`ARINC-615A-3 5.3.2.3.8.5 p.30` | `DATA-LOADER` / `DURING-COMMON-SCOPE` / `ENCODE` / `CRC` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform ENCODE on CRC under DURING-COMMON-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“数据加载器”在“在 COMMON 范围内”下必须对“CRC／校验值”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00041` | `SU-ARINC-615A-3-5-3-2-3-8-6-P044-PROSE-SENTENCE-005-F74AC5B7AE1C`<br>`ARINC-615A-3 5.3.2.3.8.6 p.32` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `FAIL` / `OPERATION, TARGET-HARDWARE-ID` / `FAILURE-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE may perform FAIL on OPERATION, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting FAILURE-RESULT-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下可以对“协议操作、TARGET-HARDWARE-ID”执行“判定失败”；证据是“失败结果可被观察”。 | — | — |
| `CRS-M1-00042` | `SU-ARINC-615A-3-5-3-2-3-8-6-P044-PROSE-SENTENCE-006-1813D605F404`<br>`ARINC-615A-3 5.3.2.3.8.6 p.32` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `ASSIGN` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform ASSIGN on NETWORK-INTERFACE under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“网络接口”执行“分配或管理”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00043` | `SU-ARINC-615A-3-5-3-2-3-9-P044-PROSE-SENTENCE-001-04EEB77FBE9B`<br>`ARINC-615A-3 5.3.2.3.9 p.32` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `COMPLY` / `TFTP-BLOCK-NUMBER` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform COMPLY on TFTP-BLOCK-NUMBER under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TFTP 块号”执行“符合”；证据是“状态或编码结果可被观察”。 | — | DEP-RFC-1350 |
...
| `CRS-M1-00045` | `SU-ARINC-615A-3-5-4-1-P045-PROSE-SENTENCE-008-B50B97990D87`<br>`ARINC-615A-3 5.4.1 p.33` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `IMPLEMENT` / `NETWORK-INTERFACE, TARGET-HARDWARE-ID` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE may perform IMPLEMENT on NETWORK-INTERFACE, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下可以对“网络接口、TARGET-HARDWARE-ID”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00046` | `SU-ARINC-615A-3-5-4-2-P047-PROSE-SENTENCE-002-ECE0CBAF4A74`<br>`ARINC-615A-3 5.4.2 p.35` | `DATA-LOADER` / `DURING-INFORMATION-SCOPE` / `IMPLEMENT` / `OPERATION` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform IMPLEMENT on OPERATION under DURING-INFORMATION-SCOPE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“数据加载器”在“在 INFORMATION 范围内”下必须对“协议操作”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00047` | `SU-ARINC-615A-3-5-4-2-P047-PROSE-SENTENCE-003-78F447EDB430`<br>`ARINC-615A-3 5.4.2 p.35` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `IMPLEMENT` / `OPERATION, TARGET-HARDWARE-ID` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform IMPLEMENT on OPERATION, TARGET-HARDWARE-ID under DURING-INFORMATION-SCOPE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“协议操作、TARGET-HARDWARE-ID”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00048` | `SU-ARINC-615A-3-5-4-2-P047-PROSE-SENTENCE-018-C6F5CE51372F`<br>`ARINC-615A-3 5.4.2 p.35` | `DATA-LOADER` / `DURING-INFORMATION-SCOPE` / `WAIT` / `CURRENT-STATUS` / `WAIT-BEHAVIOR-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform WAIT on CURRENT-STATUS under DURING-INFORMATION-SCOPE; evidence is the resulting WAIT-BEHAVIOR-OBSERVABLE.<br>参与者“数据加载器”在“在 INFORMATION 范围内”下必须对“CURRENT-STATUS”执行“等待”；证据是“等待行为可被观察”。 | — | — |
| `CRS-M1-00049` | `SU-ARINC-615A-3-5-4-2-P047-PROSE-SENTENCE-019-DD0255D27FB0`<br>`ARINC-615A-3 5.4.2 p.35` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `VALIDATE` / `TFTP-OPTION` / `VALIDATION-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT may perform VALIDATE on TFTP-OPTION under DURING-INFORMATION-SCOPE; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下可以对“TFTP 选项”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00050` | `SU-ARINC-615A-3-5-4-2-P047-PROSE-SENTENCE-020-12B60035E133`<br>`ARINC-615A-3 5.4.2 p.35` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `IMPLEMENT` / `TFTP-OPTION` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE may perform IMPLEMENT on TFTP-OPTION under DURING-INFORMATION-SCOPE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“目标硬件”在“在 INFORMATION 范围内”下可以对“TFTP 选项”执行“提供能力”；证据是“能力可用性可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00051` | `SU-ARINC-615A-3-5-4-2-P047-PROSE-SENTENCE-021-3CF28DC21423`<br>`ARINC-615A-3 5.4.2 p.35` | `DATA-LOADER` / `DURING-INFORMATION-SCOPE` / `VALIDATE` / `CRC, NETWORK-INTERFACE` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform VALIDATE on CRC, NETWORK-INTERFACE under DURING-INFORMATION-SCOPE; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“数据加载器”在“在 INFORMATION 范围内”下必须对“CRC／校验值、网络接口”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00052` | `SU-ARINC-615A-3-5-4-3-P047-PROSE-SENTENCE-002-ECE0CBAF4A74`<br>`ARINC-615A-3 5.4.3 p.35` | `DATA-LOADER` / `DURING-UPLOAD-SCOPE` / `IMPLEMENT` / `OPERATION` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor DATA-LOADER shall perform IMPLEMENT on OPERATION under DURING-UPLOAD-SCOPE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“数据加载器”在“在 UPLOAD 范围内”下必须对“协议操作”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00053` | `SU-ARINC-615A-3-5-4-3-P047-PROSE-SENTENCE-003-78F447EDB430`<br>`ARINC-615A-3 5.4.3 p.35` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `IMPLEMENT` / `OPERATION, TARGET-HARDWARE-ID` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor TARGET-HARDWARE shall perform IMPLEMENT on OPERATION, TARGET-HARDWARE-ID under DURING-UPLOAD-SCOPE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“目标硬件”在“在 UPLOAD 范围内”下必须对“协议操作、TARGET-HARDWARE-ID”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00054` | `SU-ARINC-615A-3-5-4-3-P048-PROSE-SENTENCE-014-A6329164790D`<br>`ARINC-615A-3 5.4.3 p.36` | `TARGET-HARDWARE` / `WHEN-LOAD-LIST-ITEM-REJECTED` / `REJECT` / `LOAD-LIST, TARGET-HARDWARE-ID` / `REJECTION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor TARGET-HARDWARE shall perform REJECT on LOAD-LIST, TARGET-HARDWARE-ID under WHEN-LOAD-LIST-ITEM-REJECTED; evidence is the resulting REJECTION-RESULT-OBSERVABLE.<br>参与者“目标硬件”在“加载清单中任一项被拒绝时”下必须对“LOAD-LIST、TARGET-HARDWARE-ID”执行“拒绝”；证据是“拒绝结果可被观察”。 | — | — |
| `CRS-M1-00055` | `SU-ARINC-615A-3-5-4-3-P048-PROSE-SENTENCE-017-202272C96544`<br>`ARINC-615A-3 5.4.3 p.36` | `DATA-LOADER` / `DURING-UPLOAD-SCOPE` / `DISPLAY` / `CURRENT-STATUS` / `USER-INDICATION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor DATA-LOADER shall perform DISPLAY on CURRENT-STATUS under DURING-UPLOAD-SCOPE; evidence is the resulting USER-INDICATION-OBSERVABLE.<br>参与者“数据加载器”在“在 UPLOAD 范围内”下必须对“CURRENT-STATUS”执行“显示或通知”；证据是“用户提示可被观察”。 | — | — |
| `CRS-M1-00056` | `SU-ARINC-615A-3-5-4-3-P048-PROSE-SENTENCE-022-D550F67EB586`<br>`ARINC-615A-3 5.4.3 p.36` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `VALIDATE` / `TFTP-OPTION, NETWORK-INTERFACE` / `VALIDATION-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-BASE` | Actor TARGET-HARDWARE may perform VALIDATE on TFTP-OPTION, NETWORK-INTERFACE under DURING-UPLOAD-SCOPE; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“目标硬件”在“在 UPLOAD 范围内”下可以对“TFTP 选项、网络接口”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00057` | `SU-ARINC-615A-3-5-4-3-P048-PROSE-SENTENCE-024-F38D018C4499`<br>`ARINC-615A-3 5.4.3 p.36` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor TARGET-HARDWARE shall perform VALIDATE on CRC under DURING-UPLOAD-SCOPE; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“目标硬件”在“在 UPLOAD 范围内”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00058` | `SU-ARINC-615A-3-5-4-3-P048-PROSE-SENTENCE-025-E777A6D3DAC7`<br>`ARINC-615A-3 5.4.3 p.36` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `VALIDATE` / `TFTP-OPTION` / `VALIDATION-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-BASE` | Actor TARGET-HARDWARE may perform VALIDATE on TFTP-OPTION under DURING-UPLOAD-SCOPE; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“目标硬件”在“在 UPLOAD 范围内”下可以对“TFTP 选项”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00059` | `SU-ARINC-615A-3-5-4-3-1-P048-PROSE-SENTENCE-004-AF732D243056`<br>`ARINC-615A-3 5.4.3.1 p.36` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `COMPARE` / `HEADER-FILE, DATA-FILE, LOAD-PART-NUMBER, LOADABLE-SOFTWARE-PART-NUMBER` / `COMPARISON-RESULT-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-BASE` | Actor TARGET-HARDWARE shall perform COMPARE on HEADER-FILE, DATA-FILE, LOAD-PART-NUMBER, LOADABLE-SOFTWARE-PART-NUMBER under DURING-UPLOAD-SCOPE; evidence is the resulting COMPARISON-RESULT-OBSERVABLE.<br>参与者“目标硬件”在“在 UPLOAD 范围内”下必须对“头文件、数据文件、加载件号、LOADABLE-SOFTWARE-PART-NUMBER”执行“比较”；证据是“比较结果可被观察”。 | — | — |
| `CRS-M1-00060` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-007-F209ABE1376B`<br>`ARINC-615A-3 5.4.3.1 p.37` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `VALIDATE` / `NVM-MEMORY-IMAGE` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform VALIDATE on NVM-MEMORY-IMAGE under DURING-UPLOAD-SCOPE; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“NVM-MEMORY-IMAGE”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-6655, DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00061` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-007-F209ABE1376B`<br>`ARINC-615A-3 5.4.3.1 p.37` | `SOFTWARE-PACKAGE-PRODUCER` / `DURING-UPLOAD-SCOPE` / `VALIDATE` / `CRC, SOFTWARE-PART` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform VALIDATE on CRC, SOFTWARE-PART under DURING-UPLOAD-SCOPE; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“软件包生成方”在“在 UPLOAD 范围内”下必须对“CRC／校验值、软件加载件”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-6655, DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00062` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-008-CDA43D6568CC`<br>`ARINC-615A-3 5.4.3.1 p.37` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `VALIDATE` / `CRC, FILE-CONTENT, TARGET-HARDWARE-ID` / `VALIDATION-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-BASE` | Actor TARGET-HARDWARE may perform VALIDATE on CRC, FILE-CONTENT, TARGET-HARDWARE-ID under DURING-UPLOAD-SCOPE; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“目标硬件”在“在 UPLOAD 范围内”下可以对“CRC／校验值、FILE-CONTENT、TARGET-HARDWARE-ID”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00063` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-010-F4624AC8DCB4`<br>`ARINC-615A-3 5.4.3.1 p.37` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `ENSURE-EQUALITY` / `LOAD-PART-NUMBER, CRC` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ENSURE-EQUALITY on LOAD-PART-NUMBER, CRC under DURING-UPLOAD-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“加载件号、CRC／校验值”执行“确保取值相等”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00064` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-012-B2655A4BD5D6`<br>`ARINC-615A-3 5.4.3.1 p.37` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `FORMAT` / `FILE-CONTENT` / `ENCODED-FORMAT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform FORMAT on FILE-CONTENT under DURING-UPLOAD-SCOPE; evidence is the resulting ENCODED-FORMAT-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“FILE-CONTENT”执行“按规定格式化”；证据是“编码格式可被观察”。 | — | — |
| `CRS-M1-00065` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-015-1FD87B87894F`<br>`ARINC-615A-3 5.4.3.1 p.37` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `SELECT` / `FILE-CONTENT` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform SELECT on FILE-CONTENT under DURING-UPLOAD-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“FILE-CONTENT”执行“选择”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00066` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-017-D6D20C0AE6D8`<br>`ARINC-615A-3 5.4.3.1 p.37` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `COMPILE-AND-LINK` / `FILE-CONTENT` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform COMPILE-AND-LINK on FILE-CONTENT under DURING-UPLOAD-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“FILE-CONTENT”执行“独立编译并链接”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00067` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-018-7D1A5B42A8F9`<br>`ARINC-615A-3 5.4.3.1 p.37` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `DEFINE` / `FILE-CONTENT, PROGRAM-MEMORY-MAP` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform DEFINE on FILE-CONTENT, PROGRAM-MEMORY-MAP under DURING-UPLOAD-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“FILE-CONTENT、PROGRAM-MEMORY-MAP”执行“定义”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00068` | `SU-ARINC-615A-3-5-4-5-2-P053-PROSE-SENTENCE-008-6BD76320C0DE`<br>`ARINC-615A-3 5.4.5.2 p.41` | `DATA-LOADER` / `DURING-COMMON-SCOPE` / `ABORT` / `STATUS-FILE, TEXT-FIELD, OPERATION` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform ABORT on STATUS-FILE, TEXT-FIELD, OPERATION under DURING-COMMON-SCOPE; evidence is the resulting ABORT-RESULT-OBSERVABLE.<br>参与者“数据加载器”在“在 COMMON 范围内”下必须对“状态文件、文本字段、协议操作”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00069` | `SU-ARINC-615A-3-6-2-8-1-P057-PROSE-SENTENCE-001-B9AF73779529`<br>`ARINC-615A-3 6.2.8.1 p.45` | `TARGET-HARDWARE` / `ON-WAIT-MESSAGE-RECEIPT` / `RETRY` / `TARGET-HARDWARE-ID, PROTOCOL-MESSAGE` / `RETRY-ATTEMPT-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-BASE` | Actor TARGET-HARDWARE shall perform RETRY on TARGET-HARDWARE-ID, PROTOCOL-MESSAGE under ON-WAIT-MESSAGE-RECEIPT; evidence is the resulting RETRY-ATTEMPT-OBSERVABLE.<br>参与者“目标硬件”在“收到 WAIT 消息时”下必须对“TARGET-HARDWARE-ID、PROTOCOL-MESSAGE”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00070` | `SU-ARINC-615A-3-6-3-1-P063-PROSE-SENTENCE-010-EF2C1FAB94E9`<br>`ARINC-615A-3 6.3.1 p.51` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `DEFINE` / `STATUS-FILE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform DEFINE on STATUS-FILE under DURING-INFORMATION-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“状态文件”执行“定义”；证据是“状态或编码结果可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00071` | `SU-ARINC-615A-3-6-3-1-P063-PROSE-SENTENCE-014-46E366631127`<br>`ARINC-615A-3 6.3.1 p.51` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `STATUS-FILE, NETWORK-INTERFACE, PROTOCOL-ERROR` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform ENCODE on STATUS-FILE, NETWORK-INTERFACE, PROTOCOL-ERROR under DURING-INFORMATION-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“状态文件、网络接口、PROTOCOL-ERROR”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00072` | `SU-ARINC-615A-3-6-3-1-P063-PROSE-SENTENCE-015-FFB177F65B0A`<br>`ARINC-615A-3 6.3.1 p.51` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `ABORT` / `ABORT-MESSAGE, STATUS-FILE, NETWORK-INTERFACE, TARGET-HARDWARE-ID` / `ABORT-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE may perform ABORT on ABORT-MESSAGE, STATUS-FILE, NETWORK-INTERFACE, TARGET-HARDWARE-ID under DURING-INFORMATION-SCOPE; evidence is the resulting ABORT-RESULT-OBSERVABLE.<br>参与者“目标硬件”在“在 INFORMATION 范围内”下可以对“中止消息、状态文件、网络接口、TARGET-HARDWARE-ID”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00073` | `SU-ARINC-615A-3-6-3-1-P063-PROSE-SENTENCE-018-33F16CA0556B`<br>`ARINC-615A-3 6.3.1 p.51` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `SEND` / `STATUS-FILE, TIMEOUT-EXPIRY, LCL-TRANSFER` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE may perform SEND on STATUS-FILE, TIMEOUT-EXPIRY, LCL-TRANSFER under DURING-INFORMATION-SCOPE; evidence is the resulting MESSAGE-OR-FILE-DIRECTION-OBSERVABLE.<br>参与者“目标硬件”在“在 INFORMATION 范围内”下可以对“状态文件、TIMEOUT-EXPIRY、LCL-TRANSFER”执行“发送”；证据是“消息或文件及其方向可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00074` | `SU-ARINC-615A-3-6-3-1-P063-PROSE-SENTENCE-020-D27F9DB819AB`<br>`ARINC-615A-3 6.3.1 p.51` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `SEND` / `STATUS-FILE, TARGET-HARDWARE-ID` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform SEND on STATUS-FILE, TARGET-HARDWARE-ID under DURING-INFORMATION-SCOPE; evidence is the resulting MESSAGE-OR-FILE-DIRECTION-OBSERVABLE.<br>参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“状态文件、TARGET-HARDWARE-ID”执行“发送”；证据是“消息或文件及其方向可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00075` | `SU-ARINC-615A-3-6-3-1-P064-PROSE-SENTENCE-031-D8862D88C46E`<br>`ARINC-615A-3 6.3.1 p.52` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `WAIT` / `EXCEPTION-TIMER, OPERATION, TARGET-HARDWARE-ID` / `WAIT-BEHAVIOR-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform WAIT on EXCEPTION-TIMER, OPERATION, TARGET-HARDWARE-ID under DURING-INFORMATION-SCOPE; evidence is the resulting WAIT-BEHAVIOR-OBSERVABLE.<br>参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“异常计时器、协议操作、TARGET-HARDWARE-ID”执行“等待”；证据是“等待行为可被观察”。 | `MESSAGE-CARRIED-PARAMETER` / `MESSAGE-TIMER-VALUE` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00076` | `SU-ARINC-615A-3-6-3-1-P064-PROSE-SENTENCE-032-E812AC346D09`<br>`ARINC-615A-3 6.3.1 p.52` | `TARGET-HARDWARE-SUPPLIER` / `DURING-INFORMATION-SCOPE` / `WAIT` / `EXCEPTION-TIMER, TARGET-HARDWARE-ID` / `WAIT-BEHAVIOR-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE-SUPPLIER shall perform WAIT on EXCEPTION-TIMER, TARGET-HARDWARE-ID under DURING-INFORMATION-SCOPE; evidence is the resulting WAIT-BEHAVIOR-OBSERVABLE.<br>参与者“目标硬件供应商”在“在 INFORMATION 范围内”下必须对“异常计时器、TARGET-HARDWARE-ID”执行“等待”；证据是“等待行为可被观察”。 | `MESSAGE-CARRIED-PARAMETER` / `MESSAGE-TIMER-VALUE` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00077` | `SU-ARINC-615A-3-6-3-1-P064-PROSE-SENTENCE-033-2765B9535D98`<br>`ARINC-615A-3 6.3.1 p.52` | `DATA-LOADER` / `BEFORE-MESSAGE-TIMER-EXPIRY` / `ABORT` / `STATUS-FILE, OPERATION` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform ABORT on STATUS-FILE, OPERATION under BEFORE-MESSAGE-TIMER-EXPIRY; evidence is the resulting ABORT-RESULT-OBSERVABLE.<br>参与者“数据加载器”在“消息携带计时值到期前”下必须对“状态文件、协议操作”执行“中止”；证据是“中止结果可被观察”。 | `MESSAGE-CARRIED-PARAMETER` / `MESSAGE-TIMER-VALUE` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00078` | `SU-ARINC-615A-3-6-3-2-P067-PROSE-SENTENCE-020-43C35127F07F`<br>`ARINC-615A-3 6.3.2 p.55` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `DEFINE` / `STATUS-FILE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform DEFINE on STATUS-FILE under DURING-UPLOAD-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“状态文件”执行“定义”；证据是“状态或编码结果可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00079` | `SU-ARINC-615A-3-6-3-2-P067-PROSE-SENTENCE-022-9B7AA17CBAF6`<br>`ARINC-615A-3 6.3.2 p.55` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `ENCODE` / `STATUS-FILE, NETWORK-INTERFACE, PROTOCOL-ERROR` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor TARGET-HARDWARE shall perform ENCODE on STATUS-FILE, NETWORK-INTERFACE, PROTOCOL-ERROR under DURING-UPLOAD-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“目标硬件”在“在 UPLOAD 范围内”下必须对“状态文件、网络接口、PROTOCOL-ERROR”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00080` | `SU-ARINC-615A-3-6-3-2-P067-PROSE-SENTENCE-023-AEFFB70E9596`<br>`ARINC-615A-3 6.3.2 p.55` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `ABORT` / `ABORT-MESSAGE, STATUS-FILE, NETWORK-INTERFACE, TARGET-HARDWARE-ID` / `ABORT-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-BASE` | Actor TARGET-HARDWARE may perform ABORT on ABORT-MESSAGE, STATUS-FILE, NETWORK-INTERFACE, TARGET-HARDWARE-ID under DURING-UPLOAD-SCOPE; evidence is the resulting ABORT-RESULT-OBSERVABLE.<br>参与者“目标硬件”在“在 UPLOAD 范围内”下可以对“中止消息、状态文件、网络接口、TARGET-HARDWARE-ID”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00081` | `SU-ARINC-615A-3-6-3-2-P067-PROSE-SENTENCE-026-3B69FEC8B73B`<br>`ARINC-615A-3 6.3.2 p.55` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `TRANSFER` / `UPLOAD-THREAD` / `TRANSFER-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-BASE` | Actor TARGET-HARDWARE may perform TRANSFER on UPLOAD-THREAD under DURING-UPLOAD-SCOPE; evidence is the resulting TRANSFER-OUTCOME-OBSERVABLE.<br>参与者“目标硬件”在“在 UPLOAD 范围内”下可以对“UPLOAD-THREAD”执行“传输”；证据是“传输结果可被观察”。 | — | — |
| `CRS-M1-00082` | `SU-ARINC-615A-3-5-3-2-3-4-P068-PROSE-SENTENCE-016-D8862D88C46E`<br>`ARINC-615A-3 5.3.2.3.4 p.56` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `WAIT` / `EXCEPTION-TIMER, OPERATION, TARGET-HARDWARE-ID` / `WAIT-BEHAVIOR-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform WAIT on EXCEPTION-TIMER, OPERATION, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting WAIT-BEHAVIOR-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下必须对“异常计时器、协议操作、TARGET-HARDWARE-ID”执行“等待”；证据是“等待行为可被观察”。 | `MESSAGE-CARRIED-PARAMETER` / `MESSAGE-TIMER-VALUE` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00083` | `SU-ARINC-615A-3-5-3-2-3-4-P068-PROSE-SENTENCE-017-E812AC346D09`<br>`ARINC-615A-3 5.3.2.3.4 p.56` | `TARGET-HARDWARE-SUPPLIER` / `DURING-COMMON-SCOPE` / `WAIT` / `EXCEPTION-TIMER, TARGET-HARDWARE-ID` / `WAIT-BEHAVIOR-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE-SUPPLIER shall perform WAIT on EXCEPTION-TIMER, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting WAIT-BEHAVIOR-OBSERVABLE.<br>参与者“目标硬件供应商”在“在 COMMON 范围内”下必须对“异常计时器、TARGET-HARDWARE-ID”执行“等待”；证据是“等待行为可被观察”。 | `MESSAGE-CARRIED-PARAMETER` / `MESSAGE-TIMER-VALUE` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00084` | `SU-ARINC-615A-3-5-3-2-3-4-P068-PROSE-SENTENCE-018-2765B9535D98`<br>`ARINC-615A-3 5.3.2.3.4 p.56` | `DATA-LOADER` / `BEFORE-MESSAGE-TIMER-EXPIRY` / `ABORT` / `STATUS-FILE, OPERATION` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform ABORT on STATUS-FILE, OPERATION under BEFORE-MESSAGE-TIMER-EXPIRY; evidence is the resulting ABORT-RESULT-OBSERVABLE.<br>参与者“数据加载器”在“消息携带计时值到期前”下必须对“状态文件、协议操作”执行“中止”；证据是“中止结果可被观察”。 | `MESSAGE-CARRIED-PARAMETER` / `MESSAGE-TIMER-VALUE` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00085` | `SU-ARINC-615A-3-5-3-2-3-4-P068-PROSE-SENTENCE-020-4C1D759A6B9A`<br>`ARINC-615A-3 5.3.2.3.4 p.56` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `SEND` / `STATUS-FILE, DATA-FILE, CRC` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform SEND on STATUS-FILE, DATA-FILE, CRC under DURING-COMMON-SCOPE; evidence is the resulting MESSAGE-OR-FILE-DIRECTION-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“状态文件、数据文件、CRC／校验值”执行“发送”；证据是“消息或文件及其方向可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00086` | `SU-ARINC-615A-3-6-3-5-P076-PROSE-SENTENCE-009-BF2F613AC35B`<br>`ARINC-615A-3 6.3.5 p.64` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `ABORT` / `STATUS-FILE, TARGET-HARDWARE-ID` / `ABORT-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE may perform ABORT on STATUS-FILE, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting ABORT-RESULT-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下可以对“状态文件、TARGET-HARDWARE-ID”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00087` | `SU-ARINC-615A-3-6-3-5-P076-PROSE-SENTENCE-011-5B38B1E3DBEF`<br>`ARINC-615A-3 6.3.5 p.64` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `ABORT` / `STATUS-FILE, OPERATION, TARGET-HARDWARE-ID` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform ABORT on STATUS-FILE, OPERATION, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting ABORT-RESULT-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下必须对“状态文件、协议操作、TARGET-HARDWARE-ID”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00088` | `SU-ARINC-615A-3-6-3-5-P076-PROSE-SENTENCE-012-EED68957A0BC`<br>`ARINC-615A-3 6.3.5 p.64` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `ABORT` / `ABORT-MESSAGE, OPERATION, TARGET-HARDWARE-ID` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform ABORT on ABORT-MESSAGE, OPERATION, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting ABORT-RESULT-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下必须对“中止消息、协议操作、TARGET-HARDWARE-ID”执行“中止”；证据是“中止结果可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00089` | `SU-ARINC-615A-3-6-3-5-P076-PROSE-SENTENCE-013-DEDC03B64B0A`<br>`ARINC-615A-3 6.3.5 p.64` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `ABORT` / `STATUS-FILE, ERROR-MESSAGE, TARGET-HARDWARE-ID` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform ABORT on STATUS-FILE, ERROR-MESSAGE, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting ABORT-RESULT-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下必须对“状态文件、错误消息、TARGET-HARDWARE-ID”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00090` | `SU-ARINC-615A-3-6-3-5-P076-PROSE-SENTENCE-015-DCA535962C3D`<br>`ARINC-615A-3 6.3.5 p.64` | `DATA-LOADER` / `DURING-COMMON-SCOPE` / `ABORT` / `ABORT-MESSAGE, OPERATION` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform ABORT on ABORT-MESSAGE, OPERATION under DURING-COMMON-SCOPE; evidence is the resulting ABORT-RESULT-OBSERVABLE.<br>参与者“数据加载器”在“在 COMMON 范围内”下必须对“中止消息、协议操作”执行“中止”；证据是“中止结果可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00091` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-005-1B24BCFF8198`<br>`ARINC-615A-3 6.4 p.65` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `SEND` / `PROTOCOL-VERSION, OPERATION, NETWORK-INTERFACE, TARGET-HARDWARE-ID` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform SEND on PROTOCOL-VERSION, OPERATION, NETWORK-INTERFACE, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting MESSAGE-OR-FILE-DIRECTION-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下必须对“协议版本、协议操作、网络接口、TARGET-HARDWARE-ID”执行“发送”；证据是“消息或文件及其方向可被观察”。 | — | — |
| `CRS-M1-00092` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-007-20EF70E6EF8B`<br>`ARINC-615A-3 6.4 p.65` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `IMPLEMENT` / `PROTOCOL-VERSION, OPERATION, TARGET-HARDWARE-ID` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform IMPLEMENT on PROTOCOL-VERSION, OPERATION, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下必须对“协议版本、协议操作、TARGET-HARDWARE-ID”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00093` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-009-5F21110D7E4B`<br>`ARINC-615A-3 6.4 p.65` | `PROTOCOL-FILE-PRODUCER` / `DURING-COMMON-SCOPE` / `DEFINE` / `PROTOCOL-VERSION, NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-FILE-PRODUCER shall perform DEFINE on PROTOCOL-VERSION, NETWORK-INTERFACE under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“协议文件生成方”在“在 COMMON 范围内”下必须对“协议版本、网络接口”执行“定义”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00094` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-010-5625CA7DF2D3`<br>`ARINC-615A-3 6.4 p.65` | `PROTOCOL-FILE-PRODUCER` / `WHEN-OPTIONAL-CAPABILITY-IMPLEMENTED` / `IMPLEMENT` / `PROTOCOL-VERSION, NETWORK-INTERFACE` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-FILE-PRODUCER shall perform IMPLEMENT on PROTOCOL-VERSION, NETWORK-INTERFACE under WHEN-OPTIONAL-CAPABILITY-IMPLEMENTED; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“协议文件生成方”在“实现可选能力时”下必须对“协议版本、网络接口”执行“提供能力”；证据是“能力可用性可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00095` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-012-2FCCE7C4573B`<br>`ARINC-615A-3 6.4 p.65` | `DATA-LOADER` / `WHEN-OPTIONAL-CAPABILITY-IMPLEMENTED` / `ABORT` / `PROTOCOL-VERSION` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform ABORT on PROTOCOL-VERSION under WHEN-OPTIONAL-CAPABILITY-IMPLEMENTED; evidence is the resulting ABORT-RESULT-OBSERVABLE.<br>参与者“数据加载器”在“实现可选能力时”下必须对“协议版本”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00096` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-013-569F14A5E296`<br>`ARINC-615A-3 6.4 p.65` | `DATA-LOADER` / `WHEN-PROTOCOL-VERSIONS-DIFFER` / `ABORT` / `ABORT-MESSAGE, STATUS-FILE, PROTOCOL-VERSION, OPERATION` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform ABORT on ABORT-MESSAGE, STATUS-FILE, PROTOCOL-VERSION, OPERATION under WHEN-PROTOCOL-VERSIONS-DIFFER; evidence is the resulting ABORT-RESULT-OBSERVABLE.<br>参与者“数据加载器”在“协议版本不兼容时”下必须对“中止消息、状态文件、协议版本、协议操作”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00097` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-014-425EEC39D73C`<br>`ARINC-615A-3 6.4 p.65` | `PROTOCOL-FILE-PRODUCER` / `DURING-COMMON-SCOPE` / `ENCODE` / `PROTOCOL-VERSION` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-FILE-PRODUCER shall perform ENCODE on PROTOCOL-VERSION under DURING-COMMON-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“协议文件生成方”在“在 COMMON 范围内”下必须对“协议版本”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00098` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-016-280B7BBBB75A`<br>`ARINC-615A-3 6.4 p.65` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `ENCODE` / `LOAD-PART-NUMBER, TEXT-FIELD, NETWORK-INTERFACE, LOADABLE-SOFTWARE-PART-NUMBER` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform ENCODE on LOAD-PART-NUMBER, TEXT-FIELD, NETWORK-INTERFACE, LOADABLE-SOFTWARE-PART-NUMBER under DURING-COMMON-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“加载件号、文本字段、网络接口、LOADABLE-SOFTWARE-PART-NUMBER”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00099` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-016-280B7BBBB75A`<br>`ARINC-615A-3 6.4 p.65` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform ENCODE on TEXT-FIELD under DURING-COMMON-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00100` | `SU-ARINC-615A-3-6-4-1-P080-PROSE-SENTENCE-023-B30093B748E5`<br>`ARINC-615A-3 6.4.1 p.68` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ALLOW-PRINTABLE` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ALLOW-PRINTABLE on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“仅允许可打印字符”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00101` | `SU-ARINC-615A-3-6-4-1-P080-PROSE-SENTENCE-023-B30093B748E5`<br>`ARINC-615A-3 6.4.1 p.68` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ENCODE on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00102` | `SU-ARINC-615A-3-6-4-1-P080-PROSE-SENTENCE-023-B30093B748E5`<br>`ARINC-615A-3 6.4.1 p.68` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `CONSTRAIN` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform CONSTRAIN on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“施加边界约束”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00103` | `SU-ARINC-615A-3-6-4-1-P080-PROSE-SENTENCE-024-1532165AA3AE`<br>`ARINC-615A-3 6.4.1 p.68` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ENCODE on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00104` | `SU-ARINC-615A-3-6-4-2-P081-PROSE-SENTENCE-018-7650772794FC`<br>`ARINC-615A-3 6.4.2 p.69` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ENCODE on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00105` | `SU-ARINC-615A-3-6-4-2-P081-PROSE-SENTENCE-023-B016CF154BFD`<br>`ARINC-615A-3 6.4.2 p.69` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ENCODE on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00106` | `SU-ARINC-615A-3-6-4-2-P081-PROSE-SENTENCE-030-B016CF154BFD`<br>`ARINC-615A-3 6.4.2 p.69` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ENCODE on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00107` | `SU-ARINC-615A-3-6-4-2-P082-PROSE-SENTENCE-042-0D59A327A7CC`<br>`ARINC-615A-3 6.4.2 p.70` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ALLOW-PRINTABLE` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ALLOW-PRINTABLE on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“仅允许可打印字符”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00108` | `SU-ARINC-615A-3-6-4-2-P082-PROSE-SENTENCE-042-0D59A327A7CC`<br>`ARINC-615A-3 6.4.2 p.70` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ENCODE on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00109` | `SU-ARINC-615A-3-6-4-2-P082-PROSE-SENTENCE-042-0D59A327A7CC`<br>`ARINC-615A-3 6.4.2 p.70` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `CONSTRAIN` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform CONSTRAIN on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“施加边界约束”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00110` | `SU-ARINC-615A-3-6-4-2-P082-PROSE-SENTENCE-043-1532165AA3AE`<br>`ARINC-615A-3 6.4.2 p.70` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ENCODE on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00111` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-029-C2788AA6D18A`<br>`ARINC-615A-3 6.4.3 p.72` | `PROTOCOL-FILE-PRODUCER` / `WHEN-STATUS-CODE-IS-0002-OR-0004` / `ENCODE` / `STATUS-CODE-CONDITIONAL-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-FILE-PRODUCER shall perform ENCODE on STATUS-CODE-CONDITIONAL-FIELD under WHEN-STATUS-CODE-IS-0002-OR-0004; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“协议文件生成方”在“状态码为 0x0002 或 0x0004 时”下必须对“STATUS-CODE-CONDITIONAL-FIELD”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00112` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-034-65EBA86ACA77`<br>`ARINC-615A-3 6.4.3 p.72` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `PROVIDE` / `ESTIMATED-TIME, OPERATION` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform PROVIDE on ESTIMATED-TIME, OPERATION under DURING-INFORMATION-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“预计时间、协议操作”执行“提供”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00113` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-037-98AB79F99A7B`<br>`ARINC-615A-3 6.4.3 p.72` | `TARGET-HARDWARE` / `WHEN-TIMER-VALUE-IS-NOT-PROVIDED` / `ENCODE` / `ESTIMATED-TIME, TARGET-HARDWARE-ID` / `ENCODED-FIELD-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform ENCODE on ESTIMATED-TIME, TARGET-HARDWARE-ID under WHEN-TIMER-VALUE-IS-NOT-PROVIDED; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“目标硬件”在“目标未提供计时值时”下必须对“预计时间、TARGET-HARDWARE-ID”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00114` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-043-83077CACF0DC`<br>`ARINC-615A-3 6.4.3 p.72` | `PROTOCOL-FILE-PRODUCER` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `STATUS-CODE-CONDITIONAL-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-FILE-PRODUCER may perform ENCODE on STATUS-CODE-CONDITIONAL-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“协议文件生成方”在“在 INFORMATION 范围内”下可以对“STATUS-CODE-CONDITIONAL-FIELD”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00115` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-045-1B483243E195`<br>`ARINC-615A-3 6.4.3 p.72` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ALLOW-PRINTABLE` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ALLOW-PRINTABLE on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“仅允许可打印字符”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00116` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-045-1B483243E195`<br>`ARINC-615A-3 6.4.3 p.72` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ENCODE on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00117` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-045-1B483243E195`<br>`ARINC-615A-3 6.4.3 p.72` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `CONSTRAIN` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform CONSTRAIN on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“施加边界约束”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00118` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-046-1532165AA3AE`<br>`ARINC-615A-3 6.4.3 p.72` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ENCODE on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00119` | `SU-ARINC-615A-3-6-4-4-P085-PROSE-SENTENCE-013-D5E44774D202`<br>`ARINC-615A-3 6.4.4 p.73` | `PROTOCOL-FILE-PRODUCER` / `DURING-UPLOAD-SCOPE` / `ENCODE` / `HEADER-FILE` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor PROTOCOL-FILE-PRODUCER shall perform ENCODE on HEADER-FILE under DURING-UPLOAD-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“协议文件生成方”在“在 UPLOAD 范围内”下必须对“头文件”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00120` | `SU-ARINC-615A-3-6-4-4-P085-PROSE-SENTENCE-018-1532165AA3AE`<br>`ARINC-615A-3 6.4.4 p.73` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ENCODE on TEXT-FIELD under DURING-UPLOAD-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00121` | `SU-ARINC-615A-3-6-4-4-P085-PROSE-SENTENCE-023-53AAFA003A8B`<br>`ARINC-615A-3 6.4.4 p.73` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `ALLOW-PRINTABLE` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ALLOW-PRINTABLE on TEXT-FIELD under DURING-UPLOAD-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“文本字段”执行“仅允许可打印字符”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00122` | `SU-ARINC-615A-3-6-4-4-P085-PROSE-SENTENCE-023-53AAFA003A8B`<br>`ARINC-615A-3 6.4.4 p.73` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ENCODE on TEXT-FIELD under DURING-UPLOAD-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00123` | `SU-ARINC-615A-3-6-4-4-P085-PROSE-SENTENCE-023-53AAFA003A8B`<br>`ARINC-615A-3 6.4.4 p.73` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `CONSTRAIN` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform CONSTRAIN on TEXT-FIELD under DURING-UPLOAD-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“文本字段”执行“施加边界约束”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00124` | `SU-ARINC-615A-3-6-4-4-P085-PROSE-SENTENCE-024-1532165AA3AE`<br>`ARINC-615A-3 6.4.4 p.73` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ENCODE on TEXT-FIELD under DURING-UPLOAD-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00125` | `SU-ARINC-615A-3-6-4-10-P094-PROSE-SENTENCE-001-53AAFA003A8B`<br>`ARINC-615A-3 6.4.10 p.82` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ALLOW-PRINTABLE` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ALLOW-PRINTABLE on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“仅允许可打印字符”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00126` | `SU-ARINC-615A-3-6-4-10-P094-PROSE-SENTENCE-001-53AAFA003A8B`<br>`ARINC-615A-3 6.4.10 p.82` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ENCODE on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00127` | `SU-ARINC-615A-3-6-4-10-P094-PROSE-SENTENCE-001-53AAFA003A8B`<br>`ARINC-615A-3 6.4.10 p.82` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `CONSTRAIN` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform CONSTRAIN on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“施加边界约束”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00128` | `SU-ARINC-615A-3-6-4-10-P094-PROSE-SENTENCE-002-1532165AA3AE`<br>`ARINC-615A-3 6.4.10 p.82` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ENCODE on TEXT-FIELD under DURING-INFORMATION-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00129` | `SU-ARINC-615A-3-6-4-10-P096-PROSE-SENTENCE-003-2C9653D1AE20`<br>`ARINC-615A-3 6.4.10 p.84` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `DISPLAY` / `TEXT-FIELD, TARGET-HARDWARE-ID` / `USER-INDICATION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform DISPLAY on TEXT-FIELD, TARGET-HARDWARE-ID under DURING-INFORMATION-SCOPE; evidence is the resulting USER-INDICATION-OBSERVABLE.<br>参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“文本字段、TARGET-HARDWARE-ID”执行“显示或通知”；证据是“用户提示可被观察”。 | — | — |
| `CRS-M1-00130` | `SU-ARINC-615A-3-6-4-10-P097-PROSE-SENTENCE-004-5D81ED14D19B`<br>`ARINC-615A-3 6.4.10 p.85` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `WAIT` / `NETWORK-INTERFACE, TARGET-HARDWARE-ID` / `WAIT-BEHAVIOR-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform WAIT on NETWORK-INTERFACE, TARGET-HARDWARE-ID under DURING-INFORMATION-SCOPE; evidence is the resulting WAIT-BEHAVIOR-OBSERVABLE.<br>参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“网络接口、TARGET-HARDWARE-ID”执行“等待”；证据是“等待行为可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00131` | `SU-ARINC-615A-3-6-4-10-P097-PROSE-SENTENCE-012-F313FBEE280D`<br>`ARINC-615A-3 6.4.10 p.85` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `ABORT` / `STATUS-FILE, TEXT-FIELD, OPERATION, TARGET-HARDWARE-ID` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform ABORT on STATUS-FILE, TEXT-FIELD, OPERATION, TARGET-HARDWARE-ID under DURING-INFORMATION-SCOPE; evidence is the resulting ABORT-RESULT-OBSERVABLE.<br>参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“状态文件、文本字段、协议操作、TARGET-HARDWARE-ID”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00132` | `SU-ARINC-615A-3-6-4-10-P097-PROSE-SENTENCE-014-DEF9DE65D40B`<br>`ARINC-615A-3 6.4.10 p.85` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `DISPLAY` / `STATUS-FILE, TEXT-FIELD, OPERATION, TARGET-HARDWARE-ID` / `USER-INDICATION-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform DISPLAY on STATUS-FILE, TEXT-FIELD, OPERATION, TARGET-HARDWARE-ID under DURING-INFORMATION-SCOPE; evidence is the resulting USER-INDICATION-OBSERVABLE.<br>参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“状态文件、文本字段、协议操作、TARGET-HARDWARE-ID”执行“显示或通知”；证据是“用户提示可被观察”。 | — | — |
| `CRS-M1-00133` | `SU-ARINC-615A-3-6-4-10-P099-PROSE-SENTENCE-020-C650FAC6A8D8`<br>`ARINC-615A-3 6.4.10 p.87` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ASSIGN` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform ASSIGN on NETWORK-INTERFACE under DURING-INFORMATION-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“网络接口”执行“分配或管理”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00134` | `SU-ARINC-615A-3-6-4-10-P099-PROSE-SENTENCE-021-7D0DD652080D`<br>`ARINC-615A-3 6.4.10 p.87` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `PROVIDE` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT may perform PROVIDE on NETWORK-INTERFACE under DURING-INFORMATION-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下可以对“网络接口”执行“提供”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00135` | `SU-ARINC-615A-3-6-4-10-P099-PROSE-SENTENCE-023-7640457B8D57`<br>`ARINC-615A-3 6.4.10 p.87` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `USE` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-PARTICIPANT shall perform USE on NETWORK-INTERFACE under DURING-INFORMATION-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“网络接口”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00136` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-005-D75104E5A8FF`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `RETRY` / `TIMEOUT-AND-RETRY-LAYERS` / `RETRY-ATTEMPT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform RETRY on TIMEOUT-AND-RETRY-LAYERS under DURING-COMMON-SCOPE; evidence is the resulting RETRY-ATTEMPT-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TIMEOUT-AND-RETRY-LAYERS”执行“重试”；证据是“重试尝试可被观察”。 | — | — |
| `CRS-M1-00137` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-008-F320813241E5`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `TRANSFER` / `TFTP-FILE-TRANSFER` / `TRANSFER-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform TRANSFER on TFTP-FILE-TRANSFER under DURING-COMMON-SCOPE; evidence is the resulting TRANSFER-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TFTP 文件传输”执行“传输”；证据是“传输结果可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `TFTP-TO` / `UNRESOLVED..UNRESOLVED s` | DEP-RFC-1350 |
| `CRS-M1-00138` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-009-414439744FBA`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `ACKNOWLEDGE` / `TIMEOUT-EXPIRY` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform ACKNOWLEDGE on TIMEOUT-EXPIRY under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TIMEOUT-EXPIRY”执行“确认”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00139` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-011-D951F3C8D8DC`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `RETRY` / `TFTP-FILE-TRANSFER` / `RETRY-ATTEMPT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION may perform RETRY on TFTP-FILE-TRANSFER under DURING-COMMON-SCOPE; evidence is the resulting RETRY-ATTEMPT-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下可以对“TFTP 文件传输”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00140` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-012-DCEA052A12C5`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `AFTER-RETRY-LIMIT-EXHAUSTION` / `RETRY` / `TFTP-FILE-TRANSFER, RETRY-NUMBER` / `RETRY-ATTEMPT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform RETRY on TFTP-FILE-TRANSFER, RETRY-NUMBER under AFTER-RETRY-LIMIT-EXHAUSTION; evidence is the resulting RETRY-ATTEMPT-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“重试限额耗尽后”下必须对“TFTP 文件传输、RETRY-NUMBER”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00141` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-013-0E511BD5A2AE`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `PROVIDE` / `PROTOCOL-ERROR` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform PROVIDE on PROTOCOL-ERROR under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“PROTOCOL-ERROR”执行“提供”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00142` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-015-7C1E9A3C2D05`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `ON-TFTP-ERROR` / `RETRY` / `TFTP-FILE-TRANSFER` / `RETRY-ATTEMPT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform RETRY on TFTP-FILE-TRANSFER under ON-TFTP-ERROR; evidence is the resulting RETRY-ATTEMPT-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“TFTP 层报告错误时”下必须对“TFTP 文件传输”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00143` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-016-BC84E4EE3A39`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `AFTER-RETRY-LIMIT-EXHAUSTION` / `RETRY` / `TFTP-FILE-TRANSFER, PROTOCOL-ERROR, RETRY-NUMBER` / `RETRY-ATTEMPT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform RETRY on TFTP-FILE-TRANSFER, PROTOCOL-ERROR, RETRY-NUMBER under AFTER-RETRY-LIMIT-EXHAUSTION; evidence is the resulting RETRY-ATTEMPT-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“重试限额耗尽后”下必须对“TFTP 文件传输、PROTOCOL-ERROR、RETRY-NUMBER”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00144` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-017-C80348B18729`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `FAIL` / `PROTOCOL-ERROR` / `FAILURE-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform FAIL on PROTOCOL-ERROR under DURING-COMMON-SCOPE; evidence is the resulting FAILURE-RESULT-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“PROTOCOL-ERROR”执行“判定失败”；证据是“失败结果可被观察”。 | — | — |
| `CRS-M1-00145` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-024-35890C54B368`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `ADJUST-UPWARD` / `TIMEOUT-VALUE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform ADJUST-UPWARD on TIMEOUT-VALUE under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TIMEOUT-VALUE”执行“向上调整”；证据是“状态或编码结果可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00146` | `SU-ARINC-615A-3-4-3-1-P112-PROSE-SENTENCE-004-4C05C3174D37`<br>`ARINC-615A-3 4-3.1 p.100` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `SET-CONSTANT` / `TIMEOUT-VALUE` / `CONSTANT-VALUE-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform SET-CONSTANT on TIMEOUT-VALUE under DURING-COMMON-SCOPE; evidence is the resulting CONSTANT-VALUE-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TIMEOUT-VALUE”执行“设置固定常数”；证据是“固定取值可被观察”。 | `FIXED-SOURCE-CONSTANT` / `TFTP-TO` / `0..2 s` | — |
| `CRS-M1-00147` | `SU-ARINC-615A-3-4-3-1-P112-PROSE-SENTENCE-005-88F51ABD3389`<br>`ARINC-615A-3 4-3.1 p.100` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `PROHIBIT` / `TFTP-EXCHANGE, TIMEOUT-VALUE` / `PROHIBITED-EVENT-ABSENCE-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform PROHIBIT on TFTP-EXCHANGE, TIMEOUT-VALUE under DURING-COMMON-SCOPE; evidence is the resulting PROHIBITED-EVENT-ABSENCE-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TFTP 交换、TIMEOUT-VALUE”执行“禁止”；证据是“受禁事件不出现可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `TFTP-TO` / `UNRESOLVED..UNRESOLVED s` | DEP-RFC-1350 |
| `CRS-M1-00148` | `SU-ARINC-615A-3-4-3-1-P112-PROSE-SENTENCE-007-69549032F30B`<br>`ARINC-615A-3 4-3.1 p.100` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `SEND` / `TFTP-EXCHANGE` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform SEND on TFTP-EXCHANGE under DURING-COMMON-SCOPE; evidence is the resulting MESSAGE-OR-FILE-DIRECTION-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TFTP 交换”执行“发送”；证据是“消息或文件及其方向可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00149` | `SU-ARINC-615A-3-4-3-2-P113-PROSE-SENTENCE-001-205BD6EF24F3`<br>`ARINC-615A-3 4-3.2 p.101` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `RETRY` / `TFTP-EXCHANGE, RETRY-NUMBER, TARGET-HARDWARE-ID` / `RETRY-ATTEMPT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE may perform RETRY on TFTP-EXCHANGE, RETRY-NUMBER, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting RETRY-ATTEMPT-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下可以对“TFTP 交换、RETRY-NUMBER、TARGET-HARDWARE-ID”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00150` | `SU-ARINC-615A-3-4-3-2-P113-PROSE-SENTENCE-011-A604F56F9739`<br>`ARINC-615A-3 4-3.2 p.101` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `RETRY` / `RETRY-NUMBER` / `RETRY-ATTEMPT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform RETRY on RETRY-NUMBER under DURING-COMMON-SCOPE; evidence is the resulting RETRY-ATTEMPT-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“RETRY-NUMBER”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00151` | `SU-ARINC-615A-3-4-3-3-P114-PROSE-SENTENCE-001-5174295F548B`<br>`ARINC-615A-3 4-3.3 p.102` | `PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `ENCODE` / `SORCERERS-APPRENTICE-FIX` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-IMPLEMENTATION shall perform ENCODE on SORCERERS-APPRENTICE-FIX under DURING-COMMON-SCOPE; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“协议实现”在“在 COMMON 范围内”下必须对“SORCERERS-APPRENTICE-FIX”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | DEP-RFC-1123, DEP-RFC-1350 |
| `CRS-M1-00152` | `SU-ARINC-615A-3-4-3-3-P114-PROSE-SENTENCE-002-889533B1AA3F`<br>`ARINC-615A-3 4-3.3 p.102` | `TFTP-SENDER` / `DURING-COMMON-SCOPE` / `SEND` / `TFTP-EXCHANGE` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TFTP-SENDER shall perform SEND on TFTP-EXCHANGE under DURING-COMMON-SCOPE; evidence is the resulting MESSAGE-OR-FILE-DIRECTION-OBSERVABLE.<br>参与者“TFTP 发送方”在“在 COMMON 范围内”下必须对“TFTP 交换”执行“发送”；证据是“消息或文件及其方向可被观察”。 | — | — |
| `CRS-M1-00153` | `SU-ARINC-615A-3-4-3-3-P114-PROSE-SENTENCE-002-889533B1AA3F`<br>`ARINC-615A-3 4-3.3 p.102` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `ON-DUPLICATE-ACKNOWLEDGEMENT` / `SEND` / `TFTP-EXCHANGE, NETWORK-INTERFACE` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform SEND on TFTP-EXCHANGE, NETWORK-INTERFACE under ON-DUPLICATE-ACKNOWLEDGEMENT; evidence is the resulting MESSAGE-OR-FILE-DIRECTION-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“收到重复确认时”下必须对“TFTP 交换、网络接口”执行“发送”；证据是“消息或文件及其方向可被观察”。 | — | — |
| `CRS-M1-00154` | `SU-ARINC-615A-3-4-4-1-P114-PROSE-SENTENCE-003-7C29399D1DAB`<br>`ARINC-615A-3 4-4.1 p.102` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `TRANSFER` / `TFTP-FILE-TRANSFER` / `TRANSFER-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform TRANSFER on TFTP-FILE-TRANSFER under DURING-COMMON-SCOPE; evidence is the resulting TRANSFER-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TFTP 文件传输”执行“传输”；证据是“传输结果可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | DEP-RFC-1350 |
| `CRS-M1-00155` | `SU-ARINC-615A-3-4-4-1-P114-PROSE-SENTENCE-006-02C6AA3F66A1`<br>`ARINC-615A-3 4-4.1 p.102` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `ADJUST-UPWARD` / `TIMEOUT-VALUE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform ADJUST-UPWARD on TIMEOUT-VALUE under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TIMEOUT-VALUE”执行“向上调整”；证据是“状态或编码结果可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00156` | `SU-ARINC-615A-3-4-4-1-P114-PROSE-SENTENCE-008-4848608477C0`<br>`ARINC-615A-3 4-4.1 p.102` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `SEND` / `STATUS-FILE, TARGET-HARDWARE-ID` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform SEND on STATUS-FILE, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting MESSAGE-OR-FILE-DIRECTION-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下必须对“状态文件、TARGET-HARDWARE-ID”执行“发送”；证据是“消息或文件及其方向可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00157` | `SU-ARINC-615A-3-4-4-1-P114-PROSE-SENTENCE-011-BD0CBB7058D1`<br>`ARINC-615A-3 4-4.1 p.102` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `PROVIDE` / `TIMEOUT-VALUE, TARGET-HARDWARE-ID` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform PROVIDE on TIMEOUT-VALUE, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下必须对“TIMEOUT-VALUE、TARGET-HARDWARE-ID”执行“提供”；证据是“状态或编码结果可被观察”。 | `FIXED-SOURCE-CONSTANT` / `DLP-TO` / `0..13 s` | — |
| `CRS-M1-00158` | `SU-ARINC-615A-3-4-4-1-P114-PROSE-SENTENCE-012-FB8820DE2238`<br>`ARINC-615A-3 4-4.1 p.102` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `SEND` / `TFTP-EXCHANGE, TFTP-FILE-TRANSFER, TARGET-HARDWARE-ID` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform SEND on TFTP-EXCHANGE, TFTP-FILE-TRANSFER, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting MESSAGE-OR-FILE-DIRECTION-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下必须对“TFTP 交换、TFTP 文件传输、TARGET-HARDWARE-ID”执行“发送”；证据是“消息或文件及其方向可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | DEP-RFC-1350 |
| `CRS-M1-00159` | `SU-ARINC-615A-3-4-4-1-P115-PROSE-SENTENCE-015-A31F93757E22`<br>`ARINC-615A-3 4-4.1 p.103` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `CONSTRAIN` / `TIMEOUT-VALUE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor ARINC-615A-PROTOCOL-IMPLEMENTATION shall perform CONSTRAIN on TIMEOUT-VALUE under DURING-COMMON-SCOPE; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TIMEOUT-VALUE”执行“施加边界约束”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00160` | `SU-ARINC-615A-3-4-4-2-1-P115-PROSE-SENTENCE-001-46D0EBEB4FDD`<br>`ARINC-615A-3 4-4.2.1 p.103` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `RETRY` / `TFTP-FILE-TRANSFER, RETRY-NUMBER, TARGET-HARDWARE-ID` / `RETRY-ATTEMPT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE may perform RETRY on TFTP-FILE-TRANSFER, RETRY-NUMBER, TARGET-HARDWARE-ID under DURING-COMMON-SCOPE; evidence is the resulting RETRY-ATTEMPT-OBSERVABLE.<br>参与者“目标硬件”在“在 COMMON 范围内”下可以对“TFTP 文件传输、RETRY-NUMBER、TARGET-HARDWARE-ID”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00161` | `SU-ARINC-665-5-1-3-1-P011-PROSE-SENTENCE-002-93AC8751234E`<br>`ARINC-665-5 1.3.1 p.1` | `DATA-LOADER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `IMPLEMENT` / `SOFTWARE-PART, CONFORMANCE-MODALITY` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform IMPLEMENT on SOFTWARE-PART, CONFORMANCE-MODALITY under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“数据加载器”在“生成 ARINC 665 数据对象时”下必须对“软件加载件、CONFORMANCE-MODALITY”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00162` | `SU-ARINC-665-5-1-3-1-P011-PROSE-SENTENCE-003-F4F4BC419A09`<br>`ARINC-665-5 1.3.1 p.1` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `IMPLEMENT` / `NETWORK-INTERFACE, CONFORMANCE-MODALITY` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform IMPLEMENT on NETWORK-INTERFACE, CONFORMANCE-MODALITY under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“网络接口、CONFORMANCE-MODALITY”执行“提供能力”；证据是“能力可用性可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00163` | `SU-ARINC-665-5-1-3-1-P011-PROSE-SENTENCE-005-BC73FE29F0AF`<br>`ARINC-665-5 1.3.1 p.1` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `USE` / `CONFORMANCE-MODALITY` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER may perform USE on CONFORMANCE-MODALITY under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下可以对“CONFORMANCE-MODALITY”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00164` | `SU-ARINC-665-5-1-3-1-P011-PROSE-SENTENCE-006-3F3CB7AE6B26`<br>`ARINC-665-5 1.3.1 p.1` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-OPTIONAL-CAPABILITY-IMPLEMENTED` / `IMPLEMENT` / `CONFORMANCE-MODALITY` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform IMPLEMENT on CONFORMANCE-MODALITY under WHEN-OPTIONAL-CAPABILITY-IMPLEMENTED; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“软件包生成方”在“实现可选能力时”下必须对“CONFORMANCE-MODALITY”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00165` | `SU-ARINC-665-5-1-3-3-P011-PROSE-SENTENCE-001-E0CA338A51EE`<br>`ARINC-665-5 1.3.3 p.1` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `NETWORK-INTERFACE, DATA-TYPE` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform ENCODE on NETWORK-INTERFACE, DATA-TYPE under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“网络接口、DATA-TYPE”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00166` | `SU-ARINC-665-5-1-4-2-P012-PROSE-SENTENCE-002-D07F6C2D4DAC`<br>`ARINC-665-5 1.4.2 p.2` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `NETWORK-INTERFACE` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform ENCODE on NETWORK-INTERFACE under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“网络接口”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00167` | `SU-ARINC-665-5-1-4-3-P013-PROSE-SENTENCE-003-F355ED0B2EC9`<br>`ARINC-665-5 1.4.3 p.3` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ALLOW-READ` / `FILE-VERSION-COMPATIBILITY` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform ALLOW-READ on FILE-VERSION-COMPATIBILITY under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“FILE-VERSION-COMPATIBILITY”执行“允许读取”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00168` | `SU-ARINC-665-5-1-4-3-P013-PROSE-SENTENCE-004-C23C95885017`<br>`ARINC-665-5 1.4.3 p.3` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `FILE-VERSION-COMPATIBILITY` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform ENCODE on FILE-VERSION-COMPATIBILITY under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“FILE-VERSION-COMPATIBILITY”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00169` | `SU-ARINC-665-5-1-4-4-P013-PROSE-SENTENCE-007-5E8CCA74AF4E`<br>`ARINC-665-5 1.4.4 p.3` | `PROTOCOL-FILE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `HEADER-FILE, LOAD-PART-NUMBER` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-FILE-PRODUCER shall perform ENCODE on HEADER-FILE, LOAD-PART-NUMBER under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“协议文件生成方”在“生成 ARINC 665 数据对象时”下必须对“头文件、加载件号”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00170` | `SU-ARINC-665-5-1-5-P014-PROSE-SENTENCE-002-DBF83061338F`<br>`ARINC-665-5 1.5 p.4` | `TARGET-HARDWARE` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `REFLECT` / `NETWORK-INTERFACE, MANUFACTURER-IDENTIFIER, TARGET-HARDWARE-ID` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform REFLECT on NETWORK-INTERFACE, MANUFACTURER-IDENTIFIER, TARGET-HARDWARE-ID under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“目标硬件”在“生成 ARINC 665 数据对象时”下必须对“网络接口、MANUFACTURER-IDENTIFIER、TARGET-HARDWARE-ID”执行“反映”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00171` | `SU-ARINC-665-5-1-5-P014-PROSE-SENTENCE-003-35251417E277`<br>`ARINC-665-5 1.5 p.4` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ASSIGN` / `MANUFACTURER-IDENTIFIER` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform ASSIGN on MANUFACTURER-IDENTIFIER under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“MANUFACTURER-IDENTIFIER”执行“分配或管理”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00172` | `SU-ARINC-665-5-2-1-P016-PROSE-SENTENCE-001-A7E185845C31`<br>`ARINC-665-5 2.1 p.6` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENSURE-CARDINALITY` / `LOAD-PART-NUMBER, SOFTWARE-PART, LOADABLE-SOFTWARE-PART-NUMBER` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform ENSURE-CARDINALITY on LOAD-PART-NUMBER, SOFTWARE-PART, LOADABLE-SOFTWARE-PART-NUMBER under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“加载件号、软件加载件、LOADABLE-SOFTWARE-PART-NUMBER”执行“保证基数约束”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00173` | `SU-ARINC-665-5-2-1-P016-PROSE-SENTENCE-002-C9B7C44AE544`<br>`ARINC-665-5 2.1 p.6` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `COORDINATE` / `LOAD-PART-NUMBER` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform COORDINATE on LOAD-PART-NUMBER under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“加载件号”执行“协调并批准”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00174` | `SU-ARINC-665-5-2-1-P016-PROSE-SENTENCE-003-D2A78669BC58`<br>`ARINC-665-5 2.1 p.6` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ASSIGN` / `LOAD-PART-NUMBER, SOFTWARE-PART` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform ASSIGN on LOAD-PART-NUMBER, SOFTWARE-PART under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“加载件号、软件加载件”执行“分配或管理”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00175` | `SU-ARINC-665-5-2-1-1-P016-PROSE-SENTENCE-001-79D9D9285B09`<br>`ARINC-665-5 2.1.1 p.6` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `FORMAT` / `LOADABLE-SOFTWARE-PART-NUMBER` / `ENCODED-FORMAT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform FORMAT on LOADABLE-SOFTWARE-PART-NUMBER under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FORMAT-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“LOADABLE-SOFTWARE-PART-NUMBER”执行“按规定格式化”；证据是“编码格式可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00176` | `SU-ARINC-665-5-2-1-1-P016-PROSE-SENTENCE-004-FBE93765B788`<br>`ARINC-665-5 2.1.1 p.6` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `DEFINE` / `LOAD-PART-NUMBER` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform DEFINE on LOAD-PART-NUMBER under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“加载件号”执行“定义”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00177` | `SU-ARINC-665-5-2-1-1-P016-PROSE-SENTENCE-007-6FB26843CBD8`<br>`ARINC-665-5 2.1.1 p.6` | `DATA-LOADER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `IMPLEMENT` / `LOAD-PART-NUMBER` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform IMPLEMENT on LOAD-PART-NUMBER under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“数据加载器”在“生成 ARINC 665 数据对象时”下必须对“加载件号”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00178` | `SU-ARINC-665-5-2-1-1-P016-PROSE-SENTENCE-008-63B5D84BC565`<br>`ARINC-665-5 2.1.1 p.6` | `DATA-LOADER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `USE` / `LOAD-PART-NUMBER` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor DATA-LOADER shall perform USE on LOAD-PART-NUMBER under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“数据加载器”在“生成 ARINC 665 数据对象时”下必须对“加载件号”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00179` | `SU-ARINC-665-5-2-1-3-P017-PROSE-SENTENCE-003-41F8723AEC8B`<br>`ARINC-665-5 2.1.3 p.7` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `COMPUTE` / `CHECK-CHARACTERS` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform COMPUTE on CHECK-CHARACTERS under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CHECK-CHARACTERS”执行“计算”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00180` | `SU-ARINC-665-5-2-2-2-1-P018-PROSE-SENTENCE-001-84EA4A3113C8`<br>`ARINC-665-5 2.2.2.1 p.8` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `FORMAT` / `HEADER-FILE, SOFTWARE-PART` / `ENCODED-FORMAT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform FORMAT on HEADER-FILE, SOFTWARE-PART under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FORMAT-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“头文件、软件加载件”执行“按规定格式化”；证据是“编码格式可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00181` | `SU-ARINC-665-5-2-2-3-1-P018-PROSE-SENTENCE-001-7A7C6DE1A7A7`<br>`ARINC-665-5 2.2.3.1 p.8` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `HEADER-FILE, SOFTWARE-PART` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform ENCODE on HEADER-FILE, SOFTWARE-PART under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“头文件、软件加载件”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00182` | `SU-ARINC-665-5-2-2-3-1-P019-PROSE-SENTENCE-003-D19D48006847`<br>`ARINC-665-5 2.2.3.1 p.9` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `HEADER-FILE` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform ENCODE on HEADER-FILE under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“头文件”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00183` | `SU-ARINC-665-5-2-2-3-1-P019-PROSE-SENTENCE-003-D19D48006847`<br>`ARINC-665-5 2.2.3.1 p.9` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `DEFINE` / `HEADER-FILE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform DEFINE on HEADER-FILE under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“头文件”执行“定义”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00184` | `SU-ARINC-665-5-2-2-3-1-P019-PROSE-SENTENCE-004-A761BB0130D9`<br>`ARINC-665-5 2.2.3.1 p.9` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `BINARY-FIELD-ENCODING` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform ENCODE on BINARY-FIELD-ENCODING under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“BINARY-FIELD-ENCODING”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
...
| `CRS-M1-00186` | `SU-ARINC-665-5-2-2-3-1-3-2-P021-PROSE-SENTENCE-001-641A8CBC9145`<br>`ARINC-665-5 2.2.3.1.3.2 p.11` | `PROTOCOL-FILE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `PART-FLAGS` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-FILE-PRODUCER shall perform ENCODE on PART-FLAGS under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“协议文件生成方”在“生成 ARINC 665 数据对象时”下必须对“PART-FLAGS”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00187` | `SU-ARINC-665-5-2-2-3-1-3-2-P021-PROSE-SENTENCE-001-641A8CBC9145`<br>`ARINC-665-5 2.2.3.1.3.2 p.11` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `BINARY-FIELD-ENCODING` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform ENCODE on BINARY-FIELD-ENCODING under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“BINARY-FIELD-ENCODING”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00188` | `SU-ARINC-665-5-2-2-3-1-10-P022-PROSE-SENTENCE-003-BCEBB784B407`<br>`ARINC-665-5 2.2.3.1.10 p.12` | `TARGET-HARDWARE` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `TARGET-HARDWARE-ID, STATUS-CODE-CONDITIONAL-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform ENCODE on TARGET-HARDWARE-ID, STATUS-CODE-CONDITIONAL-FIELD under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“目标硬件”在“生成 ARINC 665 数据对象时”下必须对“TARGET-HARDWARE-ID、STATUS-CODE-CONDITIONAL-FIELD”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00189` | `SU-ARINC-665-5-2-2-3-1-14-P022-PROSE-SENTENCE-004-4114C0816C51`<br>`ARINC-665-5 2.2.3.1.14 p.12` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `IMPLEMENT` / `LOAD-PART-NUMBER, SOFTWARE-PART` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform IMPLEMENT on LOAD-PART-NUMBER, SOFTWARE-PART under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“加载件号、软件加载件”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00190` | `SU-ARINC-665-5-2-2-3-1-18-P023-PROSE-SENTENCE-002-E664B245877E`<br>`ARINC-665-5 2.2.3.1.18 p.13` | `PROTOCOL-FILE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `NETWORK-INTERFACE, STATUS-CODE-CONDITIONAL-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-FILE-PRODUCER shall perform ENCODE on NETWORK-INTERFACE, STATUS-CODE-CONDITIONAL-FIELD under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“协议文件生成方”在“生成 ARINC 665 数据对象时”下必须对“网络接口、STATUS-CODE-CONDITIONAL-FIELD”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00191` | `SU-ARINC-665-5-2-2-3-1-18-P023-PROSE-SENTENCE-004-C2CE75F23520`<br>`ARINC-665-5 2.2.3.1.18 p.13` | `TARGET-HARDWARE` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENSURE-UNIQUE` / `SOFTWARE-PART, TARGET-HARDWARE-ID` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform ENSURE-UNIQUE on SOFTWARE-PART, TARGET-HARDWARE-ID under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“目标硬件”在“生成 ARINC 665 数据对象时”下必须对“软件加载件、TARGET-HARDWARE-ID”执行“保证唯一性”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00192` | `SU-ARINC-665-5-2-2-3-1-24-P024-PROSE-SENTENCE-002-C100FC8EE4E9`<br>`ARINC-665-5 2.2.3.1.24 p.14` | `TARGET-HARDWARE` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `SOFTWARE-PART, TARGET-HARDWARE-ID` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform ENCODE on SOFTWARE-PART, TARGET-HARDWARE-ID under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“目标硬件”在“生成 ARINC 665 数据对象时”下必须对“软件加载件、TARGET-HARDWARE-ID”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00193` | `SU-ARINC-665-5-2-2-3-1-26-P024-PROSE-SENTENCE-005-38372C2FA366`<br>`ARINC-665-5 2.2.3.1.26 p.14` | `TARGET-HARDWARE` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `TARGET-HARDWARE-ID, STATUS-CODE-CONDITIONAL-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor TARGET-HARDWARE shall perform ENCODE on TARGET-HARDWARE-ID, STATUS-CODE-CONDITIONAL-FIELD under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“目标硬件”在“生成 ARINC 665 数据对象时”下必须对“TARGET-HARDWARE-ID、STATUS-CODE-CONDITIONAL-FIELD”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00194` | `SU-ARINC-665-5-2-2-3-1-31-P025-PROSE-SENTENCE-002-0374CB53F0AB`<br>`ARINC-665-5 2.2.3.1.31 p.15` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `CONSTRAIN` / `DATA-FILE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform CONSTRAIN on DATA-FILE under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“数据文件”执行“施加边界约束”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00195` | `SU-ARINC-665-5-2-2-3-1-32-P025-PROSE-SENTENCE-002-F6BCEFFF8371`<br>`ARINC-665-5 2.2.3.1.32 p.15` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `SET-ZERO` / `DATA-FILE` / `ZERO-VALUE-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform SET-ZERO on DATA-FILE under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ZERO-VALUE-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“数据文件”执行“置零”；证据是“零值可被观察”。 | — | — |
| `CRS-M1-00196` | `SU-ARINC-665-5-2-2-3-1-37-P026-PROSE-SENTENCE-002-05AC99F08A26`<br>`ARINC-665-5 2.2.3.1.37 p.16` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `FORMAT` / `DATA-FILE` / `ENCODED-FORMAT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform FORMAT on DATA-FILE under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FORMAT-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“数据文件”执行“按规定格式化”；证据是“编码格式可被观察”。 | — | — |
| `CRS-M1-00197` | `SU-ARINC-665-5-2-2-3-1-38-P026-PROSE-SENTENCE-002-E3FF88E1EDA0`<br>`ARINC-665-5 2.2.3.1.38 p.16` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `DEFINE` / `CRC, NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform DEFINE on CRC, NETWORK-INTERFACE under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值、网络接口”执行“定义”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00198` | `SU-ARINC-665-5-2-2-3-1-40-P026-PROSE-SENTENCE-002-FCF47A272C90`<br>`ARINC-665-5 2.2.3.1.40 p.16` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform VALIDATE on CRC under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00199` | `SU-ARINC-665-5-2-2-3-1-41-P026-PROSE-SENTENCE-002-91B469DEBE14`<br>`ARINC-665-5 2.2.3.1.41 p.16` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform VALIDATE on CRC under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00200` | `SU-ARINC-665-5-2-2-3-1-42-P026-PROSE-SENTENCE-002-5E94CB4814AF`<br>`ARINC-665-5 2.2.3.1.42 p.16` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform VALIDATE on CRC under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00201` | `SU-ARINC-665-5-2-2-3-1-44-P027-PROSE-SENTENCE-002-AF1722AA2C2B`<br>`ARINC-665-5 2.2.3.1.44 p.17` | `PROTOCOL-FILE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `NETWORK-INTERFACE` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-FILE-PRODUCER shall perform ENCODE on NETWORK-INTERFACE under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“协议文件生成方”在“生成 ARINC 665 数据对象时”下必须对“网络接口”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00202` | `SU-ARINC-665-5-2-2-3-1-45-P027-PROSE-SENTENCE-002-3B48FE46115E`<br>`ARINC-665-5 2.2.3.1.45 p.17` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `IMPLEMENT` / `NETWORK-INTERFACE` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform IMPLEMENT on NETWORK-INTERFACE under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting CAPABILITY-AVAILABILITY-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“网络接口”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00203` | `SU-ARINC-665-5-2-2-3-1-49-P027-PROSE-SENTENCE-004-5EFD86A600D8`<br>`ARINC-665-5 2.2.3.1.49 p.17` | `PROTOCOL-FILE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `LOAD-PART-NUMBER, NETWORK-INTERFACE, STATUS-CODE-CONDITIONAL-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor PROTOCOL-FILE-PRODUCER shall perform ENCODE on LOAD-PART-NUMBER, NETWORK-INTERFACE, STATUS-CODE-CONDITIONAL-FIELD under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“协议文件生成方”在“生成 ARINC 665 数据对象时”下必须对“加载件号、网络接口、STATUS-CODE-CONDITIONAL-FIELD”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00204` | `SU-ARINC-665-5-2-2-3-1-51-P027-PROSE-SENTENCE-002-E3FF88E1EDA0`<br>`ARINC-665-5 2.2.3.1.51 p.17` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `DEFINE` / `CRC, NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform DEFINE on CRC, NETWORK-INTERFACE under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值、网络接口”执行“定义”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00205` | `SU-ARINC-665-5-2-2-3-1-53-P028-PROSE-SENTENCE-002-EE1E5830AB09`<br>`ARINC-665-5 2.2.3.1.53 p.18` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform VALIDATE on CRC under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00206` | `SU-ARINC-665-5-2-2-3-1-54-P028-PROSE-SENTENCE-002-02BC06547867`<br>`ARINC-665-5 2.2.3.1.54 p.18` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC, NETWORK-INTERFACE` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform VALIDATE on CRC, NETWORK-INTERFACE under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值、网络接口”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00207` | `SU-ARINC-665-5-2-2-3-1-57-P028-PROSE-SENTENCE-002-284196C6B3D0`<br>`ARINC-665-5 2.2.3.1.57 p.18` | `OPERATOR` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `HEADER-FILE` / `VALIDATION-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | Actor OPERATOR may perform VALIDATE on HEADER-FILE under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“操作员”在“生成 ARINC 665 数据对象时”下可以对“头文件”执行“验证”；证据是“验证结果可被观察”。 | — | — |
...
| `CRS-M1-00209` | `SU-ARINC-665-5-2-2-3-1-59-P028-PROSE-SENTENCE-002-6672CA36E154`<br>`ARINC-665-5 2.2.3.1.59 p.18` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform VALIDATE on CRC under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00210` | `SU-ARINC-665-5-2-2-3-1-60-P028-PROSE-SENTENCE-002-91B469DEBE14`<br>`ARINC-665-5 2.2.3.1.60 p.18` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform VALIDATE on CRC under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00211` | `SU-ARINC-665-5-2-2-3-1-61-P029-PROSE-SENTENCE-002-6F1B40878C6B`<br>`ARINC-665-5 2.2.3.1.61 p.19` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform VALIDATE on CRC under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00212` | `SU-ARINC-665-5-2-2-3-1-61-P029-PROSE-SENTENCE-003-6155DCD79C06`<br>`ARINC-665-5 2.2.3.1.61 p.19` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform VALIDATE on CRC under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00213` | `SU-ARINC-665-5-2-2-3-1-61-P029-PROSE-SENTENCE-004-9A509D9AE4E2`<br>`ARINC-665-5 2.2.3.1.61 p.19` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform VALIDATE on CRC under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting VALIDATION-RESULT-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00214` | `SU-ARINC-665-5-2-2-3-1-62-P029-PROSE-SENTENCE-002-136B2E7764B0`<br>`ARINC-665-5 2.2.3.1.62 p.19` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `DEFINE` / `HEADER-FILE, CRC, NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform DEFINE on HEADER-FILE, CRC, NETWORK-INTERFACE under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“头文件、CRC／校验值、网络接口”执行“定义”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00215` | `SU-ARINC-665-5-2-2-3-1-63-P029-PROSE-SENTENCE-002-8F49EC0CB8C3`<br>`ARINC-665-5 2.2.3.1.63 p.19` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `COMPUTE` / `HEADER-FILE, CRC` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform COMPUTE on HEADER-FILE, CRC under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“头文件、CRC／校验值”执行“计算”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00216` | `SU-ARINC-665-5-2-2-3-1-63-P029-PROSE-SENTENCE-003-5A9C8CDFFDEB`<br>`ARINC-665-5 2.2.3.1.63 p.19` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `DEFINE` / `CRC, NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform DEFINE on CRC, NETWORK-INTERFACE under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting STATE-OR-ENCODING-OUTCOME-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值、网络接口”执行“定义”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
...
| `CRS-M1-00218` | `SU-ARINC-665-5-2-2-3-3-P029-PROSE-SENTENCE-002-BC8C7608516E`<br>`ARINC-665-5 2.2.3.3 p.19` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `SOFTWARE-PART, NETWORK-INTERFACE, FILE-CONTENT` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Actor SOFTWARE-PACKAGE-PRODUCER shall perform ENCODE on SOFTWARE-PART, NETWORK-INTERFACE, FILE-CONTENT under WHEN-PRODUCING-ARINC-665-DATA-OBJECT; evidence is the resulting ENCODED-FIELD-OBSERVABLE.<br>参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“软件加载件、网络接口、FILE-CONTENT”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
...
- 需求指纹：`748e207be55841515ad66df655c7f31fbdc54f0c4860c71c6c4b958b2514be64`
...
|---|---|---|---|---|---|---|---|
| `CRS-M1-00001` | `SU-ARINC-615A-3-1-2-P014-PROSE-SENTENCE-002-8D3CB7C14FBD`<br>`ARINC-615A-3 1.2 p.2` | `DATA-LOADER` / `DURING-SCOPE-SCOPE` / `IMPLEMENT` / `NETWORK-INTERFACE` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“在 SCOPE 范围内”下必须对“网络接口”执行“提供能力”；证据是“能力可用性可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00002` | `SU-ARINC-615A-3-1-2-P014-PROSE-SENTENCE-003-8280DDEE506E`<br>`ARINC-615A-3 1.2 p.2` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-SCOPE-SCOPE` / `IMPLEMENT` / `CONFORMANCE-MODALITY` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 SCOPE 范围内”下必须对“CONFORMANCE-MODALITY”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00003` | `SU-ARINC-615A-3-1-2-P014-PROSE-SENTENCE-004-9B5A3832A655`<br>`ARINC-615A-3 1.2 p.2` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-SCOPE-SCOPE` / `USE` / `CONFORMANCE-MODALITY` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 SCOPE 范围内”下可以对“CONFORMANCE-MODALITY”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
...
| `CRS-M1-00005` | `SU-ARINC-615A-3-1-3-P014-PROSE-SENTENCE-001-2FA34C046AFB`<br>`ARINC-615A-3 1.3 p.2` | `DATA-LOADER` / `DURING-SCOPE-SCOPE` / `TRANSFER` / `SOFTWARE-PART` / `TRANSFER-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“在 SCOPE 范围内”下必须对“软件加载件”执行“传输”；证据是“传输结果可被观察”。 | — | — |
| `CRS-M1-00006` | `SU-ARINC-615A-3-1-3-P014-PROSE-SENTENCE-002-873AFAE35C45`<br>`ARINC-615A-3 1.3 p.2` | `TARGET-HARDWARE` / `DURING-SCOPE-SCOPE` / `TRANSFER` / `NETWORK-INTERFACE, TARGET-HARDWARE-ID` / `TRANSFER-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 SCOPE 范围内”下必须对“网络接口、TARGET-HARDWARE-ID”执行“传输”；证据是“传输结果可被观察”。 | — | DEP-ARINC-664-2, DEP-ARINC-664-3 |
| `CRS-M1-00007` | `SU-ARINC-615A-3-1-3-P014-PROSE-SENTENCE-005-EC7965CC3D31`<br>`ARINC-615A-3 1.3 p.2` | `DATA-LOADER` / `DURING-SCOPE-SCOPE` / `IMPLEMENT` / `OPERATION, NETWORK-INTERFACE` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“在 SCOPE 范围内”下必须对“协议操作、网络接口”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00008` | `SU-ARINC-615A-3-1-3-P014-PROSE-SENTENCE-007-00560ACC8ACC`<br>`ARINC-615A-3 1.3 p.2` | `DATA-LOADER` / `DURING-SCOPE-SCOPE` / `PROHIBIT` / `DATA-LOADING-TYPES` / `PROHIBITED-EVENT-ABSENCE-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“在 SCOPE 范围内”下必须对“DATA-LOADING-TYPES”执行“禁止”；证据是“受禁事件不出现可被观察”。 | — | — |
| `CRS-M1-00009` | `SU-ARINC-615A-3-1-6-P017-PROSE-SENTENCE-001-6E91C83C11CE`<br>`ARINC-615A-3 1.6 p.5` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-SCOPE-SCOPE` / `DESIGN` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 SCOPE 范围内”下必须对“网络接口”执行“设计”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00010` | `SU-ARINC-615A-3-1-6-P017-PROSE-SENTENCE-003-817EC6E68797`<br>`ARINC-615A-3 1.6 p.5` | `DATA-LOADER` / `DURING-SCOPE-SCOPE` / `IMPLEMENT` / `NETWORK-INTERFACE` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“在 SCOPE 范围内”下必须对“网络接口”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00011` | `SU-ARINC-615A-3-1-6-P017-PROSE-SENTENCE-004-1768AAB8F452`<br>`ARINC-615A-3 1.6 p.5` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-SCOPE-SCOPE` / `ENCODE` / `NETWORK-INTERFACE` / `ENCODED-FIELD-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 SCOPE 范围内”下可以对“网络接口”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00012` | `SU-ARINC-615A-3-1-6-P017-PROSE-SENTENCE-005-358B4BAB3D69`<br>`ARINC-615A-3 1.6 p.5` | `PROTOCOL-IMPLEMENTATION` / `DURING-SCOPE-SCOPE` / `ENCODE` / `NETWORK-INTERFACE` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“协议实现”在“在 SCOPE 范围内”下必须对“网络接口”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00013` | `SU-ARINC-615A-3-1-6-P017-PROSE-SENTENCE-006-711482ED9B24`<br>`ARINC-615A-3 1.6 p.5` | `SOFTWARE-PACKAGE-PRODUCER` / `DURING-SCOPE-SCOPE` / `COMPLY` / `SOFTWARE-PART, NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“在 SCOPE 范围内”下必须对“软件加载件、网络接口”执行“符合”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00014` | `SU-ARINC-615A-3-5-1-P034-PROSE-SENTENCE-015-441CC925118B`<br>`ARINC-615A-3 5.1 p.22` | `PROTOCOL-FILE-PRODUCER` / `DURING-COMMON-SCOPE` / `ENCODE` / `PROTOCOL-FILE-NAME` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“协议文件生成方”在“在 COMMON 范围内”下必须对“PROTOCOL-FILE-NAME”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00015` | `SU-ARINC-615A-3-5-1-P034-PROSE-SENTENCE-016-EE8EBA5E1E47`<br>`ARINC-615A-3 5.1 p.22` | `SOFTWARE-PACKAGE-PRODUCER` / `DURING-COMMON-SCOPE` / `DEFINE` / `SOFTWARE-PART` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“在 COMMON 范围内”下必须对“软件加载件”执行“定义”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00016` | `SU-ARINC-615A-3-5-1-P034-PROSE-SENTENCE-016-EE8EBA5E1E47`<br>`ARINC-615A-3 5.1 p.22` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `COMPLY` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“网络接口”执行“符合”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00017` | `SU-ARINC-615A-3-5-2-P035-PROSE-SENTENCE-011-D07026646B5D`<br>`ARINC-615A-3 5.2 p.23` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `USE` / `FIND-SERVICE, TARGET-HARDWARE-ID` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下必须对“FIND-SERVICE、TARGET-HARDWARE-ID”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00018` | `SU-ARINC-615A-3-5-3-2-2-P037-PROSE-SENTENCE-001-5DE45B64D498`<br>`ARINC-615A-3 5.3.2.2 p.25` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `TRANSFER` / `TFTP-OPTION` / `TRANSFER-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下可以对“TFTP 选项”执行“传输”；证据是“传输结果可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00019` | `SU-ARINC-615A-3-5-3-2-2-P037-PROSE-SENTENCE-003-DE334C18716C`<br>`ARINC-615A-3 5.3.2.2 p.25` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `USE` / `DEFAULT-OPTION-VALUES` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“DEFAULT-OPTION-VALUES”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00020` | `SU-ARINC-615A-3-5-3-2-2-P037-PROSE-SENTENCE-004-FC7D3B3729A1`<br>`ARINC-615A-3 5.3.2.2 p.25` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `TRANSFER` / `TRANSFER-OUTCOME` / `TRANSFER-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TRANSFER-OUTCOME”执行“传输”；证据是“传输结果可被观察”。 | — | — |
| `CRS-M1-00021` | `SU-ARINC-615A-3-5-3-2-2-P037-PROSE-SENTENCE-005-C966C11D19B8`<br>`ARINC-615A-3 5.3.2.2 p.25` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `AFTER-LAST-TFTP-OPTION` / `ABSENT-AFTER-BOUNDARY` / `TFTP-OPTION, NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“最后一个 TFTP 选项结束后”下必须对“TFTP 选项、网络接口”执行“确保边界后不存在数据”；证据是“状态或编码结果可被观察”。 | — | DEP-RFC-768, DEP-RFC-791, DEP-RFC-1350 |
| `CRS-M1-00022` | `SU-ARINC-615A-3-5-3-2-3-2-P037-PROSE-SENTENCE-002-1E0F8D921559`<br>`ARINC-615A-3 5.3.2.3.2 p.25` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `TRANSFER` / `TARGET-HARDWARE-ID` / `TRANSFER-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下可以对“TARGET-HARDWARE-ID”执行“传输”；证据是“传输结果可被观察”。 | — | — |
| `CRS-M1-00023` | `SU-ARINC-615A-3-5-3-2-3-2-P037-PROSE-SENTENCE-004-C976EA5E8074`<br>`ARINC-615A-3 5.3.2.3.2 p.25` | `PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `IMPLEMENT` / `NETWORK-INTERFACE` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“协议实现”在“在 COMMON 范围内”下必须对“网络接口”执行“提供能力”；证据是“能力可用性可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00024` | `SU-ARINC-615A-3-5-3-2-3-3-P038-PROSE-SENTENCE-004-15DBABB1142A`<br>`ARINC-615A-3 5.3.2.3.3 p.26` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `USE` / `ERROR-CODE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“错误码”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00025` | `SU-ARINC-615A-3-5-3-2-3-3-P038-PROSE-SENTENCE-005-A1C528A5F702`<br>`ARINC-615A-3 5.3.2.3.3 p.26` | `PROTOCOL-FILE-PRODUCER` / `DURING-COMMON-SCOPE` / `ENCODE` / `ERROR-CODE, ERROR-MESSAGE` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“协议文件生成方”在“在 COMMON 范围内”下必须对“错误码、错误消息”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00026` | `SU-ARINC-615A-3-5-3-2-3-3-P038-PROSE-SENTENCE-006-06665FE11D6E`<br>`ARINC-615A-3 5.3.2.3.3 p.26` | `PROTOCOL-FILE-PRODUCER` / `DURING-COMMON-SCOPE` / `ENCODE` / `ERROR-CODE, ERROR-MESSAGE` / `ENCODED-FIELD-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“协议文件生成方”在“在 COMMON 范围内”下可以对“错误码、错误消息”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00027` | `SU-ARINC-615A-3-5-3-2-3-3-P038-PROSE-SENTENCE-007-2560DF2DBBD3`<br>`ARINC-615A-3 5.3.2.3.3 p.26` | `TARGET-HARDWARE` / `WHEN-TFTP-RESOURCE-UNAVAILABLE` / `IMPLEMENT` / `ERROR-CODE, TARGET-HARDWARE-ID` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“TFTP 资源不可用时”下必须对“错误码、TARGET-HARDWARE-ID”执行“提供能力”；证据是“能力可用性可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00028` | `SU-ARINC-615A-3-5-3-2-3-3-P038-PROSE-SENTENCE-008-B72528E71CC2`<br>`ARINC-615A-3 5.3.2.3.3 p.26` | `TARGET-HARDWARE` / `WHEN-TFTP-RESOURCE-UNAVAILABLE` / `IMPLEMENT` / `ERROR-CODE, TARGET-HARDWARE-ID` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“TFTP 资源不可用时”下必须对“错误码、TARGET-HARDWARE-ID”执行“提供能力”；证据是“能力可用性可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00029` | `SU-ARINC-615A-3-5-3-2-3-4-P038-PROSE-SENTENCE-004-1F95516BE886`<br>`ARINC-615A-3 5.3.2.3.4 p.26` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `TRANSFER` / `PROTOCOL-MESSAGE` / `TRANSFER-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下可以对“PROTOCOL-MESSAGE”执行“传输”；证据是“传输结果可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00030` | `SU-ARINC-615A-3-5-3-2-3-4-P038-PROSE-SENTENCE-006-D6FEB985BBBB`<br>`ARINC-615A-3 5.3.2.3.4 p.26` | `TFTP-RECEIVER` / `ON-WAIT-MESSAGE-RECEIPT` / `ABORT` / `WAIT-MESSAGE` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“TFTP 接收方”在“收到 WAIT 消息时”下必须对“WAIT 消息”执行“中止”；证据是“中止结果可被观察”。 | `MESSAGE-CARRIED-PARAMETER` / `MESSAGE-TIMER-VALUE` / `UNRESOLVED..UNRESOLVED s` | DEP-RFC-1350 |
| `CRS-M1-00031` | `SU-ARINC-615A-3-5-3-2-3-8-1-P040-PROSE-SENTENCE-001-28CC7C395DC9`<br>`ARINC-615A-3 5.3.2.3.8.1 p.28` | `DATA-LOADER` / `DURING-COMMON-SCOPE` / `IMPLEMENT` / `TFTP-BLOCK-SIZE, NETWORK-INTERFACE` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“在 COMMON 范围内”下必须对“TFTP 块大小、网络接口”执行“提供能力”；证据是“能力可用性可被观察”。 | — | DEP-RFC-791, DEP-RFC-1350, DEP-RFC-2348 |
| `CRS-M1-00032` | `SU-ARINC-615A-3-5-3-2-3-8-1-P040-PROSE-SENTENCE-002-A3F954863D43`<br>`ARINC-615A-3 5.3.2.3.8.1 p.28` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `IMPLEMENT` / `CONFORMANCE-MODALITY, TARGET-HARDWARE-ID` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下必须对“CONFORMANCE-MODALITY、TARGET-HARDWARE-ID”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00033` | `SU-ARINC-615A-3-5-3-2-3-8-1-P041-PROSE-SENTENCE-003-C74E9B3EC0A0`<br>`ARINC-615A-3 5.3.2.3.8.1 p.29` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `USE` / `TFTP-BLOCK-SIZE, TARGET-HARDWARE-ID` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下可以对“TFTP 块大小、TARGET-HARDWARE-ID”执行“使用”；证据是“状态或编码结果可被观察”。 | — | DEP-RFC-1350, DEP-RFC-2348 |
...
| `CRS-M1-00037` | `SU-ARINC-615A-3-5-3-2-3-8-4-P041-PROSE-SENTENCE-001-700C898C606C`<br>`ARINC-615A-3 5.3.2.3.8.4 p.29` | `PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `USE` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“协议实现”在“在 COMMON 范围内”下可以对“网络接口”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00038` | `SU-ARINC-615A-3-5-3-2-3-8-5-P041-PROSE-SENTENCE-001-700C898C606C`<br>`ARINC-615A-3 5.3.2.3.8.5 p.29` | `PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `USE` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“协议实现”在“在 COMMON 范围内”下可以对“网络接口”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00039` | `SU-ARINC-615A-3-5-3-2-3-8-5-P042-PROSE-SENTENCE-009-89192D1CA807`<br>`ARINC-615A-3 5.3.2.3.8.5 p.30` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `ENCODE` / `HEADER-FILE, CRC, SOFTWARE-PART, TARGET-HARDWARE-ID` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下必须对“头文件、CRC／校验值、软件加载件、TARGET-HARDWARE-ID”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | DEP-RFC-1350, DEP-ARINC-6655, DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00040` | `SU-ARINC-615A-3-5-3-2-3-8-5-P042-PROSE-SENTENCE-010-B47966431472`<br>`ARINC-615A-3 5.3.2.3.8.5 p.30` | `DATA-LOADER` / `DURING-COMMON-SCOPE` / `ENCODE` / `CRC` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“在 COMMON 范围内”下必须对“CRC／校验值”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00041` | `SU-ARINC-615A-3-5-3-2-3-8-6-P044-PROSE-SENTENCE-005-F74AC5B7AE1C`<br>`ARINC-615A-3 5.3.2.3.8.6 p.32` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `FAIL` / `OPERATION, TARGET-HARDWARE-ID` / `FAILURE-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下可以对“协议操作、TARGET-HARDWARE-ID”执行“判定失败”；证据是“失败结果可被观察”。 | — | — |
| `CRS-M1-00042` | `SU-ARINC-615A-3-5-3-2-3-8-6-P044-PROSE-SENTENCE-006-1813D605F404`<br>`ARINC-615A-3 5.3.2.3.8.6 p.32` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `ASSIGN` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“网络接口”执行“分配或管理”；证据是“状态或编码结果可被观察”。 | — | — |
...
| `CRS-M1-00046` | `SU-ARINC-615A-3-5-4-2-P047-PROSE-SENTENCE-002-ECE0CBAF4A74`<br>`ARINC-615A-3 5.4.2 p.35` | `DATA-LOADER` / `DURING-INFORMATION-SCOPE` / `IMPLEMENT` / `OPERATION` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“在 INFORMATION 范围内”下必须对“协议操作”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00047` | `SU-ARINC-615A-3-5-4-2-P047-PROSE-SENTENCE-003-78F447EDB430`<br>`ARINC-615A-3 5.4.2 p.35` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `IMPLEMENT` / `OPERATION, TARGET-HARDWARE-ID` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“协议操作、TARGET-HARDWARE-ID”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00048` | `SU-ARINC-615A-3-5-4-2-P047-PROSE-SENTENCE-018-C6F5CE51372F`<br>`ARINC-615A-3 5.4.2 p.35` | `DATA-LOADER` / `DURING-INFORMATION-SCOPE` / `WAIT` / `CURRENT-STATUS` / `WAIT-BEHAVIOR-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“在 INFORMATION 范围内”下必须对“CURRENT-STATUS”执行“等待”；证据是“等待行为可被观察”。 | — | — |
| `CRS-M1-00049` | `SU-ARINC-615A-3-5-4-2-P047-PROSE-SENTENCE-019-DD0255D27FB0`<br>`ARINC-615A-3 5.4.2 p.35` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `VALIDATE` / `TFTP-OPTION` / `VALIDATION-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下可以对“TFTP 选项”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00050` | `SU-ARINC-615A-3-5-4-2-P047-PROSE-SENTENCE-020-12B60035E133`<br>`ARINC-615A-3 5.4.2 p.35` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `IMPLEMENT` / `TFTP-OPTION` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 INFORMATION 范围内”下可以对“TFTP 选项”执行“提供能力”；证据是“能力可用性可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00051` | `SU-ARINC-615A-3-5-4-2-P047-PROSE-SENTENCE-021-3CF28DC21423`<br>`ARINC-615A-3 5.4.2 p.35` | `DATA-LOADER` / `DURING-INFORMATION-SCOPE` / `VALIDATE` / `CRC, NETWORK-INTERFACE` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“在 INFORMATION 范围内”下必须对“CRC／校验值、网络接口”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00052` | `SU-ARINC-615A-3-5-4-3-P047-PROSE-SENTENCE-002-ECE0CBAF4A74`<br>`ARINC-615A-3 5.4.3 p.35` | `DATA-LOADER` / `DURING-UPLOAD-SCOPE` / `IMPLEMENT` / `OPERATION` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“数据加载器”在“在 UPLOAD 范围内”下必须对“协议操作”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00053` | `SU-ARINC-615A-3-5-4-3-P047-PROSE-SENTENCE-003-78F447EDB430`<br>`ARINC-615A-3 5.4.3 p.35` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `IMPLEMENT` / `OPERATION, TARGET-HARDWARE-ID` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“目标硬件”在“在 UPLOAD 范围内”下必须对“协议操作、TARGET-HARDWARE-ID”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00054` | `SU-ARINC-615A-3-5-4-3-P048-PROSE-SENTENCE-014-A6329164790D`<br>`ARINC-615A-3 5.4.3 p.36` | `TARGET-HARDWARE` / `WHEN-LOAD-LIST-ITEM-REJECTED` / `REJECT` / `LOAD-LIST, TARGET-HARDWARE-ID` / `REJECTION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“目标硬件”在“加载清单中任一项被拒绝时”下必须对“LOAD-LIST、TARGET-HARDWARE-ID”执行“拒绝”；证据是“拒绝结果可被观察”。 | — | — |
| `CRS-M1-00055` | `SU-ARINC-615A-3-5-4-3-P048-PROSE-SENTENCE-017-202272C96544`<br>`ARINC-615A-3 5.4.3 p.36` | `DATA-LOADER` / `DURING-UPLOAD-SCOPE` / `DISPLAY` / `CURRENT-STATUS` / `USER-INDICATION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“数据加载器”在“在 UPLOAD 范围内”下必须对“CURRENT-STATUS”执行“显示或通知”；证据是“用户提示可被观察”。 | — | — |
| `CRS-M1-00056` | `SU-ARINC-615A-3-5-4-3-P048-PROSE-SENTENCE-022-D550F67EB586`<br>`ARINC-615A-3 5.4.3 p.36` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `VALIDATE` / `TFTP-OPTION, NETWORK-INTERFACE` / `VALIDATION-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-BASE` | 参与者“目标硬件”在“在 UPLOAD 范围内”下可以对“TFTP 选项、网络接口”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00057` | `SU-ARINC-615A-3-5-4-3-P048-PROSE-SENTENCE-024-F38D018C4499`<br>`ARINC-615A-3 5.4.3 p.36` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“目标硬件”在“在 UPLOAD 范围内”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00058` | `SU-ARINC-615A-3-5-4-3-P048-PROSE-SENTENCE-025-E777A6D3DAC7`<br>`ARINC-615A-3 5.4.3 p.36` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `VALIDATE` / `TFTP-OPTION` / `VALIDATION-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-BASE` | 参与者“目标硬件”在“在 UPLOAD 范围内”下可以对“TFTP 选项”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00059` | `SU-ARINC-615A-3-5-4-3-1-P048-PROSE-SENTENCE-004-AF732D243056`<br>`ARINC-615A-3 5.4.3.1 p.36` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `COMPARE` / `HEADER-FILE, DATA-FILE, LOAD-PART-NUMBER, LOADABLE-SOFTWARE-PART-NUMBER` / `COMPARISON-RESULT-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“目标硬件”在“在 UPLOAD 范围内”下必须对“头文件、数据文件、加载件号、LOADABLE-SOFTWARE-PART-NUMBER”执行“比较”；证据是“比较结果可被观察”。 | — | — |
| `CRS-M1-00060` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-007-F209ABE1376B`<br>`ARINC-615A-3 5.4.3.1 p.37` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `VALIDATE` / `NVM-MEMORY-IMAGE` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“NVM-MEMORY-IMAGE”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-6655, DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00061` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-007-F209ABE1376B`<br>`ARINC-615A-3 5.4.3.1 p.37` | `SOFTWARE-PACKAGE-PRODUCER` / `DURING-UPLOAD-SCOPE` / `VALIDATE` / `CRC, SOFTWARE-PART` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“软件包生成方”在“在 UPLOAD 范围内”下必须对“CRC／校验值、软件加载件”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-6655, DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00062` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-008-CDA43D6568CC`<br>`ARINC-615A-3 5.4.3.1 p.37` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `VALIDATE` / `CRC, FILE-CONTENT, TARGET-HARDWARE-ID` / `VALIDATION-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-BASE` | 参与者“目标硬件”在“在 UPLOAD 范围内”下可以对“CRC／校验值、FILE-CONTENT、TARGET-HARDWARE-ID”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00063` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-010-F4624AC8DCB4`<br>`ARINC-615A-3 5.4.3.1 p.37` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `ENSURE-EQUALITY` / `LOAD-PART-NUMBER, CRC` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“加载件号、CRC／校验值”执行“确保取值相等”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00064` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-012-B2655A4BD5D6`<br>`ARINC-615A-3 5.4.3.1 p.37` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `FORMAT` / `FILE-CONTENT` / `ENCODED-FORMAT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“FILE-CONTENT”执行“按规定格式化”；证据是“编码格式可被观察”。 | — | — |
| `CRS-M1-00065` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-015-1FD87B87894F`<br>`ARINC-615A-3 5.4.3.1 p.37` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `SELECT` / `FILE-CONTENT` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“FILE-CONTENT”执行“选择”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00066` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-017-D6D20C0AE6D8`<br>`ARINC-615A-3 5.4.3.1 p.37` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `COMPILE-AND-LINK` / `FILE-CONTENT` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“FILE-CONTENT”执行“独立编译并链接”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00067` | `SU-ARINC-615A-3-5-4-3-1-P049-PROSE-SENTENCE-018-7D1A5B42A8F9`<br>`ARINC-615A-3 5.4.3.1 p.37` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `DEFINE` / `FILE-CONTENT, PROGRAM-MEMORY-MAP` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“FILE-CONTENT、PROGRAM-MEMORY-MAP”执行“定义”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00068` | `SU-ARINC-615A-3-5-4-5-2-P053-PROSE-SENTENCE-008-6BD76320C0DE`<br>`ARINC-615A-3 5.4.5.2 p.41` | `DATA-LOADER` / `DURING-COMMON-SCOPE` / `ABORT` / `STATUS-FILE, TEXT-FIELD, OPERATION` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“在 COMMON 范围内”下必须对“状态文件、文本字段、协议操作”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00069` | `SU-ARINC-615A-3-6-2-8-1-P057-PROSE-SENTENCE-001-B9AF73779529`<br>`ARINC-615A-3 6.2.8.1 p.45` | `TARGET-HARDWARE` / `ON-WAIT-MESSAGE-RECEIPT` / `RETRY` / `TARGET-HARDWARE-ID, PROTOCOL-MESSAGE` / `RETRY-ATTEMPT-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“目标硬件”在“收到 WAIT 消息时”下必须对“TARGET-HARDWARE-ID、PROTOCOL-MESSAGE”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00070` | `SU-ARINC-615A-3-6-3-1-P063-PROSE-SENTENCE-010-EF2C1FAB94E9`<br>`ARINC-615A-3 6.3.1 p.51` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `DEFINE` / `STATUS-FILE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“状态文件”执行“定义”；证据是“状态或编码结果可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00071` | `SU-ARINC-615A-3-6-3-1-P063-PROSE-SENTENCE-014-46E366631127`<br>`ARINC-615A-3 6.3.1 p.51` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `STATUS-FILE, NETWORK-INTERFACE, PROTOCOL-ERROR` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“状态文件、网络接口、PROTOCOL-ERROR”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00072` | `SU-ARINC-615A-3-6-3-1-P063-PROSE-SENTENCE-015-FFB177F65B0A`<br>`ARINC-615A-3 6.3.1 p.51` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `ABORT` / `ABORT-MESSAGE, STATUS-FILE, NETWORK-INTERFACE, TARGET-HARDWARE-ID` / `ABORT-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 INFORMATION 范围内”下可以对“中止消息、状态文件、网络接口、TARGET-HARDWARE-ID”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00073` | `SU-ARINC-615A-3-6-3-1-P063-PROSE-SENTENCE-018-33F16CA0556B`<br>`ARINC-615A-3 6.3.1 p.51` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `SEND` / `STATUS-FILE, TIMEOUT-EXPIRY, LCL-TRANSFER` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 INFORMATION 范围内”下可以对“状态文件、TIMEOUT-EXPIRY、LCL-TRANSFER”执行“发送”；证据是“消息或文件及其方向可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00074` | `SU-ARINC-615A-3-6-3-1-P063-PROSE-SENTENCE-020-D27F9DB819AB`<br>`ARINC-615A-3 6.3.1 p.51` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `SEND` / `STATUS-FILE, TARGET-HARDWARE-ID` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“状态文件、TARGET-HARDWARE-ID”执行“发送”；证据是“消息或文件及其方向可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00075` | `SU-ARINC-615A-3-6-3-1-P064-PROSE-SENTENCE-031-D8862D88C46E`<br>`ARINC-615A-3 6.3.1 p.52` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `WAIT` / `EXCEPTION-TIMER, OPERATION, TARGET-HARDWARE-ID` / `WAIT-BEHAVIOR-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“异常计时器、协议操作、TARGET-HARDWARE-ID”执行“等待”；证据是“等待行为可被观察”。 | `MESSAGE-CARRIED-PARAMETER` / `MESSAGE-TIMER-VALUE` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00076` | `SU-ARINC-615A-3-6-3-1-P064-PROSE-SENTENCE-032-E812AC346D09`<br>`ARINC-615A-3 6.3.1 p.52` | `TARGET-HARDWARE-SUPPLIER` / `DURING-INFORMATION-SCOPE` / `WAIT` / `EXCEPTION-TIMER, TARGET-HARDWARE-ID` / `WAIT-BEHAVIOR-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件供应商”在“在 INFORMATION 范围内”下必须对“异常计时器、TARGET-HARDWARE-ID”执行“等待”；证据是“等待行为可被观察”。 | `MESSAGE-CARRIED-PARAMETER` / `MESSAGE-TIMER-VALUE` / `UNRESOLVED..UNRESOLVED s` | — |
...
| `CRS-M1-00078` | `SU-ARINC-615A-3-6-3-2-P067-PROSE-SENTENCE-020-43C35127F07F`<br>`ARINC-615A-3 6.3.2 p.55` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `DEFINE` / `STATUS-FILE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“状态文件”执行“定义”；证据是“状态或编码结果可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00079` | `SU-ARINC-615A-3-6-3-2-P067-PROSE-SENTENCE-022-9B7AA17CBAF6`<br>`ARINC-615A-3 6.3.2 p.55` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `ENCODE` / `STATUS-FILE, NETWORK-INTERFACE, PROTOCOL-ERROR` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“目标硬件”在“在 UPLOAD 范围内”下必须对“状态文件、网络接口、PROTOCOL-ERROR”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00080` | `SU-ARINC-615A-3-6-3-2-P067-PROSE-SENTENCE-023-AEFFB70E9596`<br>`ARINC-615A-3 6.3.2 p.55` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `ABORT` / `ABORT-MESSAGE, STATUS-FILE, NETWORK-INTERFACE, TARGET-HARDWARE-ID` / `ABORT-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-BASE` | 参与者“目标硬件”在“在 UPLOAD 范围内”下可以对“中止消息、状态文件、网络接口、TARGET-HARDWARE-ID”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00081` | `SU-ARINC-615A-3-6-3-2-P067-PROSE-SENTENCE-026-3B69FEC8B73B`<br>`ARINC-615A-3 6.3.2 p.55` | `TARGET-HARDWARE` / `DURING-UPLOAD-SCOPE` / `TRANSFER` / `UPLOAD-THREAD` / `TRANSFER-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-BASE` | 参与者“目标硬件”在“在 UPLOAD 范围内”下可以对“UPLOAD-THREAD”执行“传输”；证据是“传输结果可被观察”。 | — | — |
| `CRS-M1-00082` | `SU-ARINC-615A-3-5-3-2-3-4-P068-PROSE-SENTENCE-016-D8862D88C46E`<br>`ARINC-615A-3 5.3.2.3.4 p.56` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `WAIT` / `EXCEPTION-TIMER, OPERATION, TARGET-HARDWARE-ID` / `WAIT-BEHAVIOR-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下必须对“异常计时器、协议操作、TARGET-HARDWARE-ID”执行“等待”；证据是“等待行为可被观察”。 | `MESSAGE-CARRIED-PARAMETER` / `MESSAGE-TIMER-VALUE` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00083` | `SU-ARINC-615A-3-5-3-2-3-4-P068-PROSE-SENTENCE-017-E812AC346D09`<br>`ARINC-615A-3 5.3.2.3.4 p.56` | `TARGET-HARDWARE-SUPPLIER` / `DURING-COMMON-SCOPE` / `WAIT` / `EXCEPTION-TIMER, TARGET-HARDWARE-ID` / `WAIT-BEHAVIOR-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件供应商”在“在 COMMON 范围内”下必须对“异常计时器、TARGET-HARDWARE-ID”执行“等待”；证据是“等待行为可被观察”。 | `MESSAGE-CARRIED-PARAMETER` / `MESSAGE-TIMER-VALUE` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00084` | `SU-ARINC-615A-3-5-3-2-3-4-P068-PROSE-SENTENCE-018-2765B9535D98`<br>`ARINC-615A-3 5.3.2.3.4 p.56` | `DATA-LOADER` / `BEFORE-MESSAGE-TIMER-EXPIRY` / `ABORT` / `STATUS-FILE, OPERATION` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“消息携带计时值到期前”下必须对“状态文件、协议操作”执行“中止”；证据是“中止结果可被观察”。 | `MESSAGE-CARRIED-PARAMETER` / `MESSAGE-TIMER-VALUE` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00085` | `SU-ARINC-615A-3-5-3-2-3-4-P068-PROSE-SENTENCE-020-4C1D759A6B9A`<br>`ARINC-615A-3 5.3.2.3.4 p.56` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `SEND` / `STATUS-FILE, DATA-FILE, CRC` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“状态文件、数据文件、CRC／校验值”执行“发送”；证据是“消息或文件及其方向可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00086` | `SU-ARINC-615A-3-6-3-5-P076-PROSE-SENTENCE-009-BF2F613AC35B`<br>`ARINC-615A-3 6.3.5 p.64` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `ABORT` / `STATUS-FILE, TARGET-HARDWARE-ID` / `ABORT-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下可以对“状态文件、TARGET-HARDWARE-ID”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00087` | `SU-ARINC-615A-3-6-3-5-P076-PROSE-SENTENCE-011-5B38B1E3DBEF`<br>`ARINC-615A-3 6.3.5 p.64` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `ABORT` / `STATUS-FILE, OPERATION, TARGET-HARDWARE-ID` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下必须对“状态文件、协议操作、TARGET-HARDWARE-ID”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00088` | `SU-ARINC-615A-3-6-3-5-P076-PROSE-SENTENCE-012-EED68957A0BC`<br>`ARINC-615A-3 6.3.5 p.64` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `ABORT` / `ABORT-MESSAGE, OPERATION, TARGET-HARDWARE-ID` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下必须对“中止消息、协议操作、TARGET-HARDWARE-ID”执行“中止”；证据是“中止结果可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00089` | `SU-ARINC-615A-3-6-3-5-P076-PROSE-SENTENCE-013-DEDC03B64B0A`<br>`ARINC-615A-3 6.3.5 p.64` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `ABORT` / `STATUS-FILE, ERROR-MESSAGE, TARGET-HARDWARE-ID` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下必须对“状态文件、错误消息、TARGET-HARDWARE-ID”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00090` | `SU-ARINC-615A-3-6-3-5-P076-PROSE-SENTENCE-015-DCA535962C3D`<br>`ARINC-615A-3 6.3.5 p.64` | `DATA-LOADER` / `DURING-COMMON-SCOPE` / `ABORT` / `ABORT-MESSAGE, OPERATION` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“在 COMMON 范围内”下必须对“中止消息、协议操作”执行“中止”；证据是“中止结果可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00091` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-005-1B24BCFF8198`<br>`ARINC-615A-3 6.4 p.65` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `SEND` / `PROTOCOL-VERSION, OPERATION, NETWORK-INTERFACE, TARGET-HARDWARE-ID` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下必须对“协议版本、协议操作、网络接口、TARGET-HARDWARE-ID”执行“发送”；证据是“消息或文件及其方向可被观察”。 | — | — |
| `CRS-M1-00092` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-007-20EF70E6EF8B`<br>`ARINC-615A-3 6.4 p.65` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `IMPLEMENT` / `PROTOCOL-VERSION, OPERATION, TARGET-HARDWARE-ID` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下必须对“协议版本、协议操作、TARGET-HARDWARE-ID”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00093` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-009-5F21110D7E4B`<br>`ARINC-615A-3 6.4 p.65` | `PROTOCOL-FILE-PRODUCER` / `DURING-COMMON-SCOPE` / `DEFINE` / `PROTOCOL-VERSION, NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“协议文件生成方”在“在 COMMON 范围内”下必须对“协议版本、网络接口”执行“定义”；证据是“状态或编码结果可被观察”。 | — | — |
...
| `CRS-M1-00095` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-012-2FCCE7C4573B`<br>`ARINC-615A-3 6.4 p.65` | `DATA-LOADER` / `WHEN-OPTIONAL-CAPABILITY-IMPLEMENTED` / `ABORT` / `PROTOCOL-VERSION` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“实现可选能力时”下必须对“协议版本”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00096` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-013-569F14A5E296`<br>`ARINC-615A-3 6.4 p.65` | `DATA-LOADER` / `WHEN-PROTOCOL-VERSIONS-DIFFER` / `ABORT` / `ABORT-MESSAGE, STATUS-FILE, PROTOCOL-VERSION, OPERATION` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“协议版本不兼容时”下必须对“中止消息、状态文件、协议版本、协议操作”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00097` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-014-425EEC39D73C`<br>`ARINC-615A-3 6.4 p.65` | `PROTOCOL-FILE-PRODUCER` / `DURING-COMMON-SCOPE` / `ENCODE` / `PROTOCOL-VERSION` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“协议文件生成方”在“在 COMMON 范围内”下必须对“协议版本”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00098` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-016-280B7BBBB75A`<br>`ARINC-615A-3 6.4 p.65` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `ENCODE` / `LOAD-PART-NUMBER, TEXT-FIELD, NETWORK-INTERFACE, LOADABLE-SOFTWARE-PART-NUMBER` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“加载件号、文本字段、网络接口、LOADABLE-SOFTWARE-PART-NUMBER”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00099` | `SU-ARINC-615A-3-6-4-P077-PROSE-SENTENCE-016-280B7BBBB75A`<br>`ARINC-615A-3 6.4 p.65` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00100` | `SU-ARINC-615A-3-6-4-1-P080-PROSE-SENTENCE-023-B30093B748E5`<br>`ARINC-615A-3 6.4.1 p.68` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ALLOW-PRINTABLE` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“仅允许可打印字符”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00101` | `SU-ARINC-615A-3-6-4-1-P080-PROSE-SENTENCE-023-B30093B748E5`<br>`ARINC-615A-3 6.4.1 p.68` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00102` | `SU-ARINC-615A-3-6-4-1-P080-PROSE-SENTENCE-023-B30093B748E5`<br>`ARINC-615A-3 6.4.1 p.68` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `CONSTRAIN` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“施加边界约束”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00103` | `SU-ARINC-615A-3-6-4-1-P080-PROSE-SENTENCE-024-1532165AA3AE`<br>`ARINC-615A-3 6.4.1 p.68` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00104` | `SU-ARINC-615A-3-6-4-2-P081-PROSE-SENTENCE-018-7650772794FC`<br>`ARINC-615A-3 6.4.2 p.69` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00105` | `SU-ARINC-615A-3-6-4-2-P081-PROSE-SENTENCE-023-B016CF154BFD`<br>`ARINC-615A-3 6.4.2 p.69` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00106` | `SU-ARINC-615A-3-6-4-2-P081-PROSE-SENTENCE-030-B016CF154BFD`<br>`ARINC-615A-3 6.4.2 p.69` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00107` | `SU-ARINC-615A-3-6-4-2-P082-PROSE-SENTENCE-042-0D59A327A7CC`<br>`ARINC-615A-3 6.4.2 p.70` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ALLOW-PRINTABLE` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“仅允许可打印字符”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00108` | `SU-ARINC-615A-3-6-4-2-P082-PROSE-SENTENCE-042-0D59A327A7CC`<br>`ARINC-615A-3 6.4.2 p.70` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00109` | `SU-ARINC-615A-3-6-4-2-P082-PROSE-SENTENCE-042-0D59A327A7CC`<br>`ARINC-615A-3 6.4.2 p.70` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `CONSTRAIN` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“施加边界约束”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00110` | `SU-ARINC-615A-3-6-4-2-P082-PROSE-SENTENCE-043-1532165AA3AE`<br>`ARINC-615A-3 6.4.2 p.70` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00111` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-029-C2788AA6D18A`<br>`ARINC-615A-3 6.4.3 p.72` | `PROTOCOL-FILE-PRODUCER` / `WHEN-STATUS-CODE-IS-0002-OR-0004` / `ENCODE` / `STATUS-CODE-CONDITIONAL-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“协议文件生成方”在“状态码为 0x0002 或 0x0004 时”下必须对“STATUS-CODE-CONDITIONAL-FIELD”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00112` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-034-65EBA86ACA77`<br>`ARINC-615A-3 6.4.3 p.72` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `PROVIDE` / `ESTIMATED-TIME, OPERATION` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“预计时间、协议操作”执行“提供”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00113` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-037-98AB79F99A7B`<br>`ARINC-615A-3 6.4.3 p.72` | `TARGET-HARDWARE` / `WHEN-TIMER-VALUE-IS-NOT-PROVIDED` / `ENCODE` / `ESTIMATED-TIME, TARGET-HARDWARE-ID` / `ENCODED-FIELD-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“目标未提供计时值时”下必须对“预计时间、TARGET-HARDWARE-ID”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00114` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-043-83077CACF0DC`<br>`ARINC-615A-3 6.4.3 p.72` | `PROTOCOL-FILE-PRODUCER` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `STATUS-CODE-CONDITIONAL-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“协议文件生成方”在“在 INFORMATION 范围内”下可以对“STATUS-CODE-CONDITIONAL-FIELD”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00115` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-045-1B483243E195`<br>`ARINC-615A-3 6.4.3 p.72` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ALLOW-PRINTABLE` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“仅允许可打印字符”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00116` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-045-1B483243E195`<br>`ARINC-615A-3 6.4.3 p.72` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00117` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-045-1B483243E195`<br>`ARINC-615A-3 6.4.3 p.72` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `CONSTRAIN` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“施加边界约束”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00118` | `SU-ARINC-615A-3-6-4-3-P084-PROSE-SENTENCE-046-1532165AA3AE`<br>`ARINC-615A-3 6.4.3 p.72` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00119` | `SU-ARINC-615A-3-6-4-4-P085-PROSE-SENTENCE-013-D5E44774D202`<br>`ARINC-615A-3 6.4.4 p.73` | `PROTOCOL-FILE-PRODUCER` / `DURING-UPLOAD-SCOPE` / `ENCODE` / `HEADER-FILE` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“协议文件生成方”在“在 UPLOAD 范围内”下必须对“头文件”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00120` | `SU-ARINC-615A-3-6-4-4-P085-PROSE-SENTENCE-018-1532165AA3AE`<br>`ARINC-615A-3 6.4.4 p.73` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00121` | `SU-ARINC-615A-3-6-4-4-P085-PROSE-SENTENCE-023-53AAFA003A8B`<br>`ARINC-615A-3 6.4.4 p.73` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `ALLOW-PRINTABLE` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“文本字段”执行“仅允许可打印字符”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00122` | `SU-ARINC-615A-3-6-4-4-P085-PROSE-SENTENCE-023-53AAFA003A8B`<br>`ARINC-615A-3 6.4.4 p.73` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00123` | `SU-ARINC-615A-3-6-4-4-P085-PROSE-SENTENCE-023-53AAFA003A8B`<br>`ARINC-615A-3 6.4.4 p.73` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `CONSTRAIN` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“文本字段”执行“施加边界约束”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00124` | `SU-ARINC-615A-3-6-4-4-P085-PROSE-SENTENCE-024-1532165AA3AE`<br>`ARINC-615A-3 6.4.4 p.73` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-UPLOAD-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-BASE` | 参与者“ARINC 615A 协议参与方”在“在 UPLOAD 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00125` | `SU-ARINC-615A-3-6-4-10-P094-PROSE-SENTENCE-001-53AAFA003A8B`<br>`ARINC-615A-3 6.4.10 p.82` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ALLOW-PRINTABLE` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“仅允许可打印字符”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00126` | `SU-ARINC-615A-3-6-4-10-P094-PROSE-SENTENCE-001-53AAFA003A8B`<br>`ARINC-615A-3 6.4.10 p.82` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00127` | `SU-ARINC-615A-3-6-4-10-P094-PROSE-SENTENCE-001-53AAFA003A8B`<br>`ARINC-615A-3 6.4.10 p.82` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `CONSTRAIN` / `TEXT-FIELD` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“施加边界约束”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00128` | `SU-ARINC-615A-3-6-4-10-P094-PROSE-SENTENCE-002-1532165AA3AE`<br>`ARINC-615A-3 6.4.10 p.82` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ENCODE` / `TEXT-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“文本字段”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00129` | `SU-ARINC-615A-3-6-4-10-P096-PROSE-SENTENCE-003-2C9653D1AE20`<br>`ARINC-615A-3 6.4.10 p.84` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `DISPLAY` / `TEXT-FIELD, TARGET-HARDWARE-ID` / `USER-INDICATION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“文本字段、TARGET-HARDWARE-ID”执行“显示或通知”；证据是“用户提示可被观察”。 | — | — |
| `CRS-M1-00130` | `SU-ARINC-615A-3-6-4-10-P097-PROSE-SENTENCE-004-5D81ED14D19B`<br>`ARINC-615A-3 6.4.10 p.85` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `WAIT` / `NETWORK-INTERFACE, TARGET-HARDWARE-ID` / `WAIT-BEHAVIOR-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“网络接口、TARGET-HARDWARE-ID”执行“等待”；证据是“等待行为可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00131` | `SU-ARINC-615A-3-6-4-10-P097-PROSE-SENTENCE-012-F313FBEE280D`<br>`ARINC-615A-3 6.4.10 p.85` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `ABORT` / `STATUS-FILE, TEXT-FIELD, OPERATION, TARGET-HARDWARE-ID` / `ABORT-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“状态文件、文本字段、协议操作、TARGET-HARDWARE-ID”执行“中止”；证据是“中止结果可被观察”。 | — | — |
| `CRS-M1-00132` | `SU-ARINC-615A-3-6-4-10-P097-PROSE-SENTENCE-014-DEF9DE65D40B`<br>`ARINC-615A-3 6.4.10 p.85` | `TARGET-HARDWARE` / `DURING-INFORMATION-SCOPE` / `DISPLAY` / `STATUS-FILE, TEXT-FIELD, OPERATION, TARGET-HARDWARE-ID` / `USER-INDICATION-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 INFORMATION 范围内”下必须对“状态文件、文本字段、协议操作、TARGET-HARDWARE-ID”执行“显示或通知”；证据是“用户提示可被观察”。 | — | — |
| `CRS-M1-00133` | `SU-ARINC-615A-3-6-4-10-P099-PROSE-SENTENCE-020-C650FAC6A8D8`<br>`ARINC-615A-3 6.4.10 p.87` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `ASSIGN` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“网络接口”执行“分配或管理”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00134` | `SU-ARINC-615A-3-6-4-10-P099-PROSE-SENTENCE-021-7D0DD652080D`<br>`ARINC-615A-3 6.4.10 p.87` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `PROVIDE` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下可以对“网络接口”执行“提供”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00135` | `SU-ARINC-615A-3-6-4-10-P099-PROSE-SENTENCE-023-7640457B8D57`<br>`ARINC-615A-3 6.4.10 p.87` | `ARINC-615A-PROTOCOL-PARTICIPANT` / `DURING-INFORMATION-SCOPE` / `USE` / `NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议参与方”在“在 INFORMATION 范围内”下必须对“网络接口”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00136` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-005-D75104E5A8FF`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `RETRY` / `TIMEOUT-AND-RETRY-LAYERS` / `RETRY-ATTEMPT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TIMEOUT-AND-RETRY-LAYERS”执行“重试”；证据是“重试尝试可被观察”。 | — | — |
| `CRS-M1-00137` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-008-F320813241E5`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `TRANSFER` / `TFTP-FILE-TRANSFER` / `TRANSFER-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TFTP 文件传输”执行“传输”；证据是“传输结果可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `TFTP-TO` / `UNRESOLVED..UNRESOLVED s` | DEP-RFC-1350 |
| `CRS-M1-00138` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-009-414439744FBA`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `ACKNOWLEDGE` / `TIMEOUT-EXPIRY` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TIMEOUT-EXPIRY”执行“确认”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00139` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-011-D951F3C8D8DC`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `RETRY` / `TFTP-FILE-TRANSFER` / `RETRY-ATTEMPT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下可以对“TFTP 文件传输”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00140` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-012-DCEA052A12C5`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `AFTER-RETRY-LIMIT-EXHAUSTION` / `RETRY` / `TFTP-FILE-TRANSFER, RETRY-NUMBER` / `RETRY-ATTEMPT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“重试限额耗尽后”下必须对“TFTP 文件传输、RETRY-NUMBER”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00141` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-013-0E511BD5A2AE`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `PROVIDE` / `PROTOCOL-ERROR` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“PROTOCOL-ERROR”执行“提供”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00142` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-015-7C1E9A3C2D05`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `ON-TFTP-ERROR` / `RETRY` / `TFTP-FILE-TRANSFER` / `RETRY-ATTEMPT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“TFTP 层报告错误时”下必须对“TFTP 文件传输”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00143` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-016-BC84E4EE3A39`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `AFTER-RETRY-LIMIT-EXHAUSTION` / `RETRY` / `TFTP-FILE-TRANSFER, PROTOCOL-ERROR, RETRY-NUMBER` / `RETRY-ATTEMPT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“重试限额耗尽后”下必须对“TFTP 文件传输、PROTOCOL-ERROR、RETRY-NUMBER”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00144` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-017-C80348B18729`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `FAIL` / `PROTOCOL-ERROR` / `FAILURE-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“PROTOCOL-ERROR”执行“判定失败”；证据是“失败结果可被观察”。 | — | — |
| `CRS-M1-00145` | `SU-ARINC-615A-3-4-1-P111-PROSE-SENTENCE-024-35890C54B368`<br>`ARINC-615A-3 4-1 p.99` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `ADJUST-UPWARD` / `TIMEOUT-VALUE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TIMEOUT-VALUE”执行“向上调整”；证据是“状态或编码结果可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00146` | `SU-ARINC-615A-3-4-3-1-P112-PROSE-SENTENCE-004-4C05C3174D37`<br>`ARINC-615A-3 4-3.1 p.100` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `SET-CONSTANT` / `TIMEOUT-VALUE` / `CONSTANT-VALUE-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TIMEOUT-VALUE”执行“设置固定常数”；证据是“固定取值可被观察”。 | `FIXED-SOURCE-CONSTANT` / `TFTP-TO` / `0..2 s` | — |
| `CRS-M1-00147` | `SU-ARINC-615A-3-4-3-1-P112-PROSE-SENTENCE-005-88F51ABD3389`<br>`ARINC-615A-3 4-3.1 p.100` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `PROHIBIT` / `TFTP-EXCHANGE, TIMEOUT-VALUE` / `PROHIBITED-EVENT-ABSENCE-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TFTP 交换、TIMEOUT-VALUE”执行“禁止”；证据是“受禁事件不出现可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `TFTP-TO` / `UNRESOLVED..UNRESOLVED s` | DEP-RFC-1350 |
| `CRS-M1-00148` | `SU-ARINC-615A-3-4-3-1-P112-PROSE-SENTENCE-007-69549032F30B`<br>`ARINC-615A-3 4-3.1 p.100` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `SEND` / `TFTP-EXCHANGE` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TFTP 交换”执行“发送”；证据是“消息或文件及其方向可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00149` | `SU-ARINC-615A-3-4-3-2-P113-PROSE-SENTENCE-001-205BD6EF24F3`<br>`ARINC-615A-3 4-3.2 p.101` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `RETRY` / `TFTP-EXCHANGE, RETRY-NUMBER, TARGET-HARDWARE-ID` / `RETRY-ATTEMPT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下可以对“TFTP 交换、RETRY-NUMBER、TARGET-HARDWARE-ID”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00150` | `SU-ARINC-615A-3-4-3-2-P113-PROSE-SENTENCE-011-A604F56F9739`<br>`ARINC-615A-3 4-3.2 p.101` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `RETRY` / `RETRY-NUMBER` / `RETRY-ATTEMPT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“RETRY-NUMBER”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00151` | `SU-ARINC-615A-3-4-3-3-P114-PROSE-SENTENCE-001-5174295F548B`<br>`ARINC-615A-3 4-3.3 p.102` | `PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `ENCODE` / `SORCERERS-APPRENTICE-FIX` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“协议实现”在“在 COMMON 范围内”下必须对“SORCERERS-APPRENTICE-FIX”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | DEP-RFC-1123, DEP-RFC-1350 |
| `CRS-M1-00152` | `SU-ARINC-615A-3-4-3-3-P114-PROSE-SENTENCE-002-889533B1AA3F`<br>`ARINC-615A-3 4-3.3 p.102` | `TFTP-SENDER` / `DURING-COMMON-SCOPE` / `SEND` / `TFTP-EXCHANGE` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“TFTP 发送方”在“在 COMMON 范围内”下必须对“TFTP 交换”执行“发送”；证据是“消息或文件及其方向可被观察”。 | — | — |
| `CRS-M1-00153` | `SU-ARINC-615A-3-4-3-3-P114-PROSE-SENTENCE-002-889533B1AA3F`<br>`ARINC-615A-3 4-3.3 p.102` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `ON-DUPLICATE-ACKNOWLEDGEMENT` / `SEND` / `TFTP-EXCHANGE, NETWORK-INTERFACE` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“收到重复确认时”下必须对“TFTP 交换、网络接口”执行“发送”；证据是“消息或文件及其方向可被观察”。 | — | — |
| `CRS-M1-00154` | `SU-ARINC-615A-3-4-4-1-P114-PROSE-SENTENCE-003-7C29399D1DAB`<br>`ARINC-615A-3 4-4.1 p.102` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `TRANSFER` / `TFTP-FILE-TRANSFER` / `TRANSFER-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TFTP 文件传输”执行“传输”；证据是“传输结果可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | DEP-RFC-1350 |
| `CRS-M1-00155` | `SU-ARINC-615A-3-4-4-1-P114-PROSE-SENTENCE-006-02C6AA3F66A1`<br>`ARINC-615A-3 4-4.1 p.102` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `ADJUST-UPWARD` / `TIMEOUT-VALUE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TIMEOUT-VALUE”执行“向上调整”；证据是“状态或编码结果可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00156` | `SU-ARINC-615A-3-4-4-1-P114-PROSE-SENTENCE-008-4848608477C0`<br>`ARINC-615A-3 4-4.1 p.102` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `SEND` / `STATUS-FILE, TARGET-HARDWARE-ID` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下必须对“状态文件、TARGET-HARDWARE-ID”执行“发送”；证据是“消息或文件及其方向可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | — |
| `CRS-M1-00157` | `SU-ARINC-615A-3-4-4-1-P114-PROSE-SENTENCE-011-BD0CBB7058D1`<br>`ARINC-615A-3 4-4.1 p.102` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `PROVIDE` / `TIMEOUT-VALUE, TARGET-HARDWARE-ID` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下必须对“TIMEOUT-VALUE、TARGET-HARDWARE-ID”执行“提供”；证据是“状态或编码结果可被观察”。 | `FIXED-SOURCE-CONSTANT` / `DLP-TO` / `0..13 s` | — |
| `CRS-M1-00158` | `SU-ARINC-615A-3-4-4-1-P114-PROSE-SENTENCE-012-FB8820DE2238`<br>`ARINC-615A-3 4-4.1 p.102` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `SEND` / `TFTP-EXCHANGE, TFTP-FILE-TRANSFER, TARGET-HARDWARE-ID` / `MESSAGE-OR-FILE-DIRECTION-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下必须对“TFTP 交换、TFTP 文件传输、TARGET-HARDWARE-ID”执行“发送”；证据是“消息或文件及其方向可被观察”。 | `SYMBOLIC-SOURCE-PARAMETER` / `DLP-TO` / `UNRESOLVED..UNRESOLVED s` | DEP-RFC-1350 |
| `CRS-M1-00159` | `SU-ARINC-615A-3-4-4-1-P115-PROSE-SENTENCE-015-A31F93757E22`<br>`ARINC-615A-3 4-4.1 p.103` | `ARINC-615A-PROTOCOL-IMPLEMENTATION` / `DURING-COMMON-SCOPE` / `CONSTRAIN` / `TIMEOUT-VALUE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“ARINC 615A 协议实现”在“在 COMMON 范围内”下必须对“TIMEOUT-VALUE”执行“施加边界约束”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00160` | `SU-ARINC-615A-3-4-4-2-1-P115-PROSE-SENTENCE-001-46D0EBEB4FDD`<br>`ARINC-615A-3 4-4.2.1 p.103` | `TARGET-HARDWARE` / `DURING-COMMON-SCOPE` / `RETRY` / `TFTP-FILE-TRANSFER, RETRY-NUMBER, TARGET-HARDWARE-ID` / `RETRY-ATTEMPT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“在 COMMON 范围内”下可以对“TFTP 文件传输、RETRY-NUMBER、TARGET-HARDWARE-ID”执行“重试”；证据是“重试尝试可被观察”。 | — | DEP-RFC-1350 |
| `CRS-M1-00161` | `SU-ARINC-665-5-1-3-1-P011-PROSE-SENTENCE-002-93AC8751234E`<br>`ARINC-665-5 1.3.1 p.1` | `DATA-LOADER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `IMPLEMENT` / `SOFTWARE-PART, CONFORMANCE-MODALITY` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“生成 ARINC 665 数据对象时”下必须对“软件加载件、CONFORMANCE-MODALITY”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00162` | `SU-ARINC-665-5-1-3-1-P011-PROSE-SENTENCE-003-F4F4BC419A09`<br>`ARINC-665-5 1.3.1 p.1` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `IMPLEMENT` / `NETWORK-INTERFACE, CONFORMANCE-MODALITY` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“网络接口、CONFORMANCE-MODALITY”执行“提供能力”；证据是“能力可用性可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00163` | `SU-ARINC-665-5-1-3-1-P011-PROSE-SENTENCE-005-BC73FE29F0AF`<br>`ARINC-665-5 1.3.1 p.1` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `USE` / `CONFORMANCE-MODALITY` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下可以对“CONFORMANCE-MODALITY”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00164` | `SU-ARINC-665-5-1-3-1-P011-PROSE-SENTENCE-006-3F3CB7AE6B26`<br>`ARINC-665-5 1.3.1 p.1` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-OPTIONAL-CAPABILITY-IMPLEMENTED` / `IMPLEMENT` / `CONFORMANCE-MODALITY` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“实现可选能力时”下必须对“CONFORMANCE-MODALITY”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00165` | `SU-ARINC-665-5-1-3-3-P011-PROSE-SENTENCE-001-E0CA338A51EE`<br>`ARINC-665-5 1.3.3 p.1` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `NETWORK-INTERFACE, DATA-TYPE` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“网络接口、DATA-TYPE”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00166` | `SU-ARINC-665-5-1-4-2-P012-PROSE-SENTENCE-002-D07F6C2D4DAC`<br>`ARINC-665-5 1.4.2 p.2` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `NETWORK-INTERFACE` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“网络接口”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00167` | `SU-ARINC-665-5-1-4-3-P013-PROSE-SENTENCE-003-F355ED0B2EC9`<br>`ARINC-665-5 1.4.3 p.3` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ALLOW-READ` / `FILE-VERSION-COMPATIBILITY` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“FILE-VERSION-COMPATIBILITY”执行“允许读取”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00168` | `SU-ARINC-665-5-1-4-3-P013-PROSE-SENTENCE-004-C23C95885017`<br>`ARINC-665-5 1.4.3 p.3` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `FILE-VERSION-COMPATIBILITY` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“FILE-VERSION-COMPATIBILITY”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00169` | `SU-ARINC-665-5-1-4-4-P013-PROSE-SENTENCE-007-5E8CCA74AF4E`<br>`ARINC-665-5 1.4.4 p.3` | `PROTOCOL-FILE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `HEADER-FILE, LOAD-PART-NUMBER` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“协议文件生成方”在“生成 ARINC 665 数据对象时”下必须对“头文件、加载件号”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00170` | `SU-ARINC-665-5-1-5-P014-PROSE-SENTENCE-002-DBF83061338F`<br>`ARINC-665-5 1.5 p.4` | `TARGET-HARDWARE` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `REFLECT` / `NETWORK-INTERFACE, MANUFACTURER-IDENTIFIER, TARGET-HARDWARE-ID` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“生成 ARINC 665 数据对象时”下必须对“网络接口、MANUFACTURER-IDENTIFIER、TARGET-HARDWARE-ID”执行“反映”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00171` | `SU-ARINC-665-5-1-5-P014-PROSE-SENTENCE-003-35251417E277`<br>`ARINC-665-5 1.5 p.4` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ASSIGN` / `MANUFACTURER-IDENTIFIER` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“MANUFACTURER-IDENTIFIER”执行“分配或管理”；证据是“状态或编码结果可被观察”。 | — | — |
...
| `CRS-M1-00175` | `SU-ARINC-665-5-2-1-1-P016-PROSE-SENTENCE-001-79D9D9285B09`<br>`ARINC-665-5 2.1.1 p.6` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `FORMAT` / `LOADABLE-SOFTWARE-PART-NUMBER` / `ENCODED-FORMAT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“LOADABLE-SOFTWARE-PART-NUMBER”执行“按规定格式化”；证据是“编码格式可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00176` | `SU-ARINC-665-5-2-1-1-P016-PROSE-SENTENCE-004-FBE93765B788`<br>`ARINC-665-5 2.1.1 p.6` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `DEFINE` / `LOAD-PART-NUMBER` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“加载件号”执行“定义”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00177` | `SU-ARINC-665-5-2-1-1-P016-PROSE-SENTENCE-007-6FB26843CBD8`<br>`ARINC-665-5 2.1.1 p.6` | `DATA-LOADER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `IMPLEMENT` / `LOAD-PART-NUMBER` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“生成 ARINC 665 数据对象时”下必须对“加载件号”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00178` | `SU-ARINC-665-5-2-1-1-P016-PROSE-SENTENCE-008-63B5D84BC565`<br>`ARINC-665-5 2.1.1 p.6` | `DATA-LOADER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `USE` / `LOAD-PART-NUMBER` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“数据加载器”在“生成 ARINC 665 数据对象时”下必须对“加载件号”执行“使用”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00179` | `SU-ARINC-665-5-2-1-3-P017-PROSE-SENTENCE-003-41F8723AEC8B`<br>`ARINC-665-5 2.1.3 p.7` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `COMPUTE` / `CHECK-CHARACTERS` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CHECK-CHARACTERS”执行“计算”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00180` | `SU-ARINC-665-5-2-2-2-1-P018-PROSE-SENTENCE-001-84EA4A3113C8`<br>`ARINC-665-5 2.2.2.1 p.8` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `FORMAT` / `HEADER-FILE, SOFTWARE-PART` / `ENCODED-FORMAT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“头文件、软件加载件”执行“按规定格式化”；证据是“编码格式可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00181` | `SU-ARINC-665-5-2-2-3-1-P018-PROSE-SENTENCE-001-7A7C6DE1A7A7`<br>`ARINC-665-5 2.2.3.1 p.8` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `HEADER-FILE, SOFTWARE-PART` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“头文件、软件加载件”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00182` | `SU-ARINC-665-5-2-2-3-1-P019-PROSE-SENTENCE-003-D19D48006847`<br>`ARINC-665-5 2.2.3.1 p.9` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `HEADER-FILE` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“头文件”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00183` | `SU-ARINC-665-5-2-2-3-1-P019-PROSE-SENTENCE-003-D19D48006847`<br>`ARINC-665-5 2.2.3.1 p.9` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `DEFINE` / `HEADER-FILE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“头文件”执行“定义”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00184` | `SU-ARINC-665-5-2-2-3-1-P019-PROSE-SENTENCE-004-A761BB0130D9`<br>`ARINC-665-5 2.2.3.1 p.9` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `BINARY-FIELD-ENCODING` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“BINARY-FIELD-ENCODING”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
...
| `CRS-M1-00186` | `SU-ARINC-665-5-2-2-3-1-3-2-P021-PROSE-SENTENCE-001-641A8CBC9145`<br>`ARINC-665-5 2.2.3.1.3.2 p.11` | `PROTOCOL-FILE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `PART-FLAGS` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“协议文件生成方”在“生成 ARINC 665 数据对象时”下必须对“PART-FLAGS”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00187` | `SU-ARINC-665-5-2-2-3-1-3-2-P021-PROSE-SENTENCE-001-641A8CBC9145`<br>`ARINC-665-5 2.2.3.1.3.2 p.11` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `BINARY-FIELD-ENCODING` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“BINARY-FIELD-ENCODING”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00188` | `SU-ARINC-665-5-2-2-3-1-10-P022-PROSE-SENTENCE-003-BCEBB784B407`<br>`ARINC-665-5 2.2.3.1.10 p.12` | `TARGET-HARDWARE` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `TARGET-HARDWARE-ID, STATUS-CODE-CONDITIONAL-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“生成 ARINC 665 数据对象时”下必须对“TARGET-HARDWARE-ID、STATUS-CODE-CONDITIONAL-FIELD”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00189` | `SU-ARINC-665-5-2-2-3-1-14-P022-PROSE-SENTENCE-004-4114C0816C51`<br>`ARINC-665-5 2.2.3.1.14 p.12` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `IMPLEMENT` / `LOAD-PART-NUMBER, SOFTWARE-PART` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“加载件号、软件加载件”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00190` | `SU-ARINC-665-5-2-2-3-1-18-P023-PROSE-SENTENCE-002-E664B245877E`<br>`ARINC-665-5 2.2.3.1.18 p.13` | `PROTOCOL-FILE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `NETWORK-INTERFACE, STATUS-CODE-CONDITIONAL-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“协议文件生成方”在“生成 ARINC 665 数据对象时”下必须对“网络接口、STATUS-CODE-CONDITIONAL-FIELD”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00191` | `SU-ARINC-665-5-2-2-3-1-18-P023-PROSE-SENTENCE-004-C2CE75F23520`<br>`ARINC-665-5 2.2.3.1.18 p.13` | `TARGET-HARDWARE` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENSURE-UNIQUE` / `SOFTWARE-PART, TARGET-HARDWARE-ID` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“生成 ARINC 665 数据对象时”下必须对“软件加载件、TARGET-HARDWARE-ID”执行“保证唯一性”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00192` | `SU-ARINC-665-5-2-2-3-1-24-P024-PROSE-SENTENCE-002-C100FC8EE4E9`<br>`ARINC-665-5 2.2.3.1.24 p.14` | `TARGET-HARDWARE` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `SOFTWARE-PART, TARGET-HARDWARE-ID` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“生成 ARINC 665 数据对象时”下必须对“软件加载件、TARGET-HARDWARE-ID”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | DEP-ARINC-6655 |
| `CRS-M1-00193` | `SU-ARINC-665-5-2-2-3-1-26-P024-PROSE-SENTENCE-005-38372C2FA366`<br>`ARINC-665-5 2.2.3.1.26 p.14` | `TARGET-HARDWARE` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `TARGET-HARDWARE-ID, STATUS-CODE-CONDITIONAL-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“目标硬件”在“生成 ARINC 665 数据对象时”下必须对“TARGET-HARDWARE-ID、STATUS-CODE-CONDITIONAL-FIELD”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00194` | `SU-ARINC-665-5-2-2-3-1-31-P025-PROSE-SENTENCE-002-0374CB53F0AB`<br>`ARINC-665-5 2.2.3.1.31 p.15` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `CONSTRAIN` / `DATA-FILE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `MUST` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“数据文件”执行“施加边界约束”；证据是“状态或编码结果可被观察”。 | — | — |
| `CRS-M1-00195` | `SU-ARINC-665-5-2-2-3-1-32-P025-PROSE-SENTENCE-002-F6BCEFFF8371`<br>`ARINC-665-5 2.2.3.1.32 p.15` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `SET-ZERO` / `DATA-FILE` / `ZERO-VALUE-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“数据文件”执行“置零”；证据是“零值可被观察”。 | — | — |
| `CRS-M1-00196` | `SU-ARINC-665-5-2-2-3-1-37-P026-PROSE-SENTENCE-002-05AC99F08A26`<br>`ARINC-665-5 2.2.3.1.37 p.16` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `FORMAT` / `DATA-FILE` / `ENCODED-FORMAT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“数据文件”执行“按规定格式化”；证据是“编码格式可被观察”。 | — | — |
| `CRS-M1-00197` | `SU-ARINC-665-5-2-2-3-1-38-P026-PROSE-SENTENCE-002-E3FF88E1EDA0`<br>`ARINC-665-5 2.2.3.1.38 p.16` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `DEFINE` / `CRC, NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值、网络接口”执行“定义”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00198` | `SU-ARINC-665-5-2-2-3-1-40-P026-PROSE-SENTENCE-002-FCF47A272C90`<br>`ARINC-665-5 2.2.3.1.40 p.16` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00199` | `SU-ARINC-665-5-2-2-3-1-41-P026-PROSE-SENTENCE-002-91B469DEBE14`<br>`ARINC-665-5 2.2.3.1.41 p.16` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00200` | `SU-ARINC-665-5-2-2-3-1-42-P026-PROSE-SENTENCE-002-5E94CB4814AF`<br>`ARINC-665-5 2.2.3.1.42 p.16` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00201` | `SU-ARINC-665-5-2-2-3-1-44-P027-PROSE-SENTENCE-002-AF1722AA2C2B`<br>`ARINC-665-5 2.2.3.1.44 p.17` | `PROTOCOL-FILE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `NETWORK-INTERFACE` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“协议文件生成方”在“生成 ARINC 665 数据对象时”下必须对“网络接口”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00202` | `SU-ARINC-665-5-2-2-3-1-45-P027-PROSE-SENTENCE-002-3B48FE46115E`<br>`ARINC-665-5 2.2.3.1.45 p.17` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `IMPLEMENT` / `NETWORK-INTERFACE` / `CAPABILITY-AVAILABILITY-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“网络接口”执行“提供能力”；证据是“能力可用性可被观察”。 | — | — |
| `CRS-M1-00203` | `SU-ARINC-665-5-2-2-3-1-49-P027-PROSE-SENTENCE-004-5EFD86A600D8`<br>`ARINC-665-5 2.2.3.1.49 p.17` | `PROTOCOL-FILE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `LOAD-PART-NUMBER, NETWORK-INTERFACE, STATUS-CODE-CONDITIONAL-FIELD` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“协议文件生成方”在“生成 ARINC 665 数据对象时”下必须对“加载件号、网络接口、STATUS-CODE-CONDITIONAL-FIELD”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
| `CRS-M1-00204` | `SU-ARINC-665-5-2-2-3-1-51-P027-PROSE-SENTENCE-002-E3FF88E1EDA0`<br>`ARINC-665-5 2.2.3.1.51 p.17` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `DEFINE` / `CRC, NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值、网络接口”执行“定义”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00205` | `SU-ARINC-665-5-2-2-3-1-53-P028-PROSE-SENTENCE-002-EE1E5830AB09`<br>`ARINC-665-5 2.2.3.1.53 p.18` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00206` | `SU-ARINC-665-5-2-2-3-1-54-P028-PROSE-SENTENCE-002-02BC06547867`<br>`ARINC-665-5 2.2.3.1.54 p.18` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC, NETWORK-INTERFACE` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值、网络接口”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00207` | `SU-ARINC-665-5-2-2-3-1-57-P028-PROSE-SENTENCE-002-284196C6B3D0`<br>`ARINC-665-5 2.2.3.1.57 p.18` | `OPERATOR` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `HEADER-FILE` / `VALIDATION-RESULT-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 参与者“操作员”在“生成 ARINC 665 数据对象时”下可以对“头文件”执行“验证”；证据是“验证结果可被观察”。 | — | — |
...
| `CRS-M1-00213` | `SU-ARINC-665-5-2-2-3-1-61-P029-PROSE-SENTENCE-004-9A509D9AE4E2`<br>`ARINC-665-5 2.2.3.1.61 p.19` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `VALIDATE` / `CRC` / `VALIDATION-RESULT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值”执行“验证”；证据是“验证结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00214` | `SU-ARINC-665-5-2-2-3-1-62-P029-PROSE-SENTENCE-002-136B2E7764B0`<br>`ARINC-665-5 2.2.3.1.62 p.19` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `DEFINE` / `HEADER-FILE, CRC, NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“头文件、CRC／校验值、网络接口”执行“定义”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00215` | `SU-ARINC-665-5-2-2-3-1-63-P029-PROSE-SENTENCE-002-8F49EC0CB8C3`<br>`ARINC-665-5 2.2.3.1.63 p.19` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `COMPUTE` / `HEADER-FILE, CRC` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“头文件、CRC／校验值”执行“计算”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
| `CRS-M1-00216` | `SU-ARINC-665-5-2-2-3-1-63-P029-PROSE-SENTENCE-003-5A9C8CDFFDEB`<br>`ARINC-665-5 2.2.3.1.63 p.19` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `DEFINE` / `CRC, NETWORK-INTERFACE` / `STATE-OR-ENCODING-OUTCOME-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“CRC／校验值、网络接口”执行“定义”；证据是“状态或编码结果可被观察”。 | — | DEP-ARINC-645, GAP-ARINC-645 |
...
| `CRS-M1-00218` | `SU-ARINC-665-5-2-2-3-3-P029-PROSE-SENTENCE-002-BC8C7608516E`<br>`ARINC-665-5 2.2.3.3 p.19` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-ARINC-665-DATA-OBJECT` / `ENCODE` / `SOFTWARE-PART, NETWORK-INTERFACE, FILE-CONTENT` / `ENCODED-FIELD-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 参与者“软件包生成方”在“生成 ARINC 665 数据对象时”下必须对“软件加载件、网络接口、FILE-CONTENT”执行“编码或赋值”；证据是“编码字段可被观察”。 | — | — |
