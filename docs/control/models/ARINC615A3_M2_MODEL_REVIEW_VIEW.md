...
- Current input artifact commit `7c599454a4a972733bd6bbee05ec5f594c601b20` tree `9e52b293110234b9bd233f3be30feda07e0d13e8`
...
| `OBJ-SUPPORTING-RESTRICT-RFC-OPTIONS-INSIDE-P3-PROFILE-WITHOUT-DROPPING-615A-TFTP-OPTIONS-CRS-M1-00604` | `CRS-M1-00604` | RESTRICT-RFC-OPTIONS-INSIDE-P3-PROFILE-WITHOUT-DROPPING-615A-TFTP-OPTIONS | ARINC-664-NETWORK-CONSTRAINT |
| `OBJ-SUPPORTING-KEEP-UDP-AS-MINIMUM-TRANSPORT-CRS-M1-00605` | `CRS-M1-00605` | KEEP-UDP-AS-MINIMUM-TRANSPORT | ARINC-664-NETWORK-CONSTRAINT |
| `OBJ-SUPPORTING-RECONCILE-IPV4-FRAGMENTATION-WITHOUT-ERASING-615A-DATALOADER-REASSEMBLY-CRS-M1-00606` | `CRS-M1-00606` | RECONCILE-IPV4-FRAGMENTATION-WITHOUT-ERASING-615A-DATALOADER-REASSEMBLY | ARINC-664-NETWORK-CONSTRAINT |
| `OBJ-SUPPORTING-PROVIDE-VL-BAG-AND-JITTER-END-SYSTEM-SERVICES-CRS-M1-00607` | `CRS-M1-00607` | PROVIDE-VL-BAG-AND-JITTER-END-SYSTEM-SERVICES | ARINC-664-NETWORK-CONSTRAINT |
| `OBJ-SUPPORTING-APPLY-AFDX-SWITCH-SPECIFICATION-CRS-M1-00608` | `CRS-M1-00608` | APPLY-AFDX-SWITCH-SPECIFICATION | ARINC-664-NETWORK-CONSTRAINT |
| `OBJ-SUPPORTING-APPLY-AFDX-IP-UDP-PROFILE-WITHOUT-REPLACING-RFC-OR-615A-TFTP-CRS-M1-00609` | `CRS-M1-00609` | APPLY-AFDX-IP-UDP-PROFILE-WITHOUT-REPLACING-RFC-OR-615A-TFTP | ARINC-664-NETWORK-CONSTRAINT |
| `OBJ-SUPPORTING-ENCODE-UDP-HEADER-AS-SOURCE-PORT-DESTINATION-PORT-LENGTH-AND-CHECKSUM-CRS-M1-00610` | `CRS-M1-00610` | ENCODE-UDP-HEADER-AS-SOURCE-PORT-DESTINATION-PORT-LENGTH-AND-CHECKSUM | RFC-PUBLIC-TEXT-CONSTRAINT |
| `OBJ-SUPPORTING-APPLY-UDP-PORT-LENGTH-AND-CHECKSUM-FIELD-SEMANTICS-CRS-M1-00611` | `CRS-M1-00611` | APPLY-UDP-PORT-LENGTH-AND-CHECKSUM-FIELD-SEMANTICS | RFC-PUBLIC-TEXT-CONSTRAINT |
| `OBJ-SUPPORTING-ENCODE-IPV4-HEADER-IDENTITY-FIELDS-CRS-M1-00612` | `CRS-M1-00612` | ENCODE-IPV4-HEADER-IDENTITY-FIELDS | RFC-PUBLIC-TEXT-CONSTRAINT |
| `OBJ-SUPPORTING-RECONCILE-IPV4-FRAGMENTATION-AND-REASSEMBLY-WITH-615A-DATALOADER-CRS-M1-00613` | `CRS-M1-00613` | RECONCILE-IPV4-FRAGMENTATION-AND-REASSEMBLY-WITH-615A-DATALOADER | RFC-PUBLIC-TEXT-CONSTRAINT |
| `OBJ-SUPPORTING-TREAT-RFC-1122-INTERNET-LAYER-AS-UNESTABLISHED-HOST-PREMISE-CRS-M1-00614` | `CRS-M1-00614` | TREAT-RFC-1122-INTERNET-LAYER-AS-UNESTABLISHED-HOST-PREMISE | RFC-PUBLIC-TEXT-CONSTRAINT |
| `OBJ-SUPPORTING-TREAT-RFC-1122-UDP-AS-UNESTABLISHED-HOST-PREMISE-CRS-M1-00615` | `CRS-M1-00615` | TREAT-RFC-1122-UDP-AS-UNESTABLISHED-HOST-PREMISE | RFC-PUBLIC-TEXT-CONSTRAINT |
...
| `OBJ-SUPPORTING-USE-LOCKSTEP-RRQ-WRQ-DATA-ACK-AND-ERROR-CRS-M1-00617` | `CRS-M1-00617` | USE-LOCKSTEP-RRQ-WRQ-DATA-ACK-AND-ERROR | RFC-PUBLIC-TEXT-CONSTRAINT |
...
| `OBJ-SUPPORTING-USE-RRQ-WRQ-DATA-ACK-AND-ERROR-PACKET-LAYOUTS-CRS-M1-00619` | `CRS-M1-00619` | USE-RRQ-WRQ-DATA-ACK-AND-ERROR-PACKET-LAYOUTS | RFC-PUBLIC-TEXT-CONSTRAINT |
| `OBJ-SUPPORTING-TERMINATE-ON-SHORT-FINAL-DATA-BLOCK-CRS-M1-00620` | `CRS-M1-00620` | TERMINATE-ON-SHORT-FINAL-DATA-BLOCK | RFC-PUBLIC-TEXT-CONSTRAINT |
| `OBJ-SUPPORTING-ABORT-TFTP-TRANSFER-WITHOUT-WAIVING-615A-FIND-CLOCKS-CRS-M1-00621` | `CRS-M1-00621` | ABORT-TFTP-TRANSFER-WITHOUT-WAIVING-615A-FIND-CLOCKS | RFC-PUBLIC-TEXT-CONSTRAINT |
| `OBJ-SUPPORTING-NEGOTIATE-TFTP-OPTIONS-WITH-BACKWARD-COMPATIBLE-EXTENSION-CRS-M1-00622` | `CRS-M1-00622` | NEGOTIATE-TFTP-OPTIONS-WITH-BACKWARD-COMPATIBLE-EXTENSION | RFC-PUBLIC-TEXT-CONSTRAINT |
| `OBJ-SUPPORTING-ACKNOWLEDGE-OPTIONS-WITH-OACK-CRS-M1-00623` | `CRS-M1-00623` | ACKNOWLEDGE-OPTIONS-WITH-OACK | RFC-PUBLIC-TEXT-CONSTRAINT |
| `OBJ-SUPPORTING-APPEND-ADOPTED-OPTIONS-TO-RRQ-OR-WRQ-CRS-M1-00624` | `CRS-M1-00624` | APPEND-ADOPTED-OPTIONS-TO-RRQ-OR-WRQ | RFC-PUBLIC-TEXT-CONSTRAINT |
| `OBJ-SUPPORTING-NEGOTIATE-TFTP-BLOCKSIZE-AS-RFC-2348-CRS-M1-00625` | `CRS-M1-00625` | NEGOTIATE-TFTP-BLOCKSIZE-AS-RFC-2348 | RFC-PUBLIC-TEXT-CONSTRAINT |
| `OBJ-SUPPORTING-NEGOTIATE-TFTP-RETRANSMISSION-INTERVAL-WITHOUT-REPLACING-615A-FIND-CLOCKS-CRS-M1-00626` | `CRS-M1-00626` | NEGOTIATE-TFTP-RETRANSMISSION-INTERVAL-WITHOUT-REPLACING-615A-FIND-CLOCKS | RFC-PUBLIC-TEXT-CONSTRAINT |
| `OBJ-SUPPORTING-COMPARE-TRANSFER-SIZE-WHEN-TSIZE-IS-USED-CRS-M1-00627` | `CRS-M1-00627` | COMPARE-TRANSFER-SIZE-WHEN-TSIZE-IS-USED | RFC-PUBLIC-TEXT-CONSTRAINT |
...
| `CRS-M1-00604` | DATA-CONSTRAINT | `OBJ-SUPPORTING-RESTRICT-RFC-OPTIONS-INSIDE-P3-PROFILE-WITHOUT-DROPPING-615A-TFTP-OPTIONS-CRS-M1-00604` |
| `CRS-M1-00605` | DATA-CONSTRAINT | `OBJ-SUPPORTING-KEEP-UDP-AS-MINIMUM-TRANSPORT-CRS-M1-00605` |
| `CRS-M1-00606` | DATA-CONSTRAINT | `OBJ-SUPPORTING-RECONCILE-IPV4-FRAGMENTATION-WITHOUT-ERASING-615A-DATALOADER-REASSEMBLY-CRS-M1-00606` |
| `CRS-M1-00607` | DATA-CONSTRAINT | `OBJ-SUPPORTING-PROVIDE-VL-BAG-AND-JITTER-END-SYSTEM-SERVICES-CRS-M1-00607` |
| `CRS-M1-00608` | DATA-CONSTRAINT | `OBJ-SUPPORTING-APPLY-AFDX-SWITCH-SPECIFICATION-CRS-M1-00608` |
| `CRS-M1-00609` | DATA-CONSTRAINT | `OBJ-SUPPORTING-APPLY-AFDX-IP-UDP-PROFILE-WITHOUT-REPLACING-RFC-OR-615A-TFTP-CRS-M1-00609` |
| `CRS-M1-00610` | DATA-CONSTRAINT | `OBJ-SUPPORTING-ENCODE-UDP-HEADER-AS-SOURCE-PORT-DESTINATION-PORT-LENGTH-AND-CHECKSUM-CRS-M1-00610` |
| `CRS-M1-00611` | DATA-CONSTRAINT | `OBJ-SUPPORTING-APPLY-UDP-PORT-LENGTH-AND-CHECKSUM-FIELD-SEMANTICS-CRS-M1-00611` |
| `CRS-M1-00612` | DATA-CONSTRAINT | `OBJ-SUPPORTING-ENCODE-IPV4-HEADER-IDENTITY-FIELDS-CRS-M1-00612` |
| `CRS-M1-00613` | DATA-CONSTRAINT | `OBJ-SUPPORTING-RECONCILE-IPV4-FRAGMENTATION-AND-REASSEMBLY-WITH-615A-DATALOADER-CRS-M1-00613` |
| `CRS-M1-00614` | DATA-CONSTRAINT | `OBJ-SUPPORTING-TREAT-RFC-1122-INTERNET-LAYER-AS-UNESTABLISHED-HOST-PREMISE-CRS-M1-00614` |
| `CRS-M1-00615` | DATA-CONSTRAINT | `OBJ-SUPPORTING-TREAT-RFC-1122-UDP-AS-UNESTABLISHED-HOST-PREMISE-CRS-M1-00615` |
...
| `CRS-M1-00617` | DATA-CONSTRAINT | `OBJ-SUPPORTING-USE-LOCKSTEP-RRQ-WRQ-DATA-ACK-AND-ERROR-CRS-M1-00617` |
| `CRS-M1-00618` | DATA-CONSTRAINT | `OBJ-SUPPORTING-ASSIGN-TID-ON-RRQ-OR-WRQ-WITHOUT-MAIL-MODE-CRS-M1-00618` |
| `CRS-M1-00619` | DATA-CONSTRAINT | `OBJ-SUPPORTING-USE-RRQ-WRQ-DATA-ACK-AND-ERROR-PACKET-LAYOUTS-CRS-M1-00619` |
| `CRS-M1-00620` | DATA-CONSTRAINT | `OBJ-SUPPORTING-TERMINATE-ON-SHORT-FINAL-DATA-BLOCK-CRS-M1-00620` |
| `CRS-M1-00621` | DATA-CONSTRAINT | `OBJ-SUPPORTING-ABORT-TFTP-TRANSFER-WITHOUT-WAIVING-615A-FIND-CLOCKS-CRS-M1-00621` |
| `CRS-M1-00622` | DATA-CONSTRAINT | `OBJ-SUPPORTING-NEGOTIATE-TFTP-OPTIONS-WITH-BACKWARD-COMPATIBLE-EXTENSION-CRS-M1-00622` |
| `CRS-M1-00623` | DATA-CONSTRAINT | `OBJ-SUPPORTING-ACKNOWLEDGE-OPTIONS-WITH-OACK-CRS-M1-00623` |
| `CRS-M1-00624` | DATA-CONSTRAINT | `OBJ-SUPPORTING-APPEND-ADOPTED-OPTIONS-TO-RRQ-OR-WRQ-CRS-M1-00624` |
| `CRS-M1-00625` | DATA-CONSTRAINT | `OBJ-SUPPORTING-NEGOTIATE-TFTP-BLOCKSIZE-AS-RFC-2348-CRS-M1-00625` |
| `CRS-M1-00626` | DATA-CONSTRAINT | `OBJ-SUPPORTING-NEGOTIATE-TFTP-RETRANSMISSION-INTERVAL-WITHOUT-REPLACING-615A-FIND-CLOCKS-CRS-M1-00626` |
| `CRS-M1-00627` | DATA-CONSTRAINT | `OBJ-SUPPORTING-COMPARE-TRANSFER-SIZE-WHEN-TSIZE-IS-USED-CRS-M1-00627` |
...
| `TR-CRS-M1-00604-0702` | `CRS-M1-00604` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-RESTRICT-RFC-OPTIONS-INSIDE-P3-PROFILE-WITHOUT-DROPPING-615A-TFTP-OPTIONS-CRS-M1-00604` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00605-0703` | `CRS-M1-00605` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-KEEP-UDP-AS-MINIMUM-TRANSPORT-CRS-M1-00605` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00606-0704` | `CRS-M1-00606` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-RECONCILE-IPV4-FRAGMENTATION-WITHOUT-ERASING-615A-DATALOADER-REASSEMBLY-CRS-M1-00606` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00607-0705` | `CRS-M1-00607` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-PROVIDE-VL-BAG-AND-JITTER-END-SYSTEM-SERVICES-CRS-M1-00607` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00608-0706` | `CRS-M1-00608` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-APPLY-AFDX-SWITCH-SPECIFICATION-CRS-M1-00608` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00609-0707` | `CRS-M1-00609` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-APPLY-AFDX-IP-UDP-PROFILE-WITHOUT-REPLACING-RFC-OR-615A-TFTP-CRS-M1-00609` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00610-0708` | `CRS-M1-00610` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-ENCODE-UDP-HEADER-AS-SOURCE-PORT-DESTINATION-PORT-LENGTH-AND-CHECKSUM-CRS-M1-00610` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00611-0709` | `CRS-M1-00611` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-APPLY-UDP-PORT-LENGTH-AND-CHECKSUM-FIELD-SEMANTICS-CRS-M1-00611` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00612-0710` | `CRS-M1-00612` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-ENCODE-IPV4-HEADER-IDENTITY-FIELDS-CRS-M1-00612` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00613-0711` | `CRS-M1-00613` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-RECONCILE-IPV4-FRAGMENTATION-AND-REASSEMBLY-WITH-615A-DATALOADER-CRS-M1-00613` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00614-0712` | `CRS-M1-00614` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-TREAT-RFC-1122-INTERNET-LAYER-AS-UNESTABLISHED-HOST-PREMISE-CRS-M1-00614` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00615-0713` | `CRS-M1-00615` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-TREAT-RFC-1122-UDP-AS-UNESTABLISHED-HOST-PREMISE-CRS-M1-00615` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00616-0714` | `CRS-M1-00616` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-APPLY-RFC-1123-TFTP-HOST-NOTES-WITHOUT-ADOPTING-MAIL-NETASCII-OR-BROADCAST-RRQ-CRS-M1-00616` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00617-0715` | `CRS-M1-00617` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-USE-LOCKSTEP-RRQ-WRQ-DATA-ACK-AND-ERROR-CRS-M1-00617` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00618-0716` | `CRS-M1-00618` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-ASSIGN-TID-ON-RRQ-OR-WRQ-WITHOUT-MAIL-MODE-CRS-M1-00618` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00619-0717` | `CRS-M1-00619` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-USE-RRQ-WRQ-DATA-ACK-AND-ERROR-PACKET-LAYOUTS-CRS-M1-00619` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00620-0718` | `CRS-M1-00620` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-TERMINATE-ON-SHORT-FINAL-DATA-BLOCK-CRS-M1-00620` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00621-0719` | `CRS-M1-00621` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-ABORT-TFTP-TRANSFER-WITHOUT-WAIVING-615A-FIND-CLOCKS-CRS-M1-00621` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00622-0720` | `CRS-M1-00622` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-NEGOTIATE-TFTP-OPTIONS-WITH-BACKWARD-COMPATIBLE-EXTENSION-CRS-M1-00622` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00623-0721` | `CRS-M1-00623` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-ACKNOWLEDGE-OPTIONS-WITH-OACK-CRS-M1-00623` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00624-0722` | `CRS-M1-00624` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-APPEND-ADOPTED-OPTIONS-TO-RRQ-OR-WRQ-CRS-M1-00624` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00625-0723` | `CRS-M1-00625` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-NEGOTIATE-TFTP-BLOCKSIZE-AS-RFC-2348-CRS-M1-00625` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00626-0724` | `CRS-M1-00626` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-NEGOTIATE-TFTP-RETRANSMISSION-INTERVAL-WITHOUT-REPLACING-615A-FIND-CLOCKS-CRS-M1-00626` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00627-0725` | `CRS-M1-00627` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-COMPARE-TRANSFER-SIZE-WHEN-TSIZE-IS-USED-CRS-M1-00627` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
...
- 当前输入制品提交 `7c599454a4a972733bd6bbee05ec5f594c601b20` 树 `9e52b293110234b9bd233f3be30feda07e0d13e8`
...
| `TR-CRS-M1-00604-0702` | `CRS-M1-00604` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-RESTRICT-RFC-OPTIONS-INSIDE-P3-PROFILE-WITHOUT-DROPPING-615A-TFTP-OPTIONS-CRS-M1-00604` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00605-0703` | `CRS-M1-00605` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-KEEP-UDP-AS-MINIMUM-TRANSPORT-CRS-M1-00605` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00606-0704` | `CRS-M1-00606` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-RECONCILE-IPV4-FRAGMENTATION-WITHOUT-ERASING-615A-DATALOADER-REASSEMBLY-CRS-M1-00606` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00607-0705` | `CRS-M1-00607` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-PROVIDE-VL-BAG-AND-JITTER-END-SYSTEM-SERVICES-CRS-M1-00607` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00608-0706` | `CRS-M1-00608` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-APPLY-AFDX-SWITCH-SPECIFICATION-CRS-M1-00608` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00609-0707` | `CRS-M1-00609` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-APPLY-AFDX-IP-UDP-PROFILE-WITHOUT-REPLACING-RFC-OR-615A-TFTP-CRS-M1-00609` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00610-0708` | `CRS-M1-00610` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-ENCODE-UDP-HEADER-AS-SOURCE-PORT-DESTINATION-PORT-LENGTH-AND-CHECKSUM-CRS-M1-00610` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00611-0709` | `CRS-M1-00611` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-APPLY-UDP-PORT-LENGTH-AND-CHECKSUM-FIELD-SEMANTICS-CRS-M1-00611` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00612-0710` | `CRS-M1-00612` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-ENCODE-IPV4-HEADER-IDENTITY-FIELDS-CRS-M1-00612` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00613-0711` | `CRS-M1-00613` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-RECONCILE-IPV4-FRAGMENTATION-AND-REASSEMBLY-WITH-615A-DATALOADER-CRS-M1-00613` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00614-0712` | `CRS-M1-00614` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-TREAT-RFC-1122-INTERNET-LAYER-AS-UNESTABLISHED-HOST-PREMISE-CRS-M1-00614` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00615-0713` | `CRS-M1-00615` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-TREAT-RFC-1122-UDP-AS-UNESTABLISHED-HOST-PREMISE-CRS-M1-00615` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00616-0714` | `CRS-M1-00616` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-APPLY-RFC-1123-TFTP-HOST-NOTES-WITHOUT-ADOPTING-MAIL-NETASCII-OR-BROADCAST-RRQ-CRS-M1-00616` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00617-0715` | `CRS-M1-00617` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-USE-LOCKSTEP-RRQ-WRQ-DATA-ACK-AND-ERROR-CRS-M1-00617` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00618-0716` | `CRS-M1-00618` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-ASSIGN-TID-ON-RRQ-OR-WRQ-WITHOUT-MAIL-MODE-CRS-M1-00618` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00619-0717` | `CRS-M1-00619` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-USE-RRQ-WRQ-DATA-ACK-AND-ERROR-PACKET-LAYOUTS-CRS-M1-00619` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00620-0718` | `CRS-M1-00620` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-TERMINATE-ON-SHORT-FINAL-DATA-BLOCK-CRS-M1-00620` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00621-0719` | `CRS-M1-00621` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-ABORT-TFTP-TRANSFER-WITHOUT-WAIVING-615A-FIND-CLOCKS-CRS-M1-00621` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00622-0720` | `CRS-M1-00622` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-NEGOTIATE-TFTP-OPTIONS-WITH-BACKWARD-COMPATIBLE-EXTENSION-CRS-M1-00622` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00623-0721` | `CRS-M1-00623` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-ACKNOWLEDGE-OPTIONS-WITH-OACK-CRS-M1-00623` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00624-0722` | `CRS-M1-00624` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-APPEND-ADOPTED-OPTIONS-TO-RRQ-OR-WRQ-CRS-M1-00624` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00625-0723` | `CRS-M1-00625` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-NEGOTIATE-TFTP-BLOCKSIZE-AS-RFC-2348-CRS-M1-00625` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00626-0724` | `CRS-M1-00626` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-NEGOTIATE-TFTP-RETRANSMISSION-INTERVAL-WITHOUT-REPLACING-615A-FIND-CLOCKS-CRS-M1-00626` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00627-0725` | `CRS-M1-00627` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-COMPARE-TRANSFER-SIZE-WHEN-TSIZE-IS-USED-CRS-M1-00627` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
