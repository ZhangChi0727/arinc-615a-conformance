...
- Current input artifact commit `17f391d0179db48a3f2ce9fa66969714cd272dcf` tree `753241be5d5fa0f2ee94edbf594a9d3786d8eba2`
...
| `OBJ-SUPPORTING-IMPLEMENT-UDP-CHECKSUM-GENERATE-AND-CHECK-FACILITY-CRS-M1-00742` | `CRS-M1-00742` | IMPLEMENT-UDP-CHECKSUM-GENERATE-AND-CHECK-FACILITY | ARINC-664-NETWORK-CONSTRAINT |
...
| `CRS-M1-00742` | DATA-CONSTRAINT | `OBJ-SUPPORTING-IMPLEMENT-UDP-CHECKSUM-GENERATE-AND-CHECK-FACILITY-CRS-M1-00742` |
...
| `TR-CRS-M1-00742-0955` | `CRS-M1-00742` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-IMPLEMENT-UDP-CHECKSUM-GENERATE-AND-CHECK-FACILITY-CRS-M1-00742` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
...
- 当前输入制品提交 `17f391d0179db48a3f2ce9fa66969714cd272dcf` 树 `753241be5d5fa0f2ee94edbf594a9d3786d8eba2`
...
| `TR-CRS-M1-00742-0955` | `CRS-M1-00742` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-IMPLEMENT-UDP-CHECKSUM-GENERATE-AND-CHECK-FACILITY-CRS-M1-00742` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
