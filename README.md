...
- Correct Table 6.4.4-1 to LUR and Table 6.4.5-1 to LUS; set CRS-M1-00365 WRQ actor to DATA-LOADER; keep LUI field-table predicates as a named gap. Add source-explicit 615A→665 and TFTP-option refinements used by the model; keep AFDX, FIND, 645 and P3 deviations deferred.
...
- 将表 6.4.4-1 纠正为 LUR、表 6.4.5-1 纠正为 LUS；将 CRS-M1-00365 WRQ 参与者改为 DATA-LOADER；LUI 字段表谓词作为具名缺口。为模型实际使用的对象增加 615A→665 与 TFTP 选项精化；FIND、AFDX、645 与 P3 偏差保持延期。
