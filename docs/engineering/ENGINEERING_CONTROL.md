...
Evidence records. Merged M1 remains the immutable
[`CRS/applicability package`](../../configs/requirements/arinc_615a3_m1_crs.json).
M2 supplies the candidate
[`observable timed model package`](../../configs/models/arinc_615a3_m2_model.json)
and still creates no codec, protocol operation, executable EFSM engine, case,
procedure, oracle or Project Configuration.
