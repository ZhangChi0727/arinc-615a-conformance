...
- Current input artifact commit `68742fc0bfd53c51038c6daa804c60a5422993a6` tree `906d87e0cd0b685ba08d7410459968838b9e301d`
...
| `OBJ-SUPPORTING-RESTRICT-RFC-OPTIONS-ONLY-FOR-AERONAUTICAL-CONFLICT-OR-AMBIGUITY-CRS-M1-00732` | `CRS-M1-00732` | RESTRICT-RFC-OPTIONS-ONLY-FOR-AERONAUTICAL-CONFLICT-OR-AMBIGUITY | ARINC-664-NETWORK-CONSTRAINT |
| `OBJ-SUPPORTING-LIMIT-P3-CONTENTS-TO-RFC-CHANGES-AND-OPTION-RESTRICTIONS-CRS-M1-00733` | `CRS-M1-00733` | LIMIT-P3-CONTENTS-TO-RFC-CHANGES-AND-OPTION-RESTRICTIONS | ARINC-664-NETWORK-CONSTRAINT |
...
| `OBJ-SUPPORTING-TREAT-UDP-CHECKSUM-AS-NOT-USED-ON-AFDX-CRS-M1-00742` | `CRS-M1-00742` | TREAT-UDP-CHECKSUM-AS-NOT-USED-ON-AFDX | ARINC-664-NETWORK-CONSTRAINT |
...
| `CRS-M1-00732` | DATA-CONSTRAINT | `OBJ-SUPPORTING-RESTRICT-RFC-OPTIONS-ONLY-FOR-AERONAUTICAL-CONFLICT-OR-AMBIGUITY-CRS-M1-00732` |
| `CRS-M1-00733` | DATA-CONSTRAINT | `OBJ-SUPPORTING-LIMIT-P3-CONTENTS-TO-RFC-CHANGES-AND-OPTION-RESTRICTIONS-CRS-M1-00733` |
...
| `CRS-M1-00742` | DATA-CONSTRAINT | `OBJ-SUPPORTING-TREAT-UDP-CHECKSUM-AS-NOT-USED-ON-AFDX-CRS-M1-00742` |
...
| `TR-CRS-M1-00732-0945` | `CRS-M1-00732` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-RESTRICT-RFC-OPTIONS-ONLY-FOR-AERONAUTICAL-CONFLICT-OR-AMBIGUITY-CRS-M1-00732` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
| `TR-CRS-M1-00733-0946` | `CRS-M1-00733` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-LIMIT-P3-CONTENTS-TO-RFC-CHANGES-AND-OPTION-RESTRICTIONS-CRS-M1-00733` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
...
| `TR-CRS-M1-00742-0955` | `CRS-M1-00742` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-TREAT-UDP-CHECKSUM-AS-NOT-USED-ON-AFDX-CRS-M1-00742` | Supporting-source predicate recorded as a data-object constraint; bound M2 does not widen UPLOAD/INFORMATION execution. |
...
- 当前输入制品提交 `68742fc0bfd53c51038c6daa804c60a5422993a6` 树 `906d87e0cd0b685ba08d7410459968838b9e301d`
...
| `TR-CRS-M1-00732-0945` | `CRS-M1-00732` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-RESTRICT-RFC-OPTIONS-ONLY-FOR-AERONAUTICAL-CONFLICT-OR-AMBIGUITY-CRS-M1-00732` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
| `TR-CRS-M1-00733-0946` | `CRS-M1-00733` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-LIMIT-P3-CONTENTS-TO-RFC-CHANGES-AND-OPTION-RESTRICTIONS-CRS-M1-00733` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
...
| `TR-CRS-M1-00742-0955` | `CRS-M1-00742` | OBJECT-CONSTRAINT | `OBJ-SUPPORTING-TREAT-UDP-CHECKSUM-AS-NOT-USED-ON-AFDX-CRS-M1-00742` | 支持来源谓词记为数据对象约束；绑定 M2 不扩大 UPLOAD/INFORMATION 执行。 |
