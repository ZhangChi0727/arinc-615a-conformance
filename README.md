...
- Deliver an observable timed EFSM for UPLOAD and INFORMATION with obligation-level traces, clocks and Attachment 4 timing.
...
- 交付 UPLOAD 与 INFORMATION 的可观测 timed EFSM，含义务级追踪、时钟和附件 4 时序。
