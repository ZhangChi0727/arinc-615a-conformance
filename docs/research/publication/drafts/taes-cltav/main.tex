...
\usepackage{textcomp}
\usepackage{balance}
% Keep the draft bibliography with the manuscript rather than leaving an
% orphaned final reference page; the template default is 8/10 pt.
\def\bibliofont{\fontfamily{\rmdefault}\fontsize{7}{8}\selectfont}
...
\input{sections/sec3_arch}
\input{sections/sec4_method}
\input{sections/sec5_setup}
