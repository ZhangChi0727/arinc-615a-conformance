...
| `FC-LUI-FIELD-FILE-LENGTH` | LUI | FIELD-FILE-LENGTH | `CRS-M1-00309` | LUI-FILE-BYTES |
| `FC-LUI-FIELD-PROTOCOL-VERSION` | LUI | FIELD-PROTOCOL-VERSION | `CRS-M1-00310` | LUI-FILE-BYTES |
| `FC-LUI-FIELD-NUMBER-OF-HEADER-FILES` | LUI | FIELD-NUMBER-OF-HEADER-FILES | `CRS-M1-00311` | LUI-FILE-BYTES |
| `FC-LUI-FIELD-HEADER-FILE-NAME-LENGTH` | LUI | FIELD-HEADER-FILE-NAME-LENGTH | `CRS-M1-00312` | LUI-FILE-BYTES |
| `FC-LUI-FIELD-HEADER-FILE-NAME` | LUI | FIELD-HEADER-FILE-NAME | `CRS-M1-00313` | LUI-FILE-BYTES |
| `FC-LUI-FIELD-LOAD-PART-NUMBER-NAME-LENGTH` | LUI | FIELD-LOAD-PART-NUMBER-NAME-LENGTH | `CRS-M1-00314` | LUI-FILE-BYTES |
| `FC-LUI-FIELD-LOAD-PART-NUMBER-NAME` | LUI | FIELD-LOAD-PART-NUMBER-NAME | `CRS-M1-00315` | LUI-FILE-BYTES |
| `FC-LUR-FIELD-FILE-LENGTH` | LUR | FIELD-FILE-LENGTH | `CRS-M1-00316` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-PROTOCOL-VERSION` | LUR | FIELD-PROTOCOL-VERSION | `CRS-M1-00317` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-UPLOAD-OPERATION-STATUS-CODE` | LUR | FIELD-UPLOAD-OPERATION-STATUS-CODE | `CRS-M1-00318` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-UPLOAD-STATUS-DESCRIPTION-LENGTH` | LUR | FIELD-UPLOAD-STATUS-DESCRIPTION-LENGTH | `CRS-M1-00319` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-UPLOAD-STATUS-DESCRIPTION` | LUR | FIELD-UPLOAD-STATUS-DESCRIPTION | `CRS-M1-00320` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-COUNTER` | LUR | FIELD-COUNTER | `CRS-M1-00321` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-EXCEPTION-TIMER` | LUR | FIELD-EXCEPTION-TIMER | `CRS-M1-00322` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-ESTIMATED-TIME` | LUR | FIELD-ESTIMATED-TIME | `CRS-M1-00323` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-LOAD-LIST-RATIO` | LUR | FIELD-LOAD-LIST-RATIO | `CRS-M1-00324` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-NUMBER-OF-HEADER-FILES` | LUR | FIELD-NUMBER-OF-HEADER-FILES | `CRS-M1-00325` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-HEADER-FILE-NAME-LENGTH` | LUR | FIELD-HEADER-FILE-NAME-LENGTH | `CRS-M1-00326` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-HEADER-FILE-NAME` | LUR | FIELD-HEADER-FILE-NAME | `CRS-M1-00327` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-LOAD-PART-NUMBER-NAME-LENGTH` | LUR | FIELD-LOAD-PART-NUMBER-NAME-LENGTH | `CRS-M1-00328` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-LOAD-PART-NUMBER-NAME` | LUR | FIELD-LOAD-PART-NUMBER-NAME | `CRS-M1-00329` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-LOAD-RATIO` | LUR | FIELD-LOAD-RATIO | `CRS-M1-00330` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-LOAD-STATUS` | LUR | FIELD-LOAD-STATUS | `CRS-M1-00331` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-LOAD-STATUS-DESCRIPTION-LENGTH` | LUR | FIELD-LOAD-STATUS-DESCRIPTION-LENGTH | `CRS-M1-00332` | LUR-FILE-BYTES |
| `FC-LUR-FIELD-LOAD-STATUS-DESCRIPTION` | LUR | FIELD-LOAD-STATUS-DESCRIPTION | `CRS-M1-00333` | LUR-FILE-BYTES |
...
| `CRS-M1-00143` | MODELED | `T_UPL_FILE_XFER` |
...
| `CRS-M1-00309` | DATA-CONSTRAINT | `FC-LUI-FIELD-FILE-LENGTH` |
| `CRS-M1-00310` | DATA-CONSTRAINT | `FC-LUI-FIELD-PROTOCOL-VERSION` |
| `CRS-M1-00311` | DATA-CONSTRAINT | `FC-LUI-FIELD-NUMBER-OF-HEADER-FILES` |
| `CRS-M1-00312` | DATA-CONSTRAINT | `FC-LUI-FIELD-HEADER-FILE-NAME-LENGTH` |
| `CRS-M1-00313` | DATA-CONSTRAINT | `FC-LUI-FIELD-HEADER-FILE-NAME` |
| `CRS-M1-00314` | DATA-CONSTRAINT | `FC-LUI-FIELD-LOAD-PART-NUMBER-NAME-LENGTH` |
| `CRS-M1-00315` | DATA-CONSTRAINT | `FC-LUI-FIELD-LOAD-PART-NUMBER-NAME` |
| `CRS-M1-00316` | DATA-CONSTRAINT | `FC-LUR-FIELD-FILE-LENGTH` |
| `CRS-M1-00317` | DATA-CONSTRAINT | `FC-LUR-FIELD-PROTOCOL-VERSION` |
| `CRS-M1-00318` | DATA-CONSTRAINT | `FC-LUR-FIELD-UPLOAD-OPERATION-STATUS-CODE` |
| `CRS-M1-00319` | DATA-CONSTRAINT | `FC-LUR-FIELD-UPLOAD-STATUS-DESCRIPTION-LENGTH` |
| `CRS-M1-00320` | DATA-CONSTRAINT | `FC-LUR-FIELD-UPLOAD-STATUS-DESCRIPTION` |
| `CRS-M1-00321` | DATA-CONSTRAINT | `FC-LUR-FIELD-COUNTER` |
| `CRS-M1-00322` | DATA-CONSTRAINT | `FC-LUR-FIELD-EXCEPTION-TIMER`, `TIM-CRS-M1-00322`, `CLK_EXCEPTION` |
| `CRS-M1-00323` | DATA-CONSTRAINT | `FC-LUR-FIELD-ESTIMATED-TIME` |
| `CRS-M1-00324` | DATA-CONSTRAINT | `FC-LUR-FIELD-LOAD-LIST-RATIO` |
| `CRS-M1-00325` | DATA-CONSTRAINT | `FC-LUR-FIELD-NUMBER-OF-HEADER-FILES` |
| `CRS-M1-00326` | DATA-CONSTRAINT | `FC-LUR-FIELD-HEADER-FILE-NAME-LENGTH` |
| `CRS-M1-00327` | DATA-CONSTRAINT | `FC-LUR-FIELD-HEADER-FILE-NAME` |
| `CRS-M1-00328` | DATA-CONSTRAINT | `FC-LUR-FIELD-LOAD-PART-NUMBER-NAME-LENGTH` |
| `CRS-M1-00329` | DATA-CONSTRAINT | `FC-LUR-FIELD-LOAD-PART-NUMBER-NAME` |
| `CRS-M1-00330` | DATA-CONSTRAINT | `FC-LUR-FIELD-LOAD-RATIO` |
| `CRS-M1-00331` | DATA-CONSTRAINT | `FC-LUR-FIELD-LOAD-STATUS` |
| `CRS-M1-00332` | DATA-CONSTRAINT | `FC-LUR-FIELD-LOAD-STATUS-DESCRIPTION-LENGTH` |
| `CRS-M1-00333` | DATA-CONSTRAINT | `FC-LUR-FIELD-LOAD-STATUS-DESCRIPTION` |
...
| `TR-CRS-M1-00143-0165` | `CRS-M1-00143` | TRANSITION | `T_UPL_FILE_XFER` | UPLOAD file-thread obligation after LUR. |
...
| `TR-CRS-M1-00309-0353` | `CRS-M1-00309` | FIELD-CONSTRAINT | `FC-LUI-FIELD-FILE-LENGTH` | Field predicate FC-LUI-FIELD-FILE-LENGTH at the named protocol file bytes. |
| `TR-CRS-M1-00310-0354` | `CRS-M1-00310` | FIELD-CONSTRAINT | `FC-LUI-FIELD-PROTOCOL-VERSION` | Field predicate FC-LUI-FIELD-PROTOCOL-VERSION at the named protocol file bytes. |
| `TR-CRS-M1-00311-0355` | `CRS-M1-00311` | FIELD-CONSTRAINT | `FC-LUI-FIELD-NUMBER-OF-HEADER-FILES` | Field predicate FC-LUI-FIELD-NUMBER-OF-HEADER-FILES at the named protocol file bytes. |
| `TR-CRS-M1-00312-0356` | `CRS-M1-00312` | FIELD-CONSTRAINT | `FC-LUI-FIELD-HEADER-FILE-NAME-LENGTH` | Field predicate FC-LUI-FIELD-HEADER-FILE-NAME-LENGTH at the named protocol file bytes. |
| `TR-CRS-M1-00313-0357` | `CRS-M1-00313` | FIELD-CONSTRAINT | `FC-LUI-FIELD-HEADER-FILE-NAME` | Field predicate FC-LUI-FIELD-HEADER-FILE-NAME at the named protocol file bytes. |
| `TR-CRS-M1-00314-0358` | `CRS-M1-00314` | FIELD-CONSTRAINT | `FC-LUI-FIELD-LOAD-PART-NUMBER-NAME-LENGTH` | Field predicate FC-LUI-FIELD-LOAD-PART-NUMBER-NAME-LENGTH at the named protocol file bytes. |
| `TR-CRS-M1-00315-0359` | `CRS-M1-00315` | FIELD-CONSTRAINT | `FC-LUI-FIELD-LOAD-PART-NUMBER-NAME` | Field predicate FC-LUI-FIELD-LOAD-PART-NUMBER-NAME at the named protocol file bytes. |
| `TR-CRS-M1-00316-0360` | `CRS-M1-00316` | FIELD-CONSTRAINT | `FC-LUR-FIELD-FILE-LENGTH` | Field predicate FC-LUR-FIELD-FILE-LENGTH at the named protocol file bytes. |
| `TR-CRS-M1-00317-0361` | `CRS-M1-00317` | FIELD-CONSTRAINT | `FC-LUR-FIELD-PROTOCOL-VERSION` | Field predicate FC-LUR-FIELD-PROTOCOL-VERSION at the named protocol file bytes. |
| `TR-CRS-M1-00318-0362` | `CRS-M1-00318` | FIELD-CONSTRAINT | `FC-LUR-FIELD-UPLOAD-OPERATION-STATUS-CODE` | Field predicate FC-LUR-FIELD-UPLOAD-OPERATION-STATUS-CODE at the named protocol file bytes. |
| `TR-CRS-M1-00319-0363` | `CRS-M1-00319` | FIELD-CONSTRAINT | `FC-LUR-FIELD-UPLOAD-STATUS-DESCRIPTION-LENGTH` | Field predicate FC-LUR-FIELD-UPLOAD-STATUS-DESCRIPTION-LENGTH at the named protocol file bytes. |
| `TR-CRS-M1-00320-0364` | `CRS-M1-00320` | FIELD-CONSTRAINT | `FC-LUR-FIELD-UPLOAD-STATUS-DESCRIPTION` | Field predicate FC-LUR-FIELD-UPLOAD-STATUS-DESCRIPTION at the named protocol file bytes. |
| `TR-CRS-M1-00321-0365` | `CRS-M1-00321` | FIELD-CONSTRAINT | `FC-LUR-FIELD-COUNTER` | Field predicate FC-LUR-FIELD-COUNTER at the named protocol file bytes. |
| `TR-CRS-M1-00322-0366` | `CRS-M1-00322` | FIELD-CONSTRAINT | `FC-LUR-FIELD-EXCEPTION-TIMER` | Field predicate FC-LUR-FIELD-EXCEPTION-TIMER at the named protocol file bytes. |
...
| `TR-CRS-M1-00323-0369` | `CRS-M1-00323` | FIELD-CONSTRAINT | `FC-LUR-FIELD-ESTIMATED-TIME` | Field predicate FC-LUR-FIELD-ESTIMATED-TIME at the named protocol file bytes. |
| `TR-CRS-M1-00324-0370` | `CRS-M1-00324` | FIELD-CONSTRAINT | `FC-LUR-FIELD-LOAD-LIST-RATIO` | Field predicate FC-LUR-FIELD-LOAD-LIST-RATIO at the named protocol file bytes. |
| `TR-CRS-M1-00325-0371` | `CRS-M1-00325` | FIELD-CONSTRAINT | `FC-LUR-FIELD-NUMBER-OF-HEADER-FILES` | Field predicate FC-LUR-FIELD-NUMBER-OF-HEADER-FILES at the named protocol file bytes. |
| `TR-CRS-M1-00326-0372` | `CRS-M1-00326` | FIELD-CONSTRAINT | `FC-LUR-FIELD-HEADER-FILE-NAME-LENGTH` | Field predicate FC-LUR-FIELD-HEADER-FILE-NAME-LENGTH at the named protocol file bytes. |
| `TR-CRS-M1-00327-0373` | `CRS-M1-00327` | FIELD-CONSTRAINT | `FC-LUR-FIELD-HEADER-FILE-NAME` | Field predicate FC-LUR-FIELD-HEADER-FILE-NAME at the named protocol file bytes. |
| `TR-CRS-M1-00328-0374` | `CRS-M1-00328` | FIELD-CONSTRAINT | `FC-LUR-FIELD-LOAD-PART-NUMBER-NAME-LENGTH` | Field predicate FC-LUR-FIELD-LOAD-PART-NUMBER-NAME-LENGTH at the named protocol file bytes. |
| `TR-CRS-M1-00329-0375` | `CRS-M1-00329` | FIELD-CONSTRAINT | `FC-LUR-FIELD-LOAD-PART-NUMBER-NAME` | Field predicate FC-LUR-FIELD-LOAD-PART-NUMBER-NAME at the named protocol file bytes. |
| `TR-CRS-M1-00330-0376` | `CRS-M1-00330` | FIELD-CONSTRAINT | `FC-LUR-FIELD-LOAD-RATIO` | Field predicate FC-LUR-FIELD-LOAD-RATIO at the named protocol file bytes. |
| `TR-CRS-M1-00331-0377` | `CRS-M1-00331` | FIELD-CONSTRAINT | `FC-LUR-FIELD-LOAD-STATUS` | Field predicate FC-LUR-FIELD-LOAD-STATUS at the named protocol file bytes. |
| `TR-CRS-M1-00332-0378` | `CRS-M1-00332` | FIELD-CONSTRAINT | `FC-LUR-FIELD-LOAD-STATUS-DESCRIPTION-LENGTH` | Field predicate FC-LUR-FIELD-LOAD-STATUS-DESCRIPTION-LENGTH at the named protocol file bytes. |
| `TR-CRS-M1-00333-0379` | `CRS-M1-00333` | FIELD-CONSTRAINT | `FC-LUR-FIELD-LOAD-STATUS-DESCRIPTION` | Field predicate FC-LUR-FIELD-LOAD-STATUS-DESCRIPTION at the named protocol file bytes. |
...
| `NET-ISSUE-EDITION` | `OPEN-PENDING-INDEPENDENT-ACCEPTANCE` | INDEPENDENT-RG0 | PROFILE-MODEL-REFINEMENT-GATE | Historical editions remain conditional inputs. |
...
- Timed: `NOT-CHECKED`
- Unproven: timed reachability, implementation conformance, network-stack conformance, M1 6.4.4 file identity
...
- M1 NET-ISSUE-EDITION 快照 blocksM1Approval=`True` — 已合并 M1 树上的历史快照。外部所有者签署与合并绑定了该 Head。该布尔值不重开合并；它仍是已转移的技术行动。
...
| `TR-CRS-M1-00143-0165` | `CRS-M1-00143` | TRANSITION | `T_UPL_FILE_XFER` | LUR 之后的 UPLOAD 文件线程义务。 |
...
| `TR-CRS-M1-00309-0353` | `CRS-M1-00309` | FIELD-CONSTRAINT | `FC-LUI-FIELD-FILE-LENGTH` | 在具名协议文件字节上应用字段谓词 FC-LUI-FIELD-FILE-LENGTH。 |
| `TR-CRS-M1-00310-0354` | `CRS-M1-00310` | FIELD-CONSTRAINT | `FC-LUI-FIELD-PROTOCOL-VERSION` | 在具名协议文件字节上应用字段谓词 FC-LUI-FIELD-PROTOCOL-VERSION。 |
| `TR-CRS-M1-00311-0355` | `CRS-M1-00311` | FIELD-CONSTRAINT | `FC-LUI-FIELD-NUMBER-OF-HEADER-FILES` | 在具名协议文件字节上应用字段谓词 FC-LUI-FIELD-NUMBER-OF-HEADER-FILES。 |
| `TR-CRS-M1-00312-0356` | `CRS-M1-00312` | FIELD-CONSTRAINT | `FC-LUI-FIELD-HEADER-FILE-NAME-LENGTH` | 在具名协议文件字节上应用字段谓词 FC-LUI-FIELD-HEADER-FILE-NAME-LENGTH。 |
| `TR-CRS-M1-00313-0357` | `CRS-M1-00313` | FIELD-CONSTRAINT | `FC-LUI-FIELD-HEADER-FILE-NAME` | 在具名协议文件字节上应用字段谓词 FC-LUI-FIELD-HEADER-FILE-NAME。 |
| `TR-CRS-M1-00314-0358` | `CRS-M1-00314` | FIELD-CONSTRAINT | `FC-LUI-FIELD-LOAD-PART-NUMBER-NAME-LENGTH` | 在具名协议文件字节上应用字段谓词 FC-LUI-FIELD-LOAD-PART-NUMBER-NAME-LENGTH。 |
| `TR-CRS-M1-00315-0359` | `CRS-M1-00315` | FIELD-CONSTRAINT | `FC-LUI-FIELD-LOAD-PART-NUMBER-NAME` | 在具名协议文件字节上应用字段谓词 FC-LUI-FIELD-LOAD-PART-NUMBER-NAME。 |
| `TR-CRS-M1-00316-0360` | `CRS-M1-00316` | FIELD-CONSTRAINT | `FC-LUR-FIELD-FILE-LENGTH` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-FILE-LENGTH。 |
| `TR-CRS-M1-00317-0361` | `CRS-M1-00317` | FIELD-CONSTRAINT | `FC-LUR-FIELD-PROTOCOL-VERSION` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-PROTOCOL-VERSION。 |
| `TR-CRS-M1-00318-0362` | `CRS-M1-00318` | FIELD-CONSTRAINT | `FC-LUR-FIELD-UPLOAD-OPERATION-STATUS-CODE` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-UPLOAD-OPERATION-STATUS-CODE。 |
| `TR-CRS-M1-00319-0363` | `CRS-M1-00319` | FIELD-CONSTRAINT | `FC-LUR-FIELD-UPLOAD-STATUS-DESCRIPTION-LENGTH` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-UPLOAD-STATUS-DESCRIPTION-LENGTH。 |
| `TR-CRS-M1-00320-0364` | `CRS-M1-00320` | FIELD-CONSTRAINT | `FC-LUR-FIELD-UPLOAD-STATUS-DESCRIPTION` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-UPLOAD-STATUS-DESCRIPTION。 |
| `TR-CRS-M1-00321-0365` | `CRS-M1-00321` | FIELD-CONSTRAINT | `FC-LUR-FIELD-COUNTER` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-COUNTER。 |
| `TR-CRS-M1-00322-0366` | `CRS-M1-00322` | FIELD-CONSTRAINT | `FC-LUR-FIELD-EXCEPTION-TIMER` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-EXCEPTION-TIMER。 |
...
| `TR-CRS-M1-00323-0369` | `CRS-M1-00323` | FIELD-CONSTRAINT | `FC-LUR-FIELD-ESTIMATED-TIME` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-ESTIMATED-TIME。 |
| `TR-CRS-M1-00324-0370` | `CRS-M1-00324` | FIELD-CONSTRAINT | `FC-LUR-FIELD-LOAD-LIST-RATIO` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-LOAD-LIST-RATIO。 |
| `TR-CRS-M1-00325-0371` | `CRS-M1-00325` | FIELD-CONSTRAINT | `FC-LUR-FIELD-NUMBER-OF-HEADER-FILES` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-NUMBER-OF-HEADER-FILES。 |
| `TR-CRS-M1-00326-0372` | `CRS-M1-00326` | FIELD-CONSTRAINT | `FC-LUR-FIELD-HEADER-FILE-NAME-LENGTH` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-HEADER-FILE-NAME-LENGTH。 |
| `TR-CRS-M1-00327-0373` | `CRS-M1-00327` | FIELD-CONSTRAINT | `FC-LUR-FIELD-HEADER-FILE-NAME` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-HEADER-FILE-NAME。 |
| `TR-CRS-M1-00328-0374` | `CRS-M1-00328` | FIELD-CONSTRAINT | `FC-LUR-FIELD-LOAD-PART-NUMBER-NAME-LENGTH` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-LOAD-PART-NUMBER-NAME-LENGTH。 |
| `TR-CRS-M1-00329-0375` | `CRS-M1-00329` | FIELD-CONSTRAINT | `FC-LUR-FIELD-LOAD-PART-NUMBER-NAME` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-LOAD-PART-NUMBER-NAME。 |
| `TR-CRS-M1-00330-0376` | `CRS-M1-00330` | FIELD-CONSTRAINT | `FC-LUR-FIELD-LOAD-RATIO` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-LOAD-RATIO。 |
| `TR-CRS-M1-00331-0377` | `CRS-M1-00331` | FIELD-CONSTRAINT | `FC-LUR-FIELD-LOAD-STATUS` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-LOAD-STATUS。 |
| `TR-CRS-M1-00332-0378` | `CRS-M1-00332` | FIELD-CONSTRAINT | `FC-LUR-FIELD-LOAD-STATUS-DESCRIPTION-LENGTH` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-LOAD-STATUS-DESCRIPTION-LENGTH。 |
| `TR-CRS-M1-00333-0379` | `CRS-M1-00333` | FIELD-CONSTRAINT | `FC-LUR-FIELD-LOAD-STATUS-DESCRIPTION` | 在具名协议文件字节上应用字段谓词 FC-LUR-FIELD-LOAD-STATUS-DESCRIPTION。 |
...
| `NET-ISSUE-EDITION` | `OPEN-PENDING-INDEPENDENT-ACCEPTANCE` | INDEPENDENT-RG0 | PROFILE-MODEL-REFINEMENT-GATE | 历史版次仍为有条件输入。 |
...
- 定时：`NOT-CHECKED`
- 未证明：timed reachability, implementation conformance, network-stack conformance, M1 6.4.4 file identity
