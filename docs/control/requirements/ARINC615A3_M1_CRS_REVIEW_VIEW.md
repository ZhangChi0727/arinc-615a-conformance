...
- Dependencies: 14
- Gaps: 1
- Coverage fingerprint: `3e3d2b7774b13d7d9f50878f03119e18f2d43df5b3d61059c4315b7ea5c14ebc`
- Requirements fingerprint: `91e272a9084d8b4353e557169ea2daba6e4a66b63034a107c6e5f59ee89e609d`
- Source-unit fingerprint: `2cb9a05fa82db51e25b6321802437bb6a5eb7f8bb12dd8d6426b344cf8ff0789`
...
| `CRS-M1-00548` | `SU-ARINC-665-5-TABLE-2-3-1-1-R003`<br>`ARINC-665-5 2.3.1 p.22` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-BATCH-FILE-PART` / `ENCODE` / `FIELD-SPARE` / `FIELD-PRESENCE-SIZE-AND-VALUE-OBSERVABLE` | `TABLE-CONSTRAINT` / `REQUIRED` | `APPLICABLE-SUPPORTING` | Encode the Spare field of LUB as 16 reserved zero bits used to align the following pointers.<br>将 LUB 的 Spare 字段编码为 16 位保留填零，用于对齐随后的指针。 | — | DEP-ARINC-6655 |
...
| `CRS-M1-00548` | `LUB` / `3` | `FIELD-SPARE` | `16` | `ONCE` / `ALWAYS` / `—` | `RESERVED-ZERO-FILL` / `NOT-APPLICABLE-OR-PROSE-DEFINED` | — |
...
| `CRS-M1-00551` | `LUB` / `6` | `FIELD-EXPANSION-POINT-1` | `0` | `ONCE` / `ALWAYS` / `—` | `RESERVED-ZERO-FILL` / `NOT-APPLICABLE-OR-PROSE-DEFINED` | — |
...
| `CRS-M1-00556` | `LUB` / `11` | `FIELD-EXPANSION-POINT-2` | `0` | `ONCE` / `ALWAYS` / `—` | `RESERVED-ZERO-FILL` / `NOT-APPLICABLE-OR-PROSE-DEFINED` | — |
...
| `CRS-M1-00566` | `LUB` / `21` | `FIELD-EXPANSION-POINT-3` | `0` | `ONCE` / `ALWAYS` / `—` | `RESERVED-ZERO-FILL` / `NOT-APPLICABLE-OR-PROSE-DEFINED` | — |
...
- 依赖：14
- 缺口：1
- 覆盖指纹：`3e3d2b7774b13d7d9f50878f03119e18f2d43df5b3d61059c4315b7ea5c14ebc`
- 需求指纹：`91e272a9084d8b4353e557169ea2daba6e4a66b63034a107c6e5f59ee89e609d`
- 来源单元指纹：`2cb9a05fa82db51e25b6321802437bb6a5eb7f8bb12dd8d6426b344cf8ff0789`
...
| `CRS-M1-00548` | `SU-ARINC-665-5-TABLE-2-3-1-1-R003`<br>`ARINC-665-5 2.3.1 p.22` | `SOFTWARE-PACKAGE-PRODUCER` / `WHEN-PRODUCING-BATCH-FILE-PART` / `ENCODE` / `FIELD-SPARE` / `FIELD-PRESENCE-SIZE-AND-VALUE-OBSERVABLE` | `TABLE-CONSTRAINT` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 将 LUB 的 Spare 字段编码为 16 位保留填零，用于对齐随后的指针。 | — | DEP-ARINC-6655 |
