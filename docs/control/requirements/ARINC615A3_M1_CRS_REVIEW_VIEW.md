...
| `CRS-M1-00390` | `SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-003-1E8680AD6287`<br>`ARINC-615A-3 3-2 p.96` | `DATA-LOADER` / `WHEN-FIND-IMPLEMENTED` / `KEEP-THREE-SECOND-FIND-ANSWER-WINDOW` / `FIND-ANSWER-WINDOW-3-S` / `FIND-LOADER-WINDOW-OBSERVABLE` | `FACT` / `REQUIRED` | `APPLICABLE-SUPPORTING` | After sending a FIND request, the data loader shall keep a three-second window for FIND answers.<br>发出 FIND 请求后，数据加载器必须为 FIND 应答保持三秒窗口。 | — | — |
| `CRS-M1-00391` | `SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-005-3CE166EDA700`<br>`ARINC-615A-3 3-2 p.96` | `FIND-HOST` / `WHEN-FIND-IMPLEMENTED` / `ANSWER-FIND-REQUEST-WITHIN-TWO-SECONDS` / `FIND-ANSWER, FIND-HOST-TIMEOUT-2-S` / `FIND-HOST-TIMEOUT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | A FIND host shall send its FIND answer within a two-second timeout of the request.<br>FIND 主机必须在收到请求后的两秒超时内发出 FIND 应答。 | — | — |
| `CRS-M1-00392` | `SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-006-E98F49FBFBDF`<br>`ARINC-615A-3 3-2 p.96` | `FIND-HOST` / `WHEN-FIND-IMPLEMENTED` / `ACCEPT-LATE-OR-MISSING-ANSWER-MAY-BE-UNREGISTERED` / `FIND-TARGET-REGISTRATION` / `FIND-LATE-ANSWER-RISK-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | A FIND host may be omitted from registration if its answer is late or missing.<br>若 FIND 应答迟到或缺失，FIND 主机可以不被登记。 | — | — |
...
| `CRS-M1-00390` | `SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-003-1E8680AD6287`<br>`ARINC-615A-3 3-2 p.96` | `DATA-LOADER` / `WHEN-FIND-IMPLEMENTED` / `KEEP-THREE-SECOND-FIND-ANSWER-WINDOW` / `FIND-ANSWER-WINDOW-3-S` / `FIND-LOADER-WINDOW-OBSERVABLE` | `FACT` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 发出 FIND 请求后，数据加载器必须为 FIND 应答保持三秒窗口。 | — | — |
| `CRS-M1-00391` | `SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-005-3CE166EDA700`<br>`ARINC-615A-3 3-2 p.96` | `FIND-HOST` / `WHEN-FIND-IMPLEMENTED` / `ANSWER-FIND-REQUEST-WITHIN-TWO-SECONDS` / `FIND-ANSWER, FIND-HOST-TIMEOUT-2-S` / `FIND-HOST-TIMEOUT-OBSERVABLE` | `SHOULD` / `REQUIRED` | `APPLICABLE-SUPPORTING` | FIND 主机必须在收到请求后的两秒超时内发出 FIND 应答。 | — | — |
| `CRS-M1-00392` | `SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-006-E98F49FBFBDF`<br>`ARINC-615A-3 3-2 p.96` | `FIND-HOST` / `WHEN-FIND-IMPLEMENTED` / `ACCEPT-LATE-OR-MISSING-ANSWER-MAY-BE-UNREGISTERED` / `FIND-TARGET-REGISTRATION` / `FIND-LATE-ANSWER-RISK-OBSERVABLE` | `MAY` / `OPTIONAL` | `APPLICABLE-SUPPORTING` | 若 FIND 应答迟到或缺失，FIND 主机可以不被登记。 | — | — |
