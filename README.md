...
- Unify resource admission, ERROR q-status, two-machine port association and row-level source-audit identity. This is not independent architecture, mathematical or RG approval.
...
- 统一资源准入、ERROR 的 q 状态、两机端口关联和来源审计逐行身份。这不是独立架构、数学或 RG 批准。
