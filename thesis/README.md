...
- baseline and method: [`../docs/BASELINE.md`](../docs/BASELINE.md) and
  [`../docs/methodology/00_INDEX.md`](../docs/methodology/00_INDEX.md);
- structure: [`../RESEARCH_OUTLINE.md`](../RESEARCH_OUTLINE.md);
- evidence wording: [`../docs/research/CLAIM_EVIDENCE_MATRIX.md`](../docs/research/CLAIM_EVIDENCE_MATRIX.md);
- experiments: [`../docs/research/EXPERIMENT_PLAN.md`](../docs/research/EXPERIMENT_PLAN.md);
- dependency contracts: [`../TRACKS.md`](../TRACKS.md).
...
- 基线与方法：[`../docs/BASELINE.md`](../docs/BASELINE.md) 和
  [`../docs/methodology/00_INDEX.md`](../docs/methodology/00_INDEX.md)；
- 结构：[`../RESEARCH_OUTLINE.md`](../RESEARCH_OUTLINE.md)；
- 证据措辞：[`../docs/research/CLAIM_EVIDENCE_MATRIX.md`](../docs/research/CLAIM_EVIDENCE_MATRIX.md)；
- 实验：[`../docs/research/EXPERIMENT_PLAN.md`](../docs/research/EXPERIMENT_PLAN.md)；
- 依赖契约：[`../TRACKS.md`](../TRACKS.md)。
