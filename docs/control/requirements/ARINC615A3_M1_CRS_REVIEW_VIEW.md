...
- Requirements fingerprint: `5d68d75718bb3a4b587339be8a0c6a1ccb5cd4bb0d85f18e2b2d56fdd5675700`
...
| `CRS-M1-00521` | `FIND-REGISTRATION-CLOSE-AT-EXPIRY` | `FIND-ANSWER-WINDOW-LIFETIME-ELAPSED` → `FIND-ANSWER-REGISTRATION-CLOSED` | `PROJECT-ASSUMPTION-UNRESOLVED-FIND-ABORT` / `NONE` | `FIND-REQUEST-INSTANCE` / `PAIR-WINDOW-EXPIRY-WITH-REGISTRATION-CLOSE` |
...
- 需求指纹：`5d68d75718bb3a4b587339be8a0c6a1ccb5cd4bb0d85f18e2b2d56fdd5675700`
...
| `CRS-M1-00521` | `SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-004-30FC1BCEB891`<br>`ARINC-615A-3 3-2 p.96` | `DATA-LOADER` / `WHEN-FIND-IMPLEMENTED` / `CLOSE-FIND-ANSWER-REGISTRATION-WHEN-WINDOW-EXPIRES` / `FIND-ANSWER-REGISTRATION, FIND-ANSWER-WINDOW-3-S` / `FIND-REGISTRATION-CLOSE-AT-WINDOW-END-OBSERVABLE` | `FACT` / `REQUIRED` | `APPLICABLE-SUPPORTING` | 在实现 FIND 时，数据加载器必须在三秒窗口寿命到期时关闭 FIND 应答登记，而不是更早关闭。测量误差是后续配置参数，不能用来改写该来源常数。 | `FIXED-SOURCE-CONSTANT` / `FIND-ANSWER-WINDOW-3-S` / `SOURCE-DEFINES-DEADLINE-OR-DURATION` / `3..3 s` / 证据：SU-ARINC-615A-3-3-2-P108-PROSE-SENTENCE-004-30FC1BCEB891 | — |
